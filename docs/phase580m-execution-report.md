...
- docs/phase580m-outbox-pressure-simulation.md
- docs/phase580m-execution-report.md
- tools/phase580m/validate-phase580m-outbox-pressure-simulation.mjs
- apps/ai-gateway-service/evidence/phase580m/outbox-pressure-simulation-result.json
