...
- docs/phase591h-dead-button-regression-test.md
- docs/phase591h-execution-report.md
- tools/phase591h/validate-phase591h-dead-button-regression-test.mjs
- apps/ai-gateway-service/evidence/phase591h/dead-button-regression-test-result.json
