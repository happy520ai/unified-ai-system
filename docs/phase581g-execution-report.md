...
- docs/phase581g-input-to-output-trace-test.md
- docs/phase581g-execution-report.md
- tools/phase581g/validate-phase581g-input-to-output-trace-test.mjs
- apps/ai-gateway-service/evidence/phase581g/input-to-output-trace-test-result.json
