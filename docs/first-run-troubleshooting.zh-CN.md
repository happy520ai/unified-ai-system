...
```powershell
# Windows PowerShell
PS> docker run --rm ghcr.io/happy520ai/unified-ai-system/ai-gateway-service:0.7.0 pnpm gateway demo
...
>> ghcr.io/happy520ai/unified-ai-system/ai-gateway-service:0.7.0 pnpm gateway demo
[ready] provider      local-fake-provider
[ready] execution     fake
[done] ... | no API key | process cleaned up
```
