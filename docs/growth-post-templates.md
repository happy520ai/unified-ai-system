...
Get-Content .\request.txt -Raw | docker run --rm -i ghcr.io/happy520ai/unified-ai-system/ai-gateway-service:0.4.9 pnpm --silent gateway demo --enhance --profile planning --language en --json
...
docker run --rm ghcr.io/happy520ai/unified-ai-system/ai-gateway-service:0.4.9 pnpm gateway demo "帮我为团队设计一个小型 API" --enhance --profile coding --language zh-CN
