...
- docs/phase582q-product-recovery-regression.md
- docs/phase582q-execution-report.md
- tools/phase582q/validate-phase582q-product-recovery-regression.mjs
- apps/ai-gateway-service/evidence/phase582q/product-recovery-regression-result.json
