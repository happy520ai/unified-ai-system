...
- docs/phase578m-merge-conflict-simulation.md
- docs/phase578m-execution-report.md
- tools/phase578m/validate-phase578m-merge-conflict-simulation.mjs
- apps/ai-gateway-service/evidence/phase578m/merge-conflict-simulation-result.json
