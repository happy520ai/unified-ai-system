...
- evidence JSON: apps/ai-gateway-service/evidence/phase578a/unified-io-envelope-result.json
- verifier: tools/phase578a/validate-phase578a-unified-io-envelope.mjs
- execution report: docs/phase578a-execution-report.md
