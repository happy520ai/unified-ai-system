...
- docs/phase589k-evidence-query-unit-tests.md
- docs/phase589k-execution-report.md
- tools/phase589k/validate-phase589k-evidence-query-unit-tests.mjs
- apps/ai-gateway-service/evidence/phase589k/evidence-query-unit-tests-result.json
