# Phase577E ESCO Source Contract

## Goal
Checks the ESCO source contract and sourceRef requirements without network import.
...
## Verification
`node tools/phase577e/validate-phase577e-esco-source-contract.mjs`
