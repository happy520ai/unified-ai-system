...
- docs/phase589r-coverage-gap-ledger.md
- docs/phase589r-execution-report.md
- tools/phase589r/validate-phase589r-coverage-gap-ledger.mjs
- apps/ai-gateway-service/evidence/phase589r/coverage-gap-ledger-result.json
