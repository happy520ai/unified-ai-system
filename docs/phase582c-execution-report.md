...
- docs/phase582c-credentialref-only-gate.md
- docs/phase582c-execution-report.md
- tools/phase582c/validate-phase582c-credentialref-only-gate.mjs
- apps/ai-gateway-service/evidence/phase582c/credentialref-only-gate-result.json
