# Phase577N Rollback Note Contract

## Goal
Checks each subphase has a rollback note scoped to docs, verifier, and evidence files.
...
## Verification
`node tools/phase577n/validate-phase577n-rollback-note-contract.mjs`
