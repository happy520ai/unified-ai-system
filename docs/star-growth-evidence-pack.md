...
- Submitted [awesome-llm-skills#207](https://github.com/Prat011/awesome-llm-skills/pull/207) with one self-disclosed external link to the existing `unified-ai-gateway` Codex skill. The target list had 1,450 stars at submission time; the PR is open/mergeable with its GitGuardian check pending, and is not counted as a merge or Star result.
