...
- The mcpservers.org response returned submission `5661` with `status=pending`, `plan=free`, and `paymentStatus=not_required`; this confirms receipt only, not a public listing or Star growth.
...
- The latest growth campaign tracks 12 external collection PRs: 10 open and 2 closed. The open set is [awesome-codex-skills#206](https://github.com/composio-community/awesome-codex-skills/pull/206), [awesome-cli-apps#347](https://github.com/toolleeo/awesome-cli-apps-in-a-csv/pull/347), [Awesome-LLMOps#710](https://github.com/tensorchord/Awesome-LLMOps/pull/710), [awesome-mcp-devtools#257](https://github.com/punkpeye/awesome-mcp-devtools/pull/257), [awesome-mcp-servers-devops#65](https://github.com/WagnerAgent/awesome-mcp-servers-devops/pull/65), [Awesome-MCP-ZH#422](https://github.com/yzfly/Awesome-MCP-ZH/pull/422), [awesome-mcp-servers#11745](https://github.com/punkpeye/awesome-mcp-servers/pull/11745), [awesome-ai-tools#1941](https://github.com/mahseema/awesome-ai-tools/pull/1941), [docker/mcp-registry#4584](https://github.com/docker/mcp-registry/pull/4584), and [up-for-grabs#5995](https://github.com/up-for-grabs/up-for-grabs.net/pull/5995). [agentic-awesome-skills#1073](https://github.com/sickn33/agentic-awesome-skills/pull/1073) and [TensorBlock/awesome-mcp-servers#1616](https://github.com/TensorBlock/awesome-mcp-servers/pull/1616) are closed. The campaign snapshot classifies 8 as CLEAN and 2 as BLOCKED. A separate [agentic-awesome-skills#1115](https://github.com/sickn33/agentic-awesome-skills/pull/1115) was merged as a release-note update outside this campaign snapshot. None is counted as a merge or Star result.
- Submitted [agentic-awesome-skills#1115](https://github.com/sickn33/agentic-awesome-skills/pull/1115) from the maintainer-owned fork to clarify that the current public release is `v0.4.3` while preserving the reviewed immutable `v0.4.0` image digest and security-review commit. The docs-only PR was merged after the required upstream checks passed. This is a verified external collection merge, not a Star result.
- The high-reach [awesome-mcp-servers#11745](https://github.com/punkpeye/awesome-mcp-servers/pull/11745) remains open and mergeable, but its automated check requests a Glama listing and badge. No third-party account or contact data was created or submitted, so this dependency remains explicitly unclaimed and is not counted as exposure or Star growth.
...
- GitHub traffic snapshot for the available 14-day window through 2026-08-08: 171 repository views / 38 unique visitors and 1607 clones / 338 unique cloners. These are exposure signals, not verified Star growth; the latest referrer breakdown was not re-collected in this snapshot.
...
- A malformed maintainer-authored bilingual `v0.4.3` Discussion #23 comment was later removed during the public documentation audit; the clean replacement is tracked below at comment `17950864`.
...
- Added `pnpm gateway demo ... --evidence` to emit a report-ready `usage-report/v1` JSON packet with the reproduction command, environment, fake execution mode, provider boundary, original request, output preview, and report link; targeted CLI tests and a real fake-provider run passed, so this lowers feedback friction but is not evidence of Star growth.
