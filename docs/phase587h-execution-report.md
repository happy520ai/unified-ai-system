...
- docs/phase587h-random-safety-block-injection.md
- docs/phase587h-execution-report.md
- tools/phase587h/validate-phase587h-random-safety-block-injection.mjs
- apps/ai-gateway-service/evidence/phase587h/random-safety-block-injection-result.json
