...
- docs/phase591a-ui-acceptance-scope-lock.md
- docs/phase591a-execution-report.md
- tools/phase591a/validate-phase591a-ui-acceptance-scope-lock.mjs
- apps/ai-gateway-service/evidence/phase591a/ui-acceptance-scope-lock-result.json
