...
- docs/phase580r-load-regression-pack.md
- docs/phase580r-execution-report.md
- tools/phase580r/validate-phase580r-load-regression-pack.mjs
- apps/ai-gateway-service/evidence/phase580r/load-regression-pack-result.json
