...
- docs/phase583r-adapter-compatibility-matrix.md
- docs/phase583r-execution-report.md
- tools/phase583r/validate-phase583r-adapter-compatibility-matrix.mjs
- apps/ai-gateway-service/evidence/phase583r/adapter-compatibility-matrix-result.json
