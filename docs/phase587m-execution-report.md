...
- docs/phase587m-evidence-size-guard.md
- docs/phase587m-execution-report.md
- tools/phase587m/validate-phase587m-evidence-size-guard.mjs
- apps/ai-gateway-service/evidence/phase587m/evidence-size-guard-result.json
