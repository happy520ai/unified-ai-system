# Codex for Open Source Application (Ready-to-Submit)
...
- Keep this text under 500 characters per field.
- Do not claim guaranteed production readiness.
- Copy each section directly into the official form and keep wording factual.
- This form is submitted at `https://openai.com/form/codex-for-oss/`.
