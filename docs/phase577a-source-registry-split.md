# Phase577A Source Registry Split

## Goal
Checks that the Position Library official source registry is split into explicit O*NET, SOC, ISCO, and ESCO source records.
...
## Verification
`node tools/phase577a/validate-phase577a-source-registry-split.mjs`
