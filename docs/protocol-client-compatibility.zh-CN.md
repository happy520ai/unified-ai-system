...
| A2A v1.0 JSON-RPC | 官方 `@a2a-js/sdk` `1.0.1` | 可选可验证 Agent Card/JWKS、`SendMessage`、`GetTask`、`ListTasks`、任务产物、有界 memory/同主机 SQLite 任务 | 当前源码、仅 fake provider，没有流式或跨主机任务存储。 |
