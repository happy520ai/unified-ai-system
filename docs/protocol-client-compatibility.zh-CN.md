...
| MCP Streamable HTTP | 官方 `@modelcontextprotocol/client` `2.0.0` | 现代 `2026-07-28`、旧版 `2025-11-25`/`2025-06-18`、路由头/CORS、12 个工具、Bearer/Origin 拒绝、清理 | 仅当前源码；已发布 `v0.4.9` 镜像仍只有 stdio。 |
