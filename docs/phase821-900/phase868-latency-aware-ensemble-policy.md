# Phase868 Latency-aware Ensemble Policy

## Goal

Latency-aware Ensemble Policy for Phase821-900 guarded routing, surrogate soak, ensemble optimization, or continuous learning.
