...
- docs/phase589i-adapter-contract-tests.md
- docs/phase589i-execution-report.md
- tools/phase589i/validate-phase589i-adapter-contract-tests.mjs
- apps/ai-gateway-service/evidence/phase589i/adapter-contract-tests-result.json
