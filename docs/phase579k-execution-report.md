...
- docs/phase579k-conflict-scenario-pack.md
- docs/phase579k-execution-report.md
- tools/phase579k/validate-phase579k-conflict-scenario-pack.mjs
- apps/ai-gateway-service/evidence/phase579k/conflict-scenario-pack-result.json
