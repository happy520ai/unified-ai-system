# Phase577O Package Script Contract

## Goal
Checks package scripts exist for the current subphase and the aggregate sequence.
...
## Verification
`node tools/phase577o/validate-phase577o-package-script-contract.mjs`
