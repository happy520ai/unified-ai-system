...
- docs/phase579s-mission-control-scenario-preview.md
- docs/phase579s-execution-report.md
- tools/phase579s/validate-phase579s-mission-control-scenario-preview.mjs
- apps/ai-gateway-service/evidence/phase579s/mission-control-scenario-preview-result.json
