# Phase577D ISCO Source Contract

## Goal
Checks the ISCO source contract and license-review boundary without network import.
...
## Verification
`node tools/phase577d/validate-phase577d-isco-source-contract.mjs`
