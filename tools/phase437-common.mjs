...
export const phaseTitle = "Yiyi Demo Implementation Boundary Notes";
export const phaseNumber = 437;
export const phaseName = "Phase437";
export const phaseSlug = "implementation-boundary-notes";
export const phaseType = "commercial_demo_implementation_boundary_notes";
export const phaseDeliverables = [
  "implementationBoundaryNotesCreated",
  "boundaryChecklistCreated"
];
