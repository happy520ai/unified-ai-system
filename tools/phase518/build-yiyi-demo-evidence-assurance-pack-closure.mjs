import {
  ...
  writeJson,
  writeText
} from "../phase518-common.mjs";

const requiredFiles = [
  "docs/phase518a-yiyi-demo-evidence-assurance-pack.json",
  "docs/phase518a-yiyi-demo-evidence-assurance-pack.md",
  "apps/ai-gateway-service/evidence/phase518a/yiyi-demo-evidence-assurance-pack-result.json"
];
...
await writeText(
  "docs/phase518-yiyi-demo-evidence-assurance-pack-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase518/yiyi-demo-evidence-assurance-pack-closure-result.json", result);
