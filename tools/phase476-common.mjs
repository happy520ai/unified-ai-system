...
export const phaseTitle = "Yiyi Demo Controlled Rollout Questions";
export const phaseNumber = 476;
export const phaseName = "Phase476";
export const phaseSlug = "controlled-rollout-questions";
export const phaseType = "commercial_demo_controlled_rollout_questions";
export const phaseDeliverables = [
  "controlledRolloutQuestionsCreated",
  "rolloutQuestionChecklistCreated"
];
