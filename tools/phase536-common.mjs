...
export const phaseTitle = "Yiyi Demo Evidence Stewardship Notes";
export const phaseNumber = 536;
export const phaseName = "Phase536";
export const phaseSlug = "evidence-stewardship-notes";
export const phaseType = "commercial_demo_evidence_stewardship_notes";
export const phaseDeliverables = [
  "evidenceStewardshipNotesCreated",
  "stewardshipChecklistCreated"
];
