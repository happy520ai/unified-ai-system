...
export const phaseTitle = "Yiyi Demo Discovery Question Bank";
export const phaseNumber = 416;
export const phaseName = "Phase416";
export const phaseSlug = "discovery-question-bank";
export const phaseType = "commercial_demo_discovery_question_bank";
export const phaseDeliverables = [
  "discoveryQuestionBankCreated",
  "discoveryUsageNotesCreated"
];
