import {
  ...
  writeJson,
  writeText
} from "../phase441-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase440/yiyi-demo-value-proof-notes-closure-result.json");
...
await writeJson(`docs/phase441a-yiyi-demo-safe-expansion-backlog.json`, packageJson);
await writeText(
  `docs/phase441a-yiyi-demo-safe-expansion-backlog.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase441a/yiyi-demo-safe-expansion-backlog-result.json`, result);
