import {
  ...
  writeJson,
  writeText
} from "../phase415-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase414/yiyi-demo-demo-enablement-onepager-closure-result.json");
...
await writeJson(`docs/phase415a-yiyi-demo-partner-intro-script-pack.json`, packageJson);
await writeText(
  `docs/phase415a-yiyi-demo-partner-intro-script-pack.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase415a/yiyi-demo-partner-intro-script-pack-result.json`, result);
