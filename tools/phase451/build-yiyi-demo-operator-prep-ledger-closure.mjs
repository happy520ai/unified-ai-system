...
const requiredFiles = [
  "docs/phase451a-yiyi-demo-operator-prep-ledger.json",
  "docs/phase451a-yiyi-demo-operator-prep-ledger.md",
  "apps/ai-gateway-service/evidence/phase451a/yiyi-demo-operator-prep-ledger-result.json"
];
...
await writeText(
  "docs/phase451-yiyi-demo-operator-prep-ledger-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase451/yiyi-demo-operator-prep-ledger-closure-result.json", result);
