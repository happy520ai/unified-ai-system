import {
  ...
  writeJson,
  writeText
} from "../phase499-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase498/yiyi-demo-internal-confidence-recap-closure-result.json");
...
await writeJson(`docs/phase499a-yiyi-demo-governance-followup-pack.json`, packageJson);
await writeText(
  `docs/phase499a-yiyi-demo-governance-followup-pack.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase499a/yiyi-demo-governance-followup-pack-result.json`, result);
