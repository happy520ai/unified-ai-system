import {
  ...
  writeJson,
  writeText
} from "../phase506-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase505/yiyi-demo-safe-stakeholder-qa-notes-closure-result.json");
...
await writeJson(`docs/phase506a-yiyi-demo-buyer-confidence-ledger.json`, packageJson);
await writeText(
  `docs/phase506a-yiyi-demo-buyer-confidence-ledger.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase506a/yiyi-demo-buyer-confidence-ledger-result.json`, result);
