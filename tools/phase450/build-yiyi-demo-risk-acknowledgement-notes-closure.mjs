import {
  ...
  writeJson,
  writeText
} from "../phase450-common.mjs";

const requiredFiles = [
  "docs/phase450a-yiyi-demo-risk-acknowledgement-notes.json",
  "docs/phase450a-yiyi-demo-risk-acknowledgement-notes.md",
  "apps/ai-gateway-service/evidence/phase450a/yiyi-demo-risk-acknowledgement-notes-result.json"
];
...
await writeText(
  "docs/phase450-yiyi-demo-risk-acknowledgement-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase450/yiyi-demo-risk-acknowledgement-notes-closure-result.json", result);
