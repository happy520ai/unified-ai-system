...
export const phaseTitle = "Yiyi Demo Evidence Trust Cards";
export const phaseNumber = 546;
export const phaseName = "Phase546";
export const phaseSlug = "evidence-trust-cards";
export const phaseType = "commercial_demo_evidence_trust_cards";
export const phaseDeliverables = [
  "evidenceTrustCardsCreated",
  "evidenceTrustChecklistCreated"
];
