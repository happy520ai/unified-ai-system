...
export const phaseTitle = "Yiyi Demo Commercial Guardrail Brief";
export const phaseNumber = 554;
export const phaseName = "Phase554";
export const phaseSlug = "commercial-guardrail-brief";
export const phaseType = "commercial_demo_commercial_guardrail_brief";
export const phaseDeliverables = [
  "commercialGuardrailBriefCreated",
  "guardrailBriefChecklistCreated"
];
