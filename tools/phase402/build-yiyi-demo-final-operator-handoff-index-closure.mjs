import {
  ...
  writeJson,
  writeText
} from "../phase402-common.mjs";

const requiredFiles = [
  "docs/phase402a-yiyi-demo-final-operator-handoff-index.json",
  "docs/phase402a-yiyi-demo-final-operator-handoff-index.md",
  "apps/ai-gateway-service/evidence/phase402a/yiyi-demo-final-operator-handoff-index-result.json"
];
...
await writeText(
  "docs/phase402-yiyi-demo-final-operator-handoff-index-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase402/yiyi-demo-final-operator-handoff-index-closure-result.json", result);
