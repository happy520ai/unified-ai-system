...
export const phaseTitle = "Yiyi Demo Decision Trace Notes";
export const phaseNumber = 457;
export const phaseName = "Phase457";
export const phaseSlug = "decision-trace-notes";
export const phaseType = "commercial_demo_decision_trace_notes";
export const phaseDeliverables = [
  "decisionTraceNotesCreated",
  "decisionTraceChecklistCreated"
];
