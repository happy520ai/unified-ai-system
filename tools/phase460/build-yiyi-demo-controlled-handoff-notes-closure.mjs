import {
  ...
  writeJson,
  writeText
} from "../phase460-common.mjs";

const requiredFiles = [
  "docs/phase460a-yiyi-demo-controlled-handoff-notes.json",
  "docs/phase460a-yiyi-demo-controlled-handoff-notes.md",
  "apps/ai-gateway-service/evidence/phase460a/yiyi-demo-controlled-handoff-notes-result.json"
];
...
await writeText(
  "docs/phase460-yiyi-demo-controlled-handoff-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase460/yiyi-demo-controlled-handoff-notes-closure-result.json", result);
