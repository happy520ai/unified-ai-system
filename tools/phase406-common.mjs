...
export const phaseTitle = "Yiyi Demo Moderator Notes Pack";
export const phaseNumber = 406;
export const phaseName = "Phase406";
export const phaseSlug = "moderator-notes-pack";
export const phaseType = "commercial_demo_moderator_notes_pack";
export const phaseDeliverables = [
  "moderatorNotesPackCreated",
  "moderationChecklistCreated"
];
