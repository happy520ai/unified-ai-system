...
export const phaseTitle = "Yiyi Demo Review Safeguard Cards";
export const phaseNumber = 538;
export const phaseName = "Phase538";
export const phaseSlug = "review-safeguard-cards";
export const phaseType = "commercial_demo_review_safeguard_cards";
export const phaseDeliverables = [
  "reviewSafeguardCardsCreated",
  "safeguardCardsChecklistCreated"
];
