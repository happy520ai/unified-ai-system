...
const requiredFiles = [
  "docs/phase532a-yiyi-demo-lowrisk-forward-notes.json",
  "docs/phase532a-yiyi-demo-lowrisk-forward-notes.md",
  "apps/ai-gateway-service/evidence/phase532a/yiyi-demo-lowrisk-forward-notes-result.json"
];
...
await writeText(
  "docs/phase532-yiyi-demo-lowrisk-forward-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase532/yiyi-demo-lowrisk-forward-notes-closure-result.json", result);
