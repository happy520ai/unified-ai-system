...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase399/yiyi-demo-internal-qa-scorecard-closure-result.json");
...
await writeJson(`docs/phase400a-yiyi-demo-manual-trial-feedback-form.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase400a/yiyi-demo-manual-trial-feedback-form-result.json`, result);
