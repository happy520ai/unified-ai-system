...
export const phaseTitle = "Yiyi Demo Stakeholder Review Packet + Signoff Checklist";
export const phaseNumber = 394;
export const phaseName = "Phase394";
export const phaseSlug = "stakeholder-review-packet";
export const phaseType = "commercial_demo_stakeholder_review_packet";
export const phaseDeliverables = [
  "stakeholderReviewPacketCreated",
  "signoffChecklistCreated"
];
