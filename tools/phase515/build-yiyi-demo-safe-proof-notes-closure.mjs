...
const requiredFiles = [
  "docs/phase515a-yiyi-demo-safe-proof-notes.json",
  "docs/phase515a-yiyi-demo-safe-proof-notes.md",
  "apps/ai-gateway-service/evidence/phase515a/yiyi-demo-safe-proof-notes-result.json"
];
...
await writeText(
  "docs/phase515-yiyi-demo-safe-proof-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase515/yiyi-demo-safe-proof-notes-closure-result.json", result);
