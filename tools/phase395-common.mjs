...
export const phaseTitle = "Yiyi Demo Evidence Index Refresh + Trace Map";
export const phaseNumber = 395;
export const phaseName = "Phase395";
export const phaseSlug = "evidence-index-refresh-trace-map";
export const phaseType = "commercial_demo_evidence_index_trace_map";
export const phaseDeliverables = [
  "evidenceIndexRefreshed",
  "traceMapCreated"
];
