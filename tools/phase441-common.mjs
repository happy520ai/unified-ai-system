...
export const phaseTitle = "Yiyi Demo Safe Expansion Backlog";
export const phaseNumber = 441;
export const phaseName = "Phase441";
export const phaseSlug = "safe-expansion-backlog";
export const phaseType = "commercial_demo_safe_expansion_backlog";
export const phaseDeliverables = [
  "safeExpansionBacklogCreated",
  "expansionBoundaryChecklistCreated"
];
