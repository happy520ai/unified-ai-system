import {
  ...
  writeJson,
  writeText
} from "../phase437-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase436/yiyi-demo-pilot-success-criteria-pack-closure-result.json");
...
await writeJson(`docs/phase437a-yiyi-demo-implementation-boundary-notes.json`, packageJson);
await writeText(
  `docs/phase437a-yiyi-demo-implementation-boundary-notes.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase437a/yiyi-demo-implementation-boundary-notes-result.json`, result);
