...
export const phaseTitle = "Yiyi Demo Manual Trial Feedback Form";
export const phaseNumber = 400;
export const phaseName = "Phase400";
export const phaseSlug = "manual-trial-feedback-form";
export const phaseType = "commercial_demo_manual_trial_feedback_form";
export const phaseDeliverables = [
  "feedbackFormCreated",
  "feedbackRubricCreated"
];
