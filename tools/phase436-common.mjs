...
export const phaseTitle = "Yiyi Demo Pilot Success Criteria Pack";
export const phaseNumber = 436;
export const phaseName = "Phase436";
export const phaseSlug = "pilot-success-criteria-pack";
export const phaseType = "commercial_demo_pilot_success_criteria_pack";
export const phaseDeliverables = [
  "pilotSuccessCriteriaPackCreated",
  "successCriteriaChecklistCreated"
];
