...
try {
  ...
  [void]$lines.Add("")
  [void]$lines.Add('```text')
  [void]$lines.Add('docker run --rm ghcr.io/happy520ai/unified-ai-system/ai-gateway-service:0.8.0 pnpm gateway demo "Build a small API for my team" --enhance --profile coding')
  [void]$lines.Add("")
