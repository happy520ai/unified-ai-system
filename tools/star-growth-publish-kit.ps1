param(
    ...
    [string]$DemoCommand = 'docker run --rm ghcr.io/happy520ai/unified-ai-system/ai-gateway-service:0.4.7 pnpm gateway demo "Build a small API for my team" --enhance --profile coding',
