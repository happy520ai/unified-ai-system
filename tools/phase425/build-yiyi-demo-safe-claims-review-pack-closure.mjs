...
const requiredFiles = [
  "docs/phase425a-yiyi-demo-safe-claims-review-pack.json",
  "docs/phase425a-yiyi-demo-safe-claims-review-pack.md",
  "apps/ai-gateway-service/evidence/phase425a/yiyi-demo-safe-claims-review-pack-result.json"
];
...
await writeText(
  "docs/phase425-yiyi-demo-safe-claims-review-pack-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase425/yiyi-demo-safe-claims-review-pack-closure-result.json", result);
