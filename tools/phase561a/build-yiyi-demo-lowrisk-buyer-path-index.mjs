import {
  ...
  writeJson,
  writeText
} from "../phase561-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase560/yiyi-demo-review-continuation-ledger-closure-result.json");
...
await writeJson(`docs/phase561a-yiyi-demo-lowrisk-buyer-path-index.json`, packageJson);
await writeText(
  `docs/phase561a-yiyi-demo-lowrisk-buyer-path-index.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase561a/yiyi-demo-lowrisk-buyer-path-index-result.json`, result);
