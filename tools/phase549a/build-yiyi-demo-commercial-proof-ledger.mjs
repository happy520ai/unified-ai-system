import {
  ...
  writeJson,
  writeText
} from "../phase549-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase548/yiyi-demo-operator-confidence-pack-closure-result.json");
...
await writeJson(`docs/phase549a-yiyi-demo-commercial-proof-ledger.json`, packageJson);
await writeText(
  `docs/phase549a-yiyi-demo-commercial-proof-ledger.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase549a/yiyi-demo-commercial-proof-ledger-result.json`, result);
