...
export const phaseTitle = "Yiyi Demo Review Continuity Cards";
export const phaseNumber = 550;
export const phaseName = "Phase550";
export const phaseSlug = "review-continuity-cards";
export const phaseType = "commercial_demo_review_continuity_cards";
export const phaseDeliverables = [
  "reviewContinuityCardsCreated",
  "reviewContinuityChecklistCreated"
];
