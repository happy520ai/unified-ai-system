import {
  ...
  writeJson,
  writeText
} from "../phase535-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase534/yiyi-demo-commercial-safety-digest-closure-result.json");
...
await writeJson(`docs/phase535a-yiyi-demo-buyer-trust-ledger.json`, packageJson);
await writeText(
  `docs/phase535a-yiyi-demo-buyer-trust-ledger.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase535a/yiyi-demo-buyer-trust-ledger-result.json`, result);
