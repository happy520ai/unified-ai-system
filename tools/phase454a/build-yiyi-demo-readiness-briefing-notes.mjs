import {
  ...
  writeJson,
  writeText
} from "../phase454-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase453/yiyi-demo-sixth-low-risk-auto-run-closure-closure-result.json");
...
await writeJson(`docs/phase454a-yiyi-demo-readiness-briefing-notes.json`, packageJson);
await writeText(
  `docs/phase454a-yiyi-demo-readiness-briefing-notes.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase454a/yiyi-demo-readiness-briefing-notes-result.json`, result);
