...
const requiredFiles = [
  "docs/phase487a-yiyi-demo-buyer-journey-handoff.json",
  "docs/phase487a-yiyi-demo-buyer-journey-handoff.md",
  "apps/ai-gateway-service/evidence/phase487a/yiyi-demo-buyer-journey-handoff-result.json"
];
...
await writeText(
  "docs/phase487-yiyi-demo-buyer-journey-handoff-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase487/yiyi-demo-buyer-journey-handoff-closure-result.json", result);
