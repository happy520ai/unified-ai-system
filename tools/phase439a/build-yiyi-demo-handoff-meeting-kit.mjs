import {
  ...
  writeJson,
  writeText
} from "../phase439-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase438/yiyi-demo-support-intake-template-closure-result.json");
...
await writeJson(`docs/phase439a-yiyi-demo-handoff-meeting-kit.json`, packageJson);
await writeText(
  `docs/phase439a-yiyi-demo-handoff-meeting-kit.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase439a/yiyi-demo-handoff-meeting-kit-result.json`, result);
