...
const requiredFiles = [
  "docs/phase550a-yiyi-demo-review-continuity-cards.json",
  "docs/phase550a-yiyi-demo-review-continuity-cards.md",
  "apps/ai-gateway-service/evidence/phase550a/yiyi-demo-review-continuity-cards-result.json"
];
...
await writeText(
  "docs/phase550-yiyi-demo-review-continuity-cards-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase550/yiyi-demo-review-continuity-cards-closure-result.json", result);
