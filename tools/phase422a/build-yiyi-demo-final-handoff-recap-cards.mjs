import {
  ...
  writeJson,
  writeText
} from "../phase422-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase421/yiyi-demo-internal-signoff-reminder-pack-closure-result.json");
...
await writeJson(`docs/phase422a-yiyi-demo-final-handoff-recap-cards.json`, packageJson);
await writeText(
  `docs/phase422a-yiyi-demo-final-handoff-recap-cards.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase422a/yiyi-demo-final-handoff-recap-cards-result.json`, result);
