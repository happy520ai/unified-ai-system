...
export const phaseTitle = "Yiyi Demo Session Agenda Templates";
export const phaseNumber = 405;
export const phaseName = "Phase405";
export const phaseSlug = "session-agenda-templates";
export const phaseType = "commercial_demo_session_agenda_templates";
export const phaseDeliverables = [
  "sessionAgendaTemplatesCreated",
  "agendaVariantsCreated"
];
