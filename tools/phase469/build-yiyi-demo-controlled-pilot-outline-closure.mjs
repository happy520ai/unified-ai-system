...
const requiredFiles = [
  "docs/phase469a-yiyi-demo-controlled-pilot-outline.json",
  "docs/phase469a-yiyi-demo-controlled-pilot-outline.md",
  "apps/ai-gateway-service/evidence/phase469a/yiyi-demo-controlled-pilot-outline-result.json"
];
...
await writeText(
  "docs/phase469-yiyi-demo-controlled-pilot-outline-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase469/yiyi-demo-controlled-pilot-outline-closure-result.json", result);
