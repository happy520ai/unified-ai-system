import {
  ...
  writeJson,
  writeText
} from "../phase403-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase402/yiyi-demo-final-operator-handoff-index-closure-result.json");
...
await writeJson(`docs/phase403a-yiyi-demo-low-risk-auto-run-closure.json`, packageJson);
await writeText(
  `docs/phase403a-yiyi-demo-low-risk-auto-run-closure.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase403a/yiyi-demo-low-risk-auto-run-closure-result.json`, result);
