...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase536/yiyi-demo-evidence-stewardship-notes-closure-result.json");
...
await writeJson(`docs/phase537a-yiyi-demo-controlled-assurance-brief.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase537a/yiyi-demo-controlled-assurance-brief-result.json`, result);
