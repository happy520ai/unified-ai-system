...
export const phaseTitle = "Yiyi Demo Narrative Consistency Sweep";
export const phaseNumber = 426;
export const phaseName = "Phase426";
export const phaseSlug = "narrative-consistency-sweep";
export const phaseType = "commercial_demo_narrative_consistency_sweep";
export const phaseDeliverables = [
  "narrativeConsistencySweepCreated",
  "storyConsistencyChecklistCreated"
];
