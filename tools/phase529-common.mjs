...
export const phaseTitle = "Yiyi Demo Controlled Readiness Notes";
export const phaseNumber = 529;
export const phaseName = "Phase529";
export const phaseSlug = "controlled-readiness-notes";
export const phaseType = "commercial_demo_controlled_readiness_notes";
export const phaseDeliverables = [
  "controlledReadinessNotesCreated",
  "controlledReadinessChecklistCreated"
];
