...
export const phaseTitle = "Yiyi Demo Seventeenth Low-risk Auto-run Closure";
export const phaseNumber = 563;
export const phaseName = "Phase563";
export const phaseSlug = "seventeenth-low-risk-auto-run-closure";
export const phaseType = "commercial_demo_seventeenth_low_risk_auto_run_closure";
export const phaseDeliverables = [
  "seventeenthLowRiskClosureCreated",
  "phase384StopPrepared"
];
