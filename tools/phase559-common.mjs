...
export const phaseTitle = "Yiyi Demo Buyer Risk Framing Pack";
export const phaseNumber = 559;
export const phaseName = "Phase559";
export const phaseSlug = "buyer-risk-framing-pack";
export const phaseType = "commercial_demo_buyer_risk_framing_pack";
export const phaseDeliverables = [
  "buyerRiskFramingPackCreated",
  "riskFramingChecklistCreated"
];
