import {
  ...
  writeJson,
  writeText
} from "../phase501-common.mjs";

const requiredFiles = [
  "docs/phase501a-yiyi-demo-controlled-commercial-notes.json",
  "docs/phase501a-yiyi-demo-controlled-commercial-notes.md",
  "apps/ai-gateway-service/evidence/phase501a/yiyi-demo-controlled-commercial-notes-result.json"
];
...
await writeText(
  "docs/phase501-yiyi-demo-controlled-commercial-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase501/yiyi-demo-controlled-commercial-notes-closure-result.json", result);
