...
const requiredFiles = [
  "docs/phase524a-yiyi-demo-commercial-trust-scorecard.json",
  "docs/phase524a-yiyi-demo-commercial-trust-scorecard.md",
  "apps/ai-gateway-service/evidence/phase524a/yiyi-demo-commercial-trust-scorecard-result.json"
];
...
await writeText(
  "docs/phase524-yiyi-demo-commercial-trust-scorecard-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase524/yiyi-demo-commercial-trust-scorecard-closure-result.json", result);
