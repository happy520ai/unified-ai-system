import {
  ...
  writeJson,
  writeText
} from "../phase400-common.mjs";

const requiredFiles = [
  "docs/phase400a-yiyi-demo-manual-trial-feedback-form.json",
  "docs/phase400a-yiyi-demo-manual-trial-feedback-form.md",
  "apps/ai-gateway-service/evidence/phase400a/yiyi-demo-manual-trial-feedback-form-result.json"
];
...
await writeText(
  "docs/phase400-yiyi-demo-manual-trial-feedback-form-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase400/yiyi-demo-manual-trial-feedback-form-closure-result.json", result);
