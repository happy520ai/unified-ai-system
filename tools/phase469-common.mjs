...
export const phaseTitle = "Yiyi Demo Controlled Pilot Outline";
export const phaseNumber = 469;
export const phaseName = "Phase469";
export const phaseSlug = "controlled-pilot-outline";
export const phaseType = "commercial_demo_controlled_pilot_outline";
export const phaseDeliverables = [
  "controlledPilotOutlineCreated",
  "controlledPilotChecklistCreated"
];
