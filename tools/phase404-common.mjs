...
export const phaseTitle = "Yiyi Demo Channel Briefing Pack";
export const phaseNumber = 404;
export const phaseName = "Phase404";
export const phaseSlug = "channel-briefing-pack";
export const phaseType = "commercial_demo_channel_briefing_pack";
export const phaseDeliverables = [
  "channelBriefingPackCreated",
  "briefingChecklistCreated"
];
