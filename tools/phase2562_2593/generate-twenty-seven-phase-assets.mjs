...
async function buildProposalDiff(target, beforeText, afterText) {
  ...
  const tempDir = resolve("tmp/phase2562-2593-proposals");
...
function buildDoc() {
  return `# Phase2562A-2593A Controlled Twenty-Seven Tool Mutation
  ...
  return JSON.stringify(
    {
      ...
      planId: "phase2562-2593-controlled-twenty-seven-tool-mutation",
      maxChangedFiles: 27,
      runNodeCheck: true,
      runLocalSmoke: true,
      approvalRecord: {
        ...
        approvedAtLeastOnceByOwner: [
          {
            ...
            scope: "phase2562-2593-controlled-twenty-seven-tool-mutation",
          },
        ],
...
function buildBaseResult({ plan, validation, generatedAt, planPath }) {
  return {
    ...
    phase2561Sealed: validation.upstreamResults.some((entry) => entry.id === "${previousPhaseMeta.sealCheckId}" && entry.passed),
    codexExecExecuted: false,
    providerCallsMade: false,
    projectProviderCallsMade: false,
    secretRead: false,
