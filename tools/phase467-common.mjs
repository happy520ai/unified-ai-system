...
export const phaseTitle = "Yiyi Demo Buyer Outcome Matrix";
export const phaseNumber = 467;
export const phaseName = "Phase467";
export const phaseSlug = "buyer-outcome-matrix";
export const phaseType = "commercial_demo_buyer_outcome_matrix";
export const phaseDeliverables = [
  "buyerOutcomeMatrixCreated",
  "outcomeMatrixChecklistCreated"
];
