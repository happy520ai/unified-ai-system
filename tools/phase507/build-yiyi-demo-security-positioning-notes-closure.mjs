import {
  ...
  writeJson,
  writeText
} from "../phase507-common.mjs";

const requiredFiles = [
  "docs/phase507a-yiyi-demo-security-positioning-notes.json",
  "docs/phase507a-yiyi-demo-security-positioning-notes.md",
  "apps/ai-gateway-service/evidence/phase507a/yiyi-demo-security-positioning-notes-result.json"
];
...
await writeText(
  "docs/phase507-yiyi-demo-security-positioning-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase507/yiyi-demo-security-positioning-notes-closure-result.json", result);
