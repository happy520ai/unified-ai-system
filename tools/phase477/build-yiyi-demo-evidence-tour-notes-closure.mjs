...
const requiredFiles = [
  "docs/phase477a-yiyi-demo-evidence-tour-notes.json",
  "docs/phase477a-yiyi-demo-evidence-tour-notes.md",
  "apps/ai-gateway-service/evidence/phase477a/yiyi-demo-evidence-tour-notes-result.json"
];
...
await writeText(
  "docs/phase477-yiyi-demo-evidence-tour-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase477/yiyi-demo-evidence-tour-notes-closure-result.json", result);
