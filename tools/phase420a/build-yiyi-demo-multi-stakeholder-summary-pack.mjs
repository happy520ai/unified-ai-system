...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase419/yiyi-demo-demo-room-setup-checklist-closure-result.json");
...
await writeJson(`docs/phase420a-yiyi-demo-multi-stakeholder-summary-pack.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase420a/yiyi-demo-multi-stakeholder-summary-pack-result.json`, result);
