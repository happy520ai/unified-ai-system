...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase551/yiyi-demo-buyer-followthrough-index-closure-result.json");
...
await writeJson(`docs/phase552a-yiyi-demo-lowrisk-evidence-forward-pack.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase552a/yiyi-demo-lowrisk-evidence-forward-pack-result.json`, result);
