...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase479/yiyi-demo-commercial-followup-ledger-closure-result.json");
...
await writeJson(`docs/phase480a-yiyi-demo-internal-demo-replay-notes.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase480a/yiyi-demo-internal-demo-replay-notes-result.json`, result);
