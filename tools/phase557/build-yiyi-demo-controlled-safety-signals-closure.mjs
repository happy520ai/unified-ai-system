...
const requiredFiles = [
  "docs/phase557a-yiyi-demo-controlled-safety-signals.json",
  "docs/phase557a-yiyi-demo-controlled-safety-signals.md",
  "apps/ai-gateway-service/evidence/phase557a/yiyi-demo-controlled-safety-signals-result.json"
];
...
await writeText(
  "docs/phase557-yiyi-demo-controlled-safety-signals-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase557/yiyi-demo-controlled-safety-signals-closure-result.json", result);
