...
export const phaseTitle = "Yiyi Demo Evidence Tour Notes";
export const phaseNumber = 477;
export const phaseName = "Phase477";
export const phaseSlug = "evidence-tour-notes";
export const phaseType = "commercial_demo_evidence_tour_notes";
export const phaseDeliverables = [
  "evidenceTourNotesCreated",
  "evidenceTourChecklistCreated"
];
