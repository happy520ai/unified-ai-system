...
const requiredFiles = [
  "docs/phase438a-yiyi-demo-support-intake-template.json",
  "docs/phase438a-yiyi-demo-support-intake-template.md",
  "apps/ai-gateway-service/evidence/phase438a/yiyi-demo-support-intake-template-result.json"
];
...
await writeText(
  "docs/phase438-yiyi-demo-support-intake-template-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase438/yiyi-demo-support-intake-template-closure-result.json", result);
