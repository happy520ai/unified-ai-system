...
export const phaseTitle = "Yiyi Demo Facilitation Backup Cards";
export const phaseNumber = 458;
export const phaseName = "Phase458";
export const phaseSlug = "facilitation-backup-cards";
export const phaseType = "commercial_demo_facilitation_backup_cards";
export const phaseDeliverables = [
  "facilitationBackupCardsCreated",
  "backupCardsChecklistCreated"
];
