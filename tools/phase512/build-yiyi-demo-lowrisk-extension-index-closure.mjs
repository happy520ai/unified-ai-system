...
const requiredFiles = [
  "docs/phase512a-yiyi-demo-lowrisk-extension-index.json",
  "docs/phase512a-yiyi-demo-lowrisk-extension-index.md",
  "apps/ai-gateway-service/evidence/phase512a/yiyi-demo-lowrisk-extension-index-result.json"
];
...
await writeText(
  "docs/phase512-yiyi-demo-lowrisk-extension-index-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase512/yiyi-demo-lowrisk-extension-index-closure-result.json", result);
