import {
  ...
  writeJson,
  writeText
} from "../phase527-common.mjs";

const requiredFiles = [
  "docs/phase527a-yiyi-demo-evidence-control-ledger.json",
  "docs/phase527a-yiyi-demo-evidence-control-ledger.md",
  "apps/ai-gateway-service/evidence/phase527a/yiyi-demo-evidence-control-ledger-result.json"
];
...
await writeText(
  "docs/phase527-yiyi-demo-evidence-control-ledger-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase527/yiyi-demo-evidence-control-ledger-closure-result.json", result);
