import {
  ...
  writeJson,
  writeText
} from "../phase489-common.mjs";

const requiredFiles = [
  "docs/phase489a-yiyi-demo-evidence-confidence-notes.json",
  "docs/phase489a-yiyi-demo-evidence-confidence-notes.md",
  "apps/ai-gateway-service/evidence/phase489a/yiyi-demo-evidence-confidence-notes-result.json"
];
...
await writeText(
  "docs/phase489-yiyi-demo-evidence-confidence-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase489/yiyi-demo-evidence-confidence-notes-closure-result.json", result);
