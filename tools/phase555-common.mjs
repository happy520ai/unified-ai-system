...
export const phaseTitle = "Yiyi Demo Buyer Confidence Notes";
export const phaseNumber = 555;
export const phaseName = "Phase555";
export const phaseSlug = "buyer-confidence-notes";
export const phaseType = "commercial_demo_buyer_confidence_notes";
export const phaseDeliverables = [
  "buyerConfidenceNotesCreated",
  "buyerConfidenceNotesChecklistCreated"
];
