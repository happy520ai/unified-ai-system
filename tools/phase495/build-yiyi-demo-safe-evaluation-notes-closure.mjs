...
const requiredFiles = [
  "docs/phase495a-yiyi-demo-safe-evaluation-notes.json",
  "docs/phase495a-yiyi-demo-safe-evaluation-notes.md",
  "apps/ai-gateway-service/evidence/phase495a/yiyi-demo-safe-evaluation-notes-result.json"
];
...
await writeText(
  "docs/phase495-yiyi-demo-safe-evaluation-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase495/yiyi-demo-safe-evaluation-notes-closure-result.json", result);
