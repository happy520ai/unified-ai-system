...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase555/yiyi-demo-buyer-confidence-notes-closure-result.json");
...
await writeJson(`docs/phase556a-yiyi-demo-evidence-reliability-ledger.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase556a/yiyi-demo-evidence-reliability-ledger-result.json`, result);
