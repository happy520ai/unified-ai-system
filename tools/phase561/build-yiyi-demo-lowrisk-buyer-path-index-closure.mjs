...
const requiredFiles = [
  "docs/phase561a-yiyi-demo-lowrisk-buyer-path-index.json",
  "docs/phase561a-yiyi-demo-lowrisk-buyer-path-index.md",
  "apps/ai-gateway-service/evidence/phase561a/yiyi-demo-lowrisk-buyer-path-index-result.json"
];
...
await writeText(
  "docs/phase561-yiyi-demo-lowrisk-buyer-path-index-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase561/yiyi-demo-lowrisk-buyer-path-index-closure-result.json", result);
