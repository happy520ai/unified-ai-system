...
const requiredFiles = [
  "docs/phase492a-yiyi-demo-safe-next-batch-pack.json",
  "docs/phase492a-yiyi-demo-safe-next-batch-pack.md",
  "apps/ai-gateway-service/evidence/phase492a/yiyi-demo-safe-next-batch-pack-result.json"
];
...
await writeText(
  "docs/phase492-yiyi-demo-safe-next-batch-pack-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase492/yiyi-demo-safe-next-batch-pack-closure-result.json", result);
