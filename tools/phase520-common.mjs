...
export const phaseTitle = "Yiyi Demo Internal Review Addendum";
export const phaseNumber = 520;
export const phaseName = "Phase520";
export const phaseSlug = "internal-review-addendum";
export const phaseType = "commercial_demo_internal_review_addendum";
export const phaseDeliverables = [
  "internalReviewAddendumCreated",
  "internalReviewChecklistCreated"
];
