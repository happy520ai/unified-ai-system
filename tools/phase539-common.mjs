...
export const phaseTitle = "Yiyi Demo Commercial Continuity Notes";
export const phaseNumber = 539;
export const phaseName = "Phase539";
export const phaseSlug = "commercial-continuity-notes";
export const phaseType = "commercial_demo_commercial_continuity_notes";
export const phaseDeliverables = [
  "commercialContinuityNotesCreated",
  "continuityNotesChecklistCreated"
];
