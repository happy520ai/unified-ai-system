...
export const phaseTitle = "Yiyi Demo Safe Stakeholder Q&A Notes";
export const phaseNumber = 505;
export const phaseName = "Phase505";
export const phaseSlug = "safe-stakeholder-qa-notes";
export const phaseType = "commercial_demo_safe_stakeholder_qa_notes";
export const phaseDeliverables = [
  "safeStakeholderQaNotesCreated",
  "stakeholderQaChecklistCreated"
];
