import {
  ...
  writeJson,
  writeText
} from "../phase495-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase494/yiyi-demo-commercial-proof-digest-closure-result.json");
...
await writeJson(`docs/phase495a-yiyi-demo-safe-evaluation-notes.json`, packageJson);
await writeText(
  `docs/phase495a-yiyi-demo-safe-evaluation-notes.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase495a/yiyi-demo-safe-evaluation-notes-result.json`, result);
