...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase510/yiyi-demo-internal-narrative-sync-closure-result.json");
...
await writeJson(`docs/phase511a-yiyi-demo-safe-buyer-followup-pack.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase511a/yiyi-demo-safe-buyer-followup-pack-result.json`, result);
