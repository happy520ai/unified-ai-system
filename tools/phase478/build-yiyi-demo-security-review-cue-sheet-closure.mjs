import {
  ...
  writeJson,
  writeText
} from "../phase478-common.mjs";

const requiredFiles = [
  "docs/phase478a-yiyi-demo-security-review-cue-sheet.json",
  "docs/phase478a-yiyi-demo-security-review-cue-sheet.md",
  "apps/ai-gateway-service/evidence/phase478a/yiyi-demo-security-review-cue-sheet-result.json"
];
...
await writeText(
  "docs/phase478-yiyi-demo-security-review-cue-sheet-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase478/yiyi-demo-security-review-cue-sheet-closure-result.json", result);
