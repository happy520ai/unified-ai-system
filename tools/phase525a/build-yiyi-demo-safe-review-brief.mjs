import {
  ...
  writeJson,
  writeText
} from "../phase525-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase524/yiyi-demo-commercial-trust-scorecard-closure-result.json");
...
await writeJson(`docs/phase525a-yiyi-demo-safe-review-brief.json`, packageJson);
await writeText(
  `docs/phase525a-yiyi-demo-safe-review-brief.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase525a/yiyi-demo-safe-review-brief-result.json`, result);
