import {
  ...
  writeJson,
  writeText
} from "../phase508-common.mjs";

const requiredFiles = [
  "docs/phase508a-yiyi-demo-evidence-walkthrough-cards.json",
  "docs/phase508a-yiyi-demo-evidence-walkthrough-cards.md",
  "apps/ai-gateway-service/evidence/phase508a/yiyi-demo-evidence-walkthrough-cards-result.json"
];
...
await writeText(
  "docs/phase508-yiyi-demo-evidence-walkthrough-cards-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase508/yiyi-demo-evidence-walkthrough-cards-closure-result.json", result);
