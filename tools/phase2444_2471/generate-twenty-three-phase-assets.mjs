...
async function buildProposalDiff(target, beforeText, afterText) {
  ...
  const tempDir = resolve("tmp/phase2444-2471-proposals");
...
function buildDoc() {
  return `# Phase2444A-2471A Controlled Twenty-Three Tool Mutation
  ...
  return JSON.stringify(
    {
      ...
      planId: "phase2444-2471-controlled-twenty-three-tool-mutation",
      maxChangedFiles: 23,
      runNodeCheck: true,
      runLocalSmoke: true,
      approvalRecord: {
        ...
        approvedAtLeastOnceByOwner: [
          {
            ...
            scope: "phase2444-2471-controlled-twenty-three-tool-mutation",
          },
        ],
...
${smokeMarkers}
  ...
  const result = {
    ...
    blocker: completed ? "none" : "twenty_three_mutation_node_check_or_smoke_failed",
...
function validatePlan(plan) {
  return validateControlledMutationPlan({
    ...
    expectedOperationCount: 23,
    expectedMaxChangedFiles: 23,
...
function printSummary(result) {
  console.log(JSON.stringify({
    status: result.status,
    blocker: result.blocker,
    twentyThreeMutationApplied: result.twentyThreeMutationApplied,
    changedFileCount: result.changedFileCount,
    nodeCheckPassed: result.nodeCheckPassed,
    localTwentyThreeSmokePassed: result.localTwentyThreeSmokePassed,
