import {
  ...
  writeJson,
  writeText
} from "../phase522-common.mjs";

const requiredFiles = [
  "docs/phase522a-yiyi-demo-lowrisk-carryforward-pack.json",
  "docs/phase522a-yiyi-demo-lowrisk-carryforward-pack.md",
  "apps/ai-gateway-service/evidence/phase522a/yiyi-demo-lowrisk-carryforward-pack-result.json"
];
...
await writeText(
  "docs/phase522-yiyi-demo-lowrisk-carryforward-pack-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase522/yiyi-demo-lowrisk-carryforward-pack-closure-result.json", result);
