...
export const phaseTitle = "Yiyi Demo Operator Quick Reference";
export const phaseNumber = 432;
export const phaseName = "Phase432";
export const phaseSlug = "operator-quick-reference";
export const phaseType = "commercial_demo_operator_quick_reference";
export const phaseDeliverables = [
  "operatorQuickReferenceCreated",
  "quickReferenceChecklistCreated"
];
