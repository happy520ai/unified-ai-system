...
writeJson(paths.tianshuUsefulnessRecorder, records[paths.tianshuUsefulnessRecorder]);
...
console.log(JSON.stringify({
  ...
  ownerUsefulnessScoreOwnerOnly: records[paths.tianshuUsefulnessRecorder].ownerUsefulnessScoreOwnerOnly,
}, null, 2));
