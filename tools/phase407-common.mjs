...
export const phaseTitle = "Yiyi Demo Storyline Sequencing Pack";
export const phaseNumber = 407;
export const phaseName = "Phase407";
export const phaseSlug = "storyline-sequencing-pack";
export const phaseType = "commercial_demo_storyline_sequencing_pack";
export const phaseDeliverables = [
  "storylineSequencingPackCreated",
  "sequenceChecklistCreated"
];
