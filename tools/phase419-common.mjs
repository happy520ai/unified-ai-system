...
export const phaseTitle = "Yiyi Demo Demo Room Setup Checklist";
export const phaseNumber = 419;
export const phaseName = "Phase419";
export const phaseSlug = "demo-room-setup-checklist";
export const phaseType = "commercial_demo_room_setup_checklist";
export const phaseDeliverables = [
  "demoRoomSetupChecklistCreated",
  "setupReadinessNotesCreated"
];
