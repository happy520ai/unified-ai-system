...
export const phaseTitle = "Yiyi Demo Safe Buyer Follow-up Pack";
export const phaseNumber = 511;
export const phaseName = "Phase511";
export const phaseSlug = "safe-buyer-followup-pack";
export const phaseType = "commercial_demo_safe_buyer_followup_pack";
export const phaseDeliverables = [
  "safeBuyerFollowupPackCreated",
  "buyerFollowupChecklistCreated"
];
