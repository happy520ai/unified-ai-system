...
export const phaseTitle = "Yiyi Demo Pilot Readiness Ledger";
export const phaseNumber = 486;
export const phaseName = "Phase486";
export const phaseSlug = "pilot-readiness-ledger";
export const phaseType = "commercial_demo_pilot_readiness_ledger";
export const phaseDeliverables = [
  "pilotReadinessLedgerCreated",
  "pilotReadinessChecklistCreated"
];
