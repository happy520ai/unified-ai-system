...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase550/yiyi-demo-review-continuity-cards-closure-result.json");
...
await writeJson(`docs/phase551a-yiyi-demo-buyer-followthrough-index.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase551a/yiyi-demo-buyer-followthrough-index-result.json`, result);
