...
export const phaseTitle = "Yiyi Demo Review Closure Notes";
export const phaseNumber = 491;
export const phaseName = "Phase491";
export const phaseSlug = "review-closure-notes";
export const phaseType = "commercial_demo_review_closure_notes";
export const phaseDeliverables = [
  "reviewClosureNotesCreated",
  "reviewClosureChecklistCreated"
];
