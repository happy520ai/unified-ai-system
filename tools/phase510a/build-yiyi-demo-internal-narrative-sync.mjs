import {
  ...
  writeJson,
  writeText
} from "../phase510-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase509/yiyi-demo-controlled-trial-framing-closure-result.json");
...
await writeJson(`docs/phase510a-yiyi-demo-internal-narrative-sync.json`, packageJson);
await writeText(
  `docs/phase510a-yiyi-demo-internal-narrative-sync.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase510a/yiyi-demo-internal-narrative-sync-result.json`, result);
