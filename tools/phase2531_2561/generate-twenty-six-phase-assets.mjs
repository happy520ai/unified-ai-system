...
async function buildProposalDiff(target, beforeText, afterText) {
  ...
  const tempDir = resolve("tmp/phase2531-2561-proposals");
...
function buildDoc() {
  return `# Phase2531A-2561A Controlled Twenty-Six Tool Mutation
  ...
  return JSON.stringify(
    {
      ...
      planId: "phase2531-2561-controlled-twenty-six-tool-mutation",
      maxChangedFiles: 26,
      runNodeCheck: true,
      runLocalSmoke: true,
      approvalRecord: {
        ...
        approvedAtLeastOnceByOwner: [
          {
            ...
            scope: "phase2531-2561-controlled-twenty-six-tool-mutation",
          },
        ],
...
function buildBaseResult({ plan, validation, generatedAt, planPath }) {
  return {
    ...
    phase2530Sealed: validation.upstreamResults.some((entry) => entry.id === "${previousPhaseMeta.sealCheckId}" && entry.passed),
    codexExecExecuted: false,
    providerCallsMade: false,
    projectProviderCallsMade: false,
    secretRead: false,
