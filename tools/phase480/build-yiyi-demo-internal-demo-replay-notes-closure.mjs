import {
  ...
  writeJson,
  writeText
} from "../phase480-common.mjs";

const requiredFiles = [
  "docs/phase480a-yiyi-demo-internal-demo-replay-notes.json",
  "docs/phase480a-yiyi-demo-internal-demo-replay-notes.md",
  "apps/ai-gateway-service/evidence/phase480a/yiyi-demo-internal-demo-replay-notes-result.json"
];
...
await writeText(
  "docs/phase480-yiyi-demo-internal-demo-replay-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase480/yiyi-demo-internal-demo-replay-notes-closure-result.json", result);
