...
const requiredFiles = [
  "docs/phase486a-yiyi-demo-pilot-readiness-ledger.json",
  "docs/phase486a-yiyi-demo-pilot-readiness-ledger.md",
  "apps/ai-gateway-service/evidence/phase486a/yiyi-demo-pilot-readiness-ledger-result.json"
];
...
await writeText(
  "docs/phase486-yiyi-demo-pilot-readiness-ledger-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase486/yiyi-demo-pilot-readiness-ledger-closure-result.json", result);
