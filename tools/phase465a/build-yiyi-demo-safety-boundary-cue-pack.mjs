import {
  ...
  writeJson,
  writeText
} from "../phase465-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase464/yiyi-demo-commercial-readiness-digest-closure-result.json");
...
await writeJson(`docs/phase465a-yiyi-demo-safety-boundary-cue-pack.json`, packageJson);
await writeText(
  `docs/phase465a-yiyi-demo-safety-boundary-cue-pack.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase465a/yiyi-demo-safety-boundary-cue-pack-result.json`, result);
