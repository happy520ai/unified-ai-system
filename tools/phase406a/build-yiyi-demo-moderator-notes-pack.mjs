import {
  ...
  writeJson,
  writeText
} from "../phase406-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase405/yiyi-demo-session-agenda-templates-closure-result.json");
...
await writeJson(`docs/phase406a-yiyi-demo-moderator-notes-pack.json`, packageJson);
await writeText(
  `docs/phase406a-yiyi-demo-moderator-notes-pack.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase406a/yiyi-demo-moderator-notes-pack-result.json`, result);
