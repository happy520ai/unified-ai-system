import {
  ...
  writeJson,
  writeText
} from "../phase538-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase537/yiyi-demo-controlled-assurance-brief-closure-result.json");
...
await writeJson(`docs/phase538a-yiyi-demo-review-safeguard-cards.json`, packageJson);
await writeText(
  `docs/phase538a-yiyi-demo-review-safeguard-cards.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase538a/yiyi-demo-review-safeguard-cards-result.json`, result);
