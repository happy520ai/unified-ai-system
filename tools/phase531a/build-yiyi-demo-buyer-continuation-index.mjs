import {
  ...
  writeJson,
  writeText
} from "../phase531-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase530/yiyi-demo-operator-assurance-pack-closure-result.json");
...
await writeJson(`docs/phase531a-yiyi-demo-buyer-continuation-index.json`, packageJson);
await writeText(
  `docs/phase531a-yiyi-demo-buyer-continuation-index.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase531a/yiyi-demo-buyer-continuation-index-result.json`, result);
