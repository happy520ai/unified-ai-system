...
const requiredFiles = [
  "docs/phase525a-yiyi-demo-safe-review-brief.json",
  "docs/phase525a-yiyi-demo-safe-review-brief.md",
  "apps/ai-gateway-service/evidence/phase525a/yiyi-demo-safe-review-brief-result.json"
];
...
await writeText(
  "docs/phase525-yiyi-demo-safe-review-brief-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase525/yiyi-demo-safe-review-brief-closure-result.json", result);
