...
const requiredFiles = [
  "docs/phase444a-yiyi-demo-field-enablement-brief.json",
  "docs/phase444a-yiyi-demo-field-enablement-brief.md",
  "apps/ai-gateway-service/evidence/phase444a/yiyi-demo-field-enablement-brief-result.json"
];
...
await writeText(
  "docs/phase444-yiyi-demo-field-enablement-brief-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase444/yiyi-demo-field-enablement-brief-closure-result.json", result);
