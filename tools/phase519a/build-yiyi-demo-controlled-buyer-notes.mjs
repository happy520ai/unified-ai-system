import {
  ...
  writeJson,
  writeText
} from "../phase519-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase518/yiyi-demo-evidence-assurance-pack-closure-result.json");
...
await writeJson(`docs/phase519a-yiyi-demo-controlled-buyer-notes.json`, packageJson);
await writeText(
  `docs/phase519a-yiyi-demo-controlled-buyer-notes.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase519a/yiyi-demo-controlled-buyer-notes-result.json`, result);
