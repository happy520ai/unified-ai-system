...
export const phaseTitle = "Yiyi Demo Governance Follow-up Pack";
export const phaseNumber = 499;
export const phaseName = "Phase499";
export const phaseSlug = "governance-followup-pack";
export const phaseType = "commercial_demo_governance_followup_pack";
export const phaseDeliverables = [
  "governanceFollowupPackCreated",
  "governanceFollowupChecklistCreated"
];
