...
export const phaseTitle = "Yiyi Demo Low-risk Auto-run Closure";
export const phaseNumber = 403;
export const phaseName = "Phase403";
export const phaseSlug = "low-risk-auto-run-closure";
export const phaseType = "commercial_demo_low_risk_auto_run_closure";
export const phaseDeliverables = [
  "lowRiskAutoRunClosureCreated",
