...
const requiredFiles = [
  "docs/phase449a-yiyi-demo-review-facilitation-pack.json",
  "docs/phase449a-yiyi-demo-review-facilitation-pack.md",
  "apps/ai-gateway-service/evidence/phase449a/yiyi-demo-review-facilitation-pack-result.json"
];
...
await writeText(
  "docs/phase449-yiyi-demo-review-facilitation-pack-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase449/yiyi-demo-review-facilitation-pack-closure-result.json", result);
