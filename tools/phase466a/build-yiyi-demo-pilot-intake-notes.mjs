import {
  ...
  writeJson,
  writeText
} from "../phase466-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase465/yiyi-demo-safety-boundary-cue-pack-closure-result.json");
...
await writeJson(`docs/phase466a-yiyi-demo-pilot-intake-notes.json`, packageJson);
await writeText(
  `docs/phase466a-yiyi-demo-pilot-intake-notes.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase466a/yiyi-demo-pilot-intake-notes-result.json`, result);
