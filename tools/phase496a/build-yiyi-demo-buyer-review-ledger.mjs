import {
  ...
  writeJson,
  writeText
} from "../phase496-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase495/yiyi-demo-safe-evaluation-notes-closure-result.json");
...
await writeJson(`docs/phase496a-yiyi-demo-buyer-review-ledger.json`, packageJson);
await writeText(
  `docs/phase496a-yiyi-demo-buyer-review-ledger.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase496a/yiyi-demo-buyer-review-ledger-result.json`, result);
