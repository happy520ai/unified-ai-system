...
writeJson(paths.godModeUsefulnessRecorder, records[paths.godModeUsefulnessRecorder]);
...
console.log(JSON.stringify({
  ...
  ownerUsefulnessScoreOwnerOnly: records[paths.godModeUsefulnessRecorder].ownerUsefulnessScoreOwnerOnly,
}, null, 2));
