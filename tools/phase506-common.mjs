...
export const phaseTitle = "Yiyi Demo Buyer Confidence Ledger";
export const phaseNumber = 506;
export const phaseName = "Phase506";
export const phaseSlug = "buyer-confidence-ledger";
export const phaseType = "commercial_demo_buyer_confidence_ledger";
export const phaseDeliverables = [
  "buyerConfidenceLedgerCreated",
  "buyerConfidenceChecklistCreated"
];
