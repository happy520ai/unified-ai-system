import {
  ...
  writeJson,
  writeText
} from "../phase468-common.mjs";

const requiredFiles = [
  "docs/phase468a-yiyi-demo-review-followthrough-notes.json",
  "docs/phase468a-yiyi-demo-review-followthrough-notes.md",
  "apps/ai-gateway-service/evidence/phase468a/yiyi-demo-review-followthrough-notes-result.json"
];
...
await writeText(
  "docs/phase468-yiyi-demo-review-followthrough-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase468/yiyi-demo-review-followthrough-notes-closure-result.json", result);
