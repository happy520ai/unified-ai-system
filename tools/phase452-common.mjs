...
export const phaseTitle = "Yiyi Demo Controlled Next-step Pack";
export const phaseNumber = 452;
export const phaseName = "Phase452";
export const phaseSlug = "controlled-nextstep-pack";
export const phaseType = "commercial_demo_controlled_nextstep_pack";
export const phaseDeliverables = [
  "controlledNextstepPackCreated",
  "nextstepChecklistCreated"
];
