...
const requiredFiles = [
  "docs/phase404a-yiyi-demo-channel-briefing-pack.json",
  "docs/phase404a-yiyi-demo-channel-briefing-pack.md",
  "apps/ai-gateway-service/evidence/phase404a/yiyi-demo-channel-briefing-pack-result.json"
];
...
await writeText(
  "docs/phase404-yiyi-demo-channel-briefing-pack-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase404/yiyi-demo-channel-briefing-pack-closure-result.json", result);
