...
export const phaseTitle = "Yiyi Demo Safe Continuation Notes";
export const phaseNumber = 482;
export const phaseName = "Phase482";
export const phaseSlug = "safe-continuation-notes";
export const phaseType = "commercial_demo_safe_continuation_notes";
export const phaseDeliverables = [
  "safeContinuationNotesCreated",
  "continuationChecklistCreated"
];
