import {
  ...
  writeJson,
  writeText
} from "../phase487-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase486/yiyi-demo-pilot-readiness-ledger-closure-result.json");
...
await writeJson(`docs/phase487a-yiyi-demo-buyer-journey-handoff.json`, packageJson);
await writeText(
  `docs/phase487a-yiyi-demo-buyer-journey-handoff.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase487a/yiyi-demo-buyer-journey-handoff-result.json`, result);
