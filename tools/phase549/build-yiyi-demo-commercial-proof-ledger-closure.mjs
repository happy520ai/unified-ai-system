...
const requiredFiles = [
  "docs/phase549a-yiyi-demo-commercial-proof-ledger.json",
  "docs/phase549a-yiyi-demo-commercial-proof-ledger.md",
  "apps/ai-gateway-service/evidence/phase549a/yiyi-demo-commercial-proof-ledger-result.json"
];
...
await writeText(
  "docs/phase549-yiyi-demo-commercial-proof-ledger-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase549/yiyi-demo-commercial-proof-ledger-closure-result.json", result);
