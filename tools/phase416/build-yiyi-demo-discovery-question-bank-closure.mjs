...
const requiredFiles = [
  "docs/phase416a-yiyi-demo-discovery-question-bank.json",
  "docs/phase416a-yiyi-demo-discovery-question-bank.md",
  "apps/ai-gateway-service/evidence/phase416a/yiyi-demo-discovery-question-bank-result.json"
];
...
await writeText(
  "docs/phase416-yiyi-demo-discovery-question-bank-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase416/yiyi-demo-discovery-question-bank-closure-result.json", result);
