...
const phaseMeta = {
  ...
  docPath: "docs/phase3056-3100-controlled-forty-tool-mutation.md",
  approvalPath: "docs/phase3056-3100-controlled-forty-tool-mutation-approval.example.json",
  runnerPath: "tools/phase3056_3100/apply-controlled-forty-tool-mutation.mjs",
  verifierPath: "tools/phase3056_3100/validate-controlled-forty-tool-mutation.mjs",
  resultDir: "apps/ai-gateway-service/evidence/phase3056-3100-controlled-forty-tool-mutation",
  resultPath: "apps/ai-gateway-service/evidence/phase3056-3100-controlled-forty-tool-mutation/result.json",
  resultMdPath: "apps/ai-gateway-service/evidence/phase3056-3100-controlled-forty-tool-mutation/result.md",
  rollbackPath: "apps/ai-gateway-service/evidence/phase3056-3100-controlled-forty-tool-mutation/rollback.json",
  smokePath: "apps/ai-gateway-service/evidence/phase3056-3100-controlled-forty-tool-mutation/forty-smoke.json",
  permissionMode: "controlled-forty-tool-source-mutation",
  label: "forty",
  runnerReadyField: "fortyRunnerReady",
  appliedField: "fortyMutationApplied",
  smokeField: "localFortySmokePassed",
  rollbackAction: "restore-previous-content-forty",
  verifyScript: "verify:phase3056-3100-controlled-forty-tool-mutation",
  applyScript: "apply:phase3056-3100-controlled-forty-tool-mutation",
  smokeScript: "smoke:phase3056-3100-controlled-forty-tool-mutation",
};
...
const previousPhaseMeta = {
  ...
  sealCheckId: "phase3055_sealed",
  sealCheckField: "thirtyNineMutationApplied",
  sealCheckBlocker: "phase3055_not_sealed",
};
...
async function buildProposalDiff(target, beforeText, afterText) {
  ...
  const tempDir = resolve("tmp/phase3056-3100-proposals");
...
function buildDoc() {
  return `# Phase3056A-3100A Controlled Forty Tool Mutation
  ...
  return JSON.stringify(
    {
      ...
      planId: "phase3056-3100-controlled-forty-tool-mutation",
      maxChangedFiles: 40,
      runNodeCheck: true,
      runLocalSmoke: true,
      approvalRecord: {
        ...
        approvedAtLeastOnceByOwner: [
          {
            ...
            scope: "phase3056-3100-controlled-forty-tool-mutation",
          },
        ],
...
${smokeMarkers}
  ...
  const result = {
    ...
    blocker: completed ? "none" : "forty_mutation_node_check_or_smoke_failed",
...
function buildBaseResult({ plan, validation, generatedAt, planPath }) {
  return {
    ...
    phase3055Sealed: validation.upstreamResults.some((entry) => entry.id === "${previousPhaseMeta.sealCheckId}" && entry.passed),
    codexExecExecuted: false,
    providerCallsMade: false,
    projectProviderCallsMade: false,
    secretRead: false,
...
function printSummary(result) {
  console.log(JSON.stringify({
    status: result.status,
    blocker: result.blocker,
    fortyMutationApplied: result.fortyMutationApplied,
    changedFileCount: result.changedFileCount,
    nodeCheckPassed: result.nodeCheckPassed,
    localFortySmokePassed: result.localFortySmokePassed,
...
const phase3055 = readJson("${previousPhaseMeta.resultPath}") || {};
...
check("${previousPhaseMeta.sealCheckId}", phase3055.recommendedSealed === true && phase3055.${previousPhaseMeta.sealCheckField} === true);
