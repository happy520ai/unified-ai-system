...
const requiredFiles = [
  "docs/phase521a-yiyi-demo-safe-commercial-index.json",
  "docs/phase521a-yiyi-demo-safe-commercial-index.md",
  "apps/ai-gateway-service/evidence/phase521a/yiyi-demo-safe-commercial-index-result.json"
];
...
await writeText(
  "docs/phase521-yiyi-demo-safe-commercial-index-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase521/yiyi-demo-safe-commercial-index-closure-result.json", result);
