...
export const phaseTitle = "Yiyi Demo Security FAQ Addendum";
export const phaseNumber = 429;
export const phaseName = "Phase429";
export const phaseSlug = "security-faq-addendum";
export const phaseType = "commercial_demo_security_faq_addendum";
export const phaseDeliverables = [
  "securityFaqAddendumCreated",
  "securityBoundaryChecklistCreated"
];
