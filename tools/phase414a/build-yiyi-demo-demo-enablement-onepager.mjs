import {
  ...
  writeJson,
  writeText
} from "../phase414-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase413/yiyi-demo-extended-low-risk-auto-run-closure-closure-result.json");
...
await writeJson(`docs/phase414a-yiyi-demo-demo-enablement-onepager.json`, packageJson);
await writeText(
  `docs/phase414a-yiyi-demo-demo-enablement-onepager.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase414a/yiyi-demo-demo-enablement-onepager-result.json`, result);
