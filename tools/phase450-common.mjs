...
export const phaseTitle = "Yiyi Demo Risk Acknowledgement Notes";
export const phaseNumber = 450;
export const phaseName = "Phase450";
export const phaseSlug = "risk-acknowledgement-notes";
export const phaseType = "commercial_demo_risk_acknowledgement_notes";
export const phaseDeliverables = [
  "riskAcknowledgementNotesCreated",
  "riskAcknowledgementChecklistCreated"
];
