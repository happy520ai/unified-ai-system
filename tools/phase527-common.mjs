...
export const phaseTitle = "Yiyi Demo Evidence Control Ledger";
export const phaseNumber = 527;
export const phaseName = "Phase527";
export const phaseSlug = "evidence-control-ledger";
export const phaseType = "commercial_demo_evidence_control_ledger";
export const phaseDeliverables = [
  "evidenceControlLedgerCreated",
  "evidenceControlChecklistCreated"
];
