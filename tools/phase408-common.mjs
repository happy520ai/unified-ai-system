...
export const phaseTitle = "Yiyi Demo Audience Question Routing Pack";
export const phaseNumber = 408;
export const phaseName = "Phase408";
export const phaseSlug = "audience-question-routing-pack";
export const phaseType = "commercial_demo_audience_question_routing_pack";
export const phaseDeliverables = [
  "questionRoutingPackCreated",
  "routingDecisionMapCreated"
];
