...
const requiredFiles = [
  "docs/phase559a-yiyi-demo-buyer-risk-framing-pack.json",
  "docs/phase559a-yiyi-demo-buyer-risk-framing-pack.md",
  "apps/ai-gateway-service/evidence/phase559a/yiyi-demo-buyer-risk-framing-pack-result.json"
];
...
await writeText(
  "docs/phase559-yiyi-demo-buyer-risk-framing-pack-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase559/yiyi-demo-buyer-risk-framing-pack-closure-result.json", result);
