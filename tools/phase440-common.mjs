...
export const phaseTitle = "Yiyi Demo Value Proof Notes";
export const phaseNumber = 440;
export const phaseName = "Phase440";
export const phaseSlug = "value-proof-notes";
export const phaseType = "commercial_demo_value_proof_notes";
export const phaseDeliverables = [
  "valueProofNotesCreated",
  "proofChecklistCreated"
];
