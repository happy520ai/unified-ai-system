...
export const phaseTitle = "Yiyi Demo Controlled Handoff Notes";
export const phaseNumber = 460;
export const phaseName = "Phase460";
export const phaseSlug = "controlled-handoff-notes";
export const phaseType = "commercial_demo_controlled_handoff_notes";
export const phaseDeliverables = [
  "controlledHandoffNotesCreated",
  "handoffNotesChecklistCreated"
];
