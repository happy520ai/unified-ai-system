...
export const phaseTitle = "Yiyi Demo Safe Review Brief";
export const phaseNumber = 525;
export const phaseName = "Phase525";
export const phaseSlug = "safe-review-brief";
export const phaseType = "commercial_demo_safe_review_brief";
export const phaseDeliverables = [
  "safeReviewBriefCreated",
  "safeReviewChecklistCreated"
];
