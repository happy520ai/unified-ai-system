...
const requiredFiles = [
  "docs/phase441a-yiyi-demo-safe-expansion-backlog.json",
  "docs/phase441a-yiyi-demo-safe-expansion-backlog.md",
  "apps/ai-gateway-service/evidence/phase441a/yiyi-demo-safe-expansion-backlog-result.json"
];
...
await writeText(
  "docs/phase441-yiyi-demo-safe-expansion-backlog-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase441/yiyi-demo-safe-expansion-backlog-closure-result.json", result);
