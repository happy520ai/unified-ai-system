...
const requiredFiles = [
  "docs/phase534a-yiyi-demo-commercial-safety-digest.json",
  "docs/phase534a-yiyi-demo-commercial-safety-digest.md",
  "apps/ai-gateway-service/evidence/phase534a/yiyi-demo-commercial-safety-digest-result.json"
];
...
await writeText(
  "docs/phase534-yiyi-demo-commercial-safety-digest-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase534/yiyi-demo-commercial-safety-digest-closure-result.json", result);
