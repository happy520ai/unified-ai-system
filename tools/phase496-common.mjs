...
export const phaseTitle = "Yiyi Demo Buyer Review Ledger";
export const phaseNumber = 496;
export const phaseName = "Phase496";
export const phaseSlug = "buyer-review-ledger";
export const phaseType = "commercial_demo_buyer_review_ledger";
export const phaseDeliverables = [
  "buyerReviewLedgerCreated",
  "buyerReviewChecklistCreated"
];
