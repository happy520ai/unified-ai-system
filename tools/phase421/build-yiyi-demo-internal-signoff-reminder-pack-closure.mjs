...
const requiredFiles = [
  "docs/phase421a-yiyi-demo-internal-signoff-reminder-pack.json",
  "docs/phase421a-yiyi-demo-internal-signoff-reminder-pack.md",
  "apps/ai-gateway-service/evidence/phase421a/yiyi-demo-internal-signoff-reminder-pack-result.json"
];
...
await writeText(
  "docs/phase421-yiyi-demo-internal-signoff-reminder-pack-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase421/yiyi-demo-internal-signoff-reminder-pack-closure-result.json", result);
