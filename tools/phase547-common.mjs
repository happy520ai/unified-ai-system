...
export const phaseTitle = "Yiyi Demo Controlled Security Notes";
export const phaseNumber = 547;
export const phaseName = "Phase547";
export const phaseSlug = "controlled-security-notes";
export const phaseType = "commercial_demo_controlled_security_notes";
export const phaseDeliverables = [
  "controlledSecurityNotesCreated",
  "controlledSecurityChecklistCreated"
];
