...
const requiredFiles = [
  "docs/phase531a-yiyi-demo-buyer-continuation-index.json",
  "docs/phase531a-yiyi-demo-buyer-continuation-index.md",
  "apps/ai-gateway-service/evidence/phase531a/yiyi-demo-buyer-continuation-index-result.json"
];
...
await writeText(
  "docs/phase531-yiyi-demo-buyer-continuation-index-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase531/yiyi-demo-buyer-continuation-index-closure-result.json", result);
