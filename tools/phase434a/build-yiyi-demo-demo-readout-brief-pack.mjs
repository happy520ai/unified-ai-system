import {
  ...
  writeJson,
  writeText
} from "../phase434-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase433/yiyi-demo-fourth-low-risk-auto-run-closure-closure-result.json");
...
await writeJson(`docs/phase434a-yiyi-demo-demo-readout-brief-pack.json`, packageJson);
await writeText(
  `docs/phase434a-yiyi-demo-demo-readout-brief-pack.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase434a/yiyi-demo-demo-readout-brief-pack-result.json`, result);
