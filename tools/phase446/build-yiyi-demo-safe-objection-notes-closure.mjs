...
const requiredFiles = [
  "docs/phase446a-yiyi-demo-safe-objection-notes.json",
  "docs/phase446a-yiyi-demo-safe-objection-notes.md",
  "apps/ai-gateway-service/evidence/phase446a/yiyi-demo-safe-objection-notes-result.json"
];
...
await writeText(
  "docs/phase446-yiyi-demo-safe-objection-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase446/yiyi-demo-safe-objection-notes-closure-result.json", result);
