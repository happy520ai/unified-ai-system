...
export const phaseTitle = "Yiyi Demo Pilot Proposal Outline";
export const phaseNumber = 412;
export const phaseName = "Phase412";
export const phaseSlug = "pilot-proposal-outline";
export const phaseType = "commercial_demo_pilot_proposal_outline";
export const phaseDeliverables = [
  "pilotProposalOutlineCreated",
  "pilotBoundaryNotesCreated"
];
