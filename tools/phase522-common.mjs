...
export const phaseTitle = "Yiyi Demo Low-risk Carry-forward Pack";
export const phaseNumber = 522;
export const phaseName = "Phase522";
export const phaseSlug = "lowrisk-carryforward-pack";
export const phaseType = "commercial_demo_lowrisk_carryforward_pack";
export const phaseDeliverables = [
  "lowriskCarryforwardPackCreated",
  "carryforwardChecklistCreated"
];
