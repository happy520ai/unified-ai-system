...
export const phaseTitle = "Yiyi Demo Operator Safety Ledger";
export const phaseNumber = 540;
export const phaseName = "Phase540";
export const phaseSlug = "operator-safety-ledger";
export const phaseType = "commercial_demo_operator_safety_ledger";
export const phaseDeliverables = [
  "operatorSafetyLedgerCreated",
  "operatorSafetyChecklistCreated"
];
