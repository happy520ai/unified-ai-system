...
export function buildPhase3495FortyEightMutationTargetFortySevenStatus() {
  return {
    phaseId: "Phase3495A-Controlled-Forty-Eight-Tool-Mutation-Target-Forty-Seven",
    ...
    phase3391Marker: "PHASE3391_FORTY_SIX_TOOL_TARGET_FORTY_SIX_OK",
    phase3443Marker: "PHASE3443_FORTY_SEVEN_TOOL_TARGET_FORTY_SEVEN_OK",
    phase3495Marker: "PHASE3495_FORTY_EIGHT_TOOL_TARGET_FORTY_SEVEN_OK",
...
export function buildPhase3548FortyNineMutationTargetFortySevenStatus() {
  return {
    phaseId: "Phase3548A-Controlled-Forty-Nine-Tool-Mutation-Target-Forty-Seven",
    ...
    phase3443Marker: "PHASE3443_FORTY_SEVEN_TOOL_TARGET_FORTY_SEVEN_OK",
    phase3495Marker: "PHASE3495_FORTY_EIGHT_TOOL_TARGET_FORTY_SEVEN_OK",
    phase3548Marker: "PHASE3548_FORTY_NINE_TOOL_TARGET_FORTY_SEVEN_OK",
...
export function buildPhase3602FiftyMutationTargetFortySevenStatus() {
  return {
    phaseId: "Phase3602A-Controlled-Fifty-Tool-Mutation-Target-Forty-Seven",
    ...
    phase3495Marker: "PHASE3495_FORTY_EIGHT_TOOL_TARGET_FORTY_SEVEN_OK",
    phase3548Marker: "PHASE3548_FORTY_NINE_TOOL_TARGET_FORTY_SEVEN_OK",
    phase3602Marker: "PHASE3602_FIFTY_TOOL_TARGET_FORTY_SEVEN_OK",
...
export function buildPhase3657FiftyOneMutationTargetFortySevenStatus() {
  return {
    phaseId: "Phase3657A-Controlled-Fifty-One-Tool-Mutation-Target-Forty-Seven",
    ...
    phase3548Marker: "PHASE3548_FORTY_NINE_TOOL_TARGET_FORTY_SEVEN_OK",
    phase3602Marker: "PHASE3602_FIFTY_TOOL_TARGET_FORTY_SEVEN_OK",
    phase3657Marker: "PHASE3657_FIFTY_ONE_TOOL_TARGET_FORTY_SEVEN_OK",
...
export function buildPhase3713FiftyTwoMutationTargetFortySevenStatus() {
  return {
    phaseId: "Phase3713A-Controlled-Fifty-Two-Tool-Mutation-Target-Forty-Seven",
    ...
    phase3602Marker: "PHASE3602_FIFTY_TOOL_TARGET_FORTY_SEVEN_OK",
    phase3657Marker: "PHASE3657_FIFTY_ONE_TOOL_TARGET_FORTY_SEVEN_OK",
    phase3713Marker: "PHASE3713_FIFTY_TWO_TOOL_TARGET_FORTY_SEVEN_OK",
...
export function buildPhase3770FiftyThreeMutationTargetFortySevenStatus() {
  return {
    phaseId: "Phase3770A-Controlled-Fifty-Three-Tool-Mutation-Target-Forty-Seven",
    ...
    phase3657Marker: "PHASE3657_FIFTY_ONE_TOOL_TARGET_FORTY_SEVEN_OK",
    phase3713Marker: "PHASE3713_FIFTY_TWO_TOOL_TARGET_FORTY_SEVEN_OK",
    phase3770Marker: "PHASE3770_FIFTY_THREE_TOOL_TARGET_FORTY_SEVEN_OK",
...
export function buildPhase3828FiftyFourMutationTargetFortySevenStatus() {
  return {
    phaseId: "Phase3828A-Controlled-Fifty-Four-Tool-Mutation-Target-Forty-Seven",
    ...
    phase3713Marker: "PHASE3713_FIFTY_TWO_TOOL_TARGET_FORTY_SEVEN_OK",
    phase3770Marker: "PHASE3770_FIFTY_THREE_TOOL_TARGET_FORTY_SEVEN_OK",
    phase3828Marker: "PHASE3828_FIFTY_FOUR_TOOL_TARGET_FORTY_SEVEN_OK",
...
export function buildPhase3887FiftyFiveMutationTargetFortySevenStatus() {
  return {
    phaseId: "Phase3887A-Controlled-Fifty-Five-Tool-Mutation-Target-Forty-Seven",
    ...
    phase3770Marker: "PHASE3770_FIFTY_THREE_TOOL_TARGET_FORTY_SEVEN_OK",
    phase3828Marker: "PHASE3828_FIFTY_FOUR_TOOL_TARGET_FORTY_SEVEN_OK",
    phase3887Marker: "PHASE3887_FIFTY_FIVE_TOOL_TARGET_FORTY_SEVEN_OK",
...
export function buildPhase3947FiftySixMutationTargetFortySevenStatus() {
  return {
    phaseId: "Phase3947A-Controlled-Fifty-Six-Tool-Mutation-Target-Forty-Seven",
    ...
    phase3828Marker: "PHASE3828_FIFTY_FOUR_TOOL_TARGET_FORTY_SEVEN_OK",
    phase3887Marker: "PHASE3887_FIFTY_FIVE_TOOL_TARGET_FORTY_SEVEN_OK",
    phase3947Marker: "PHASE3947_FIFTY_SIX_TOOL_TARGET_FORTY_SEVEN_OK",
...
export function main() {
  ...
  const planPath = args.plan || "docs/phase3341-3391-controlled-forty-six-tool-mutation-approval.example.json";
  ...
  if (!validation.valid) {
    const blocked = {
      ...
      fortySixMutationApplied: false,
      changedFileCount: 0,
      nodeCheckPassed: false,
      localFortySixSmokePassed: false,
  ...
  },
  {
    ...
    "args": [
      "-e",
      "import('./tools/phase2111_2120/apply-controlled-quint-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3351FortySixMutationTargetSixStatus())))"
    ]
  },
  {
    "id": "phase2121",
    ...
    "args": [
      "-e",
      "import('./tools/phase2121_2131/apply-controlled-sext-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3352FortySixMutationTargetSevenStatus())))"
    ]
  },
  {
    "id": "phase2132",
    ...
    "args": [
      "-e",
      "import('./tools/phase2132_2143/apply-controlled-sept-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3353FortySixMutationTargetEightStatus())))"
    ]
  },
  {
    "id": "phase2144",
    ...
    "args": [
      "-e",
      "import('./tools/phase2144_2156/apply-controlled-oct-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3354FortySixMutationTargetNineStatus())))"
    ]
  },
  {
    "id": "phase2157",
    ...
    "args": [
      "-e",
      "import('./tools/phase2157_2170/apply-controlled-nonet-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3355FortySixMutationTargetTenStatus())))"
    ]
  },
  {
    "id": "phase2171",
    ...
    "args": [
      "-e",
      "import('./tools/phase2171_2185/apply-controlled-deca-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3356FortySixMutationTargetElevenStatus())))"
    ]
  },
  {
    "id": "phase2186",
    ...
    "args": [
      "-e",
      "import('./tools/phase2186_2201/apply-controlled-eleven-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3357FortySixMutationTargetTwelveStatus())))"
    ]
  },
  {
    "id": "phase2202",
    ...
    "args": [
      "-e",
      "import('./tools/phase2202_2218/apply-controlled-twelve-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3358FortySixMutationTargetThirteenStatus())))"
    ]
  },
  {
    "id": "phase2219",
    ...
    "args": [
      "-e",
      "import('./tools/phase2219_2236/apply-controlled-thirteen-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3359FortySixMutationTargetFourteenStatus())))"
    ]
  },
  {
    "id": "phase2237",
    ...
    "args": [
      "-e",
      "import('./tools/phase2237_2255/apply-controlled-fourteen-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3360FortySixMutationTargetFifteenStatus())))"
    ]
  },
  {
    "id": "phase2256",
    ...
    "args": [
      "-e",
      "import('./tools/phase2256_2275/apply-controlled-fifteen-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3361FortySixMutationTargetSixteenStatus())))"
    ]
  },
  {
    "id": "phase2276",
    ...
    "args": [
      "-e",
      "import('./tools/phase2276_2296/apply-controlled-sixteen-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3362FortySixMutationTargetSeventeenStatus())))"
    ]
  },
  {
    "id": "phase2297",
    ...
    "args": [
      "-e",
      "import('./tools/phase2297_2318/apply-controlled-seventeen-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3363FortySixMutationTargetEighteenStatus())))"
    ]
  },
  {
    "id": "phase2319",
    ...
    "args": [
      "-e",
      "import('./tools/phase2319_2341/apply-controlled-eighteen-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3364FortySixMutationTargetNineteenStatus())))"
    ]
  },
  {
    "id": "phase2342",
    ...
    "args": [
      "-e",
      "import('./tools/phase2342_2365/apply-controlled-nineteen-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3365FortySixMutationTargetTwentyStatus())))"
    ]
  },
  {
    "id": "phase2366",
    ...
    "args": [
      "-e",
      "import('./tools/phase2366_2390/apply-controlled-twenty-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3366FortySixMutationTargetTwentyOneStatus())))"
    ]
  },
  {
    "id": "phase2391",
    ...
    "args": [
      "-e",
      "import('./tools/phase2391_2416/apply-controlled-twenty-one-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3367FortySixMutationTargetTwentyTwoStatus())))"
    ]
  },
  {
    "id": "phase2417",
    ...
    "args": [
      "-e",
      "import('./tools/phase2417_2443/apply-controlled-twenty-two-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3368FortySixMutationTargetTwentyThreeStatus())))"
    ]
  },
  {
    "id": "phase2444",
    ...
    "args": [
      "-e",
      "import('./tools/phase2444_2471/apply-controlled-twenty-three-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3369FortySixMutationTargetTwentyFourStatus())))"
    ]
  },
  {
    "id": "phase2472",
    ...
    "args": [
      "-e",
      "import('./tools/phase2472_2500/apply-controlled-twenty-four-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3370FortySixMutationTargetTwentyFiveStatus())))"
    ]
  },
  {
    "id": "phase2501",
    ...
    "args": [
      "-e",
      "import('./tools/phase2501_2530/apply-controlled-twenty-five-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3371FortySixMutationTargetTwentySixStatus())))"
    ]
  },
  {
    "id": "phase2531",
    ...
    "args": [
      "-e",
      "import('./tools/phase2531_2561/apply-controlled-twenty-six-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3372FortySixMutationTargetTwentySevenStatus())))"
    ]
  },
  {
    "id": "phase2562",
    ...
    "args": [
      "-e",
      "import('./tools/phase2562_2593/apply-controlled-twenty-seven-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3373FortySixMutationTargetTwentyEightStatus())))"
    ]
  },
  {
    "id": "phase2594",
    ...
    "args": [
      "-e",
      "import('./tools/phase2594_2626/apply-controlled-twenty-eight-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3374FortySixMutationTargetTwentyNineStatus())))"
    ]
  },
  {
    "id": "phase2627",
    ...
    "args": [
      "-e",
      "import('./tools/phase2627_2660/apply-controlled-twenty-nine-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3375FortySixMutationTargetThirtyStatus())))"
    ]
  },
  {
    "id": "phase2661",
    ...
    "args": [
      "-e",
      "import('./tools/phase2661_2695/apply-controlled-thirty-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3376FortySixMutationTargetThirtyOneStatus())))"
    ]
  },
  {
    "id": "phase2696",
    ...
    "args": [
      "-e",
      "import('./tools/phase2696_2731/apply-controlled-thirty-one-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3377FortySixMutationTargetThirtyTwoStatus())))"
    ]
  },
  {
    "id": "phase2732",
    ...
    "args": [
      "-e",
      "import('./tools/phase2732_2768/apply-controlled-thirty-two-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3378FortySixMutationTargetThirtyThreeStatus())))"
    ]
  },
  {
    "id": "phase2769",
    ...
    "args": [
      "-e",
      "import('./tools/phase2769_2806/apply-controlled-thirty-three-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3379FortySixMutationTargetThirtyFourStatus())))"
    ]
  },
  {
    "id": "phase2807",
    ...
    "args": [
      "-e",
      "import('./tools/phase2807_2845/apply-controlled-thirty-four-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3380FortySixMutationTargetThirtyFiveStatus())))"
    ]
  },
  {
    "id": "phase2846",
    ...
    "args": [
      "-e",
      "import('./tools/phase2846_2885/apply-controlled-thirty-five-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3381FortySixMutationTargetThirtySixStatus())))"
    ]
  },
  {
    "id": "phase2886",
    ...
    "args": [
      "-e",
      "import('./tools/phase2886_2926/apply-controlled-thirty-six-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3382FortySixMutationTargetThirtySevenStatus())))"
    ]
  },
  {
    "id": "phase2927",
    ...
    "args": [
      "-e",
      "import('./tools/phase2927_2968/apply-controlled-thirty-seven-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3383FortySixMutationTargetThirtyEightStatus())))"
    ]
  },
  {
    "id": "phase2969",
    ...
    "args": [
      "-e",
      "import('./tools/phase2969_3011/apply-controlled-thirty-eight-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3384FortySixMutationTargetThirtyNineStatus())))"
    ]
  },
  {
    "id": "phase3012",
    ...
    "args": [
      "-e",
      "import('./tools/phase3012_3055/apply-controlled-thirty-nine-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3385FortySixMutationTargetFortyStatus())))"
    ]
  },
  {
    "id": "phase3056",
    ...
    "args": [
      "-e",
      "import('./tools/phase3056_3100/apply-controlled-forty-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3386FortySixMutationTargetFortyOneStatus())))"
    ]
  },
  {
    "id": "phase3101",
    ...
    "args": [
      "-e",
      "import('./tools/phase3101_3146/apply-controlled-forty-one-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3387FortySixMutationTargetFortyTwoStatus())))"
    ]
  },
  {
    "id": "phase3147",
    ...
    "args": [
      "-e",
      "import('./tools/phase3147_3193/apply-controlled-forty-two-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3388FortySixMutationTargetFortyThreeStatus())))"
    ]
  },
  {
    "id": "phase3194",
    ...
    "args": [
      "-e",
      "import('./tools/phase3194_3241/apply-controlled-forty-three-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3389FortySixMutationTargetFortyFourStatus())))"
    ]
  },
  {
    "id": "phase3242",
    ...
    "args": [
      "-e",
      "import('./tools/phase3242_3290/apply-controlled-forty-four-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3390FortySixMutationTargetFortyFiveStatus())))"
    ]
  },
  {
    "id": "phase3291",
    ...
    "args": [
      "-e",
      "import('./tools/phase3291_3340/apply-controlled-forty-five-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3391FortySixMutationRuntimeStatus())))"
    ]
  }
]);
  ...
  const smokeResult = {
    ...
    status:
      ...
      smokePhase2091.parsed?.phase3346?.marker === "PHASE3346_FORTY_SIX_TOOL_TARGET_ONE_OK" &&
      ...
      smokePhase2092.parsed?.phase3347Marker === "PHASE3347_FORTY_SIX_TOOL_TARGET_TWO_OK" &&
      ...
      smokePhase2093.parsed?.phase3348Marker === "PHASE3348_FORTY_SIX_TOOL_TARGET_THREE_OK" &&
      ...
      smokePhase2096.parsed?.phase3349Marker === "PHASE3349_FORTY_SIX_TOOL_TARGET_FOUR_OK" &&
      ...
      smokePhase2101.parsed?.phase3350Marker === "PHASE3350_FORTY_SIX_TOOL_TARGET_FIVE_OK" &&
      smokePhase2111.parsed?.marker === "PHASE3351_FORTY_SIX_TOOL_TARGET_SIX_OK" &&
      ...
      smokePhase2121.parsed?.marker === "PHASE3352_FORTY_SIX_TOOL_TARGET_SEVEN_OK" &&
      ...
      smokePhase2132.parsed?.marker === "PHASE3353_FORTY_SIX_TOOL_TARGET_EIGHT_OK" &&
      ...
      smokePhase2144.parsed?.marker === "PHASE3354_FORTY_SIX_TOOL_TARGET_NINE_OK" &&
      ...
      smokePhase2157.parsed?.marker === "PHASE3355_FORTY_SIX_TOOL_TARGET_TEN_OK" &&
      ...
      smokePhase2171.parsed?.marker === "PHASE3356_FORTY_SIX_TOOL_TARGET_ELEVEN_OK" &&
      ...
      smokePhase2186.parsed?.marker === "PHASE3357_FORTY_SIX_TOOL_TARGET_TWELVE_OK" &&
      ...
      smokePhase2202.parsed?.marker === "PHASE3358_FORTY_SIX_TOOL_TARGET_THIRTEEN_OK" &&
      ...
      smokePhase2219.parsed?.marker === "PHASE3359_FORTY_SIX_TOOL_TARGET_FOURTEEN_OK" &&
      ...
      smokePhase2237.parsed?.marker === "PHASE3360_FORTY_SIX_TOOL_TARGET_FIFTEEN_OK" &&
      ...
      smokePhase2256.parsed?.marker === "PHASE3361_FORTY_SIX_TOOL_TARGET_SIXTEEN_OK" &&
      ...
      smokePhase2276.parsed?.marker === "PHASE3362_FORTY_SIX_TOOL_TARGET_SEVENTEEN_OK" &&
      ...
      smokePhase2297.parsed?.marker === "PHASE3363_FORTY_SIX_TOOL_TARGET_EIGHTEEN_OK" &&
      ...
      smokePhase2319.parsed?.marker === "PHASE3364_FORTY_SIX_TOOL_TARGET_NINETEEN_OK" &&
      ...
      smokePhase2342.parsed?.marker === "PHASE3365_FORTY_SIX_TOOL_TARGET_TWENTY_OK" &&
      ...
      smokePhase2366.parsed?.marker === "PHASE3366_FORTY_SIX_TOOL_TARGET_TWENTY_ONE_OK" &&
      ...
      smokePhase2391.parsed?.marker === "PHASE3367_FORTY_SIX_TOOL_TARGET_TWENTY_TWO_OK" &&
      ...
      smokePhase2417.parsed?.marker === "PHASE3368_FORTY_SIX_TOOL_TARGET_TWENTY_THREE_OK" &&
      ...
      smokePhase2444.parsed?.marker === "PHASE3369_FORTY_SIX_TOOL_TARGET_TWENTY_FOUR_OK" &&
      ...
      smokePhase2472.parsed?.marker === "PHASE3370_FORTY_SIX_TOOL_TARGET_TWENTY_FIVE_OK" &&
      ...
      smokePhase2501.parsed?.marker === "PHASE3371_FORTY_SIX_TOOL_TARGET_TWENTY_SIX_OK" &&
      ...
      smokePhase2531.parsed?.marker === "PHASE3372_FORTY_SIX_TOOL_TARGET_TWENTY_SEVEN_OK" &&
      ...
      smokePhase2562.parsed?.marker === "PHASE3373_FORTY_SIX_TOOL_TARGET_TWENTY_EIGHT_OK" &&
      ...
      smokePhase2594.parsed?.marker === "PHASE3374_FORTY_SIX_TOOL_TARGET_TWENTY_NINE_OK" &&
      ...
      smokePhase2627.parsed?.marker === "PHASE3375_FORTY_SIX_TOOL_TARGET_THIRTY_OK" &&
      ...
      smokePhase2661.parsed?.marker === "PHASE3376_FORTY_SIX_TOOL_TARGET_THIRTY_ONE_OK" &&
      ...
      smokePhase2696.parsed?.marker === "PHASE3377_FORTY_SIX_TOOL_TARGET_THIRTY_TWO_OK" &&
      ...
      smokePhase2732.parsed?.marker === "PHASE3378_FORTY_SIX_TOOL_TARGET_THIRTY_THREE_OK" &&
      ...
      smokePhase2769.parsed?.marker === "PHASE3379_FORTY_SIX_TOOL_TARGET_THIRTY_FOUR_OK" &&
      ...
      smokePhase2807.parsed?.marker === "PHASE3380_FORTY_SIX_TOOL_TARGET_THIRTY_FIVE_OK" &&
      ...
      smokePhase2846.parsed?.marker === "PHASE3381_FORTY_SIX_TOOL_TARGET_THIRTY_SIX_OK" &&
      ...
      smokePhase2886.parsed?.marker === "PHASE3382_FORTY_SIX_TOOL_TARGET_THIRTY_SEVEN_OK" &&
      ...
      smokePhase2927.parsed?.marker === "PHASE3383_FORTY_SIX_TOOL_TARGET_THIRTY_EIGHT_OK" &&
      ...
      smokePhase2969.parsed?.marker === "PHASE3384_FORTY_SIX_TOOL_TARGET_THIRTY_NINE_OK" &&
      ...
      smokePhase3012.parsed?.marker === "PHASE3385_FORTY_SIX_TOOL_TARGET_FORTY_OK" &&
      ...
      smokePhase3056.parsed?.marker === "PHASE3386_FORTY_SIX_TOOL_TARGET_FORTY_ONE_OK" &&
      ...
      smokePhase3101.parsed?.marker === "PHASE3387_FORTY_SIX_TOOL_TARGET_FORTY_TWO_OK" &&
      ...
      smokePhase3147.parsed?.marker === "PHASE3388_FORTY_SIX_TOOL_TARGET_FORTY_THREE_OK" &&
      ...
      smokePhase3194.parsed?.marker === "PHASE3389_FORTY_SIX_TOOL_TARGET_FORTY_FOUR_OK" &&
      ...
      smokePhase3242.parsed?.marker === "PHASE3390_FORTY_SIX_TOOL_TARGET_FORTY_FIVE_OK" &&
      ...
      smokePhase3291.parsed?.marker === "PHASE3391_FORTY_SIX_TOOL_TARGET_FORTY_SIX_OK" &&
      ...
      true
        ? "passed"
        : "failed",
    phase3346Marker: smokePhase2091.parsed?.phase3346?.marker || null,
    phase3347Marker: smokePhase2092.parsed?.phase3347Marker || null,
    phase3348Marker: smokePhase2093.parsed?.phase3348Marker || null,
    phase3349Marker: smokePhase2096.parsed?.phase3349Marker || null,
    phase3350Marker: smokePhase2101.parsed?.phase3350Marker || null,
    phase3351Marker: smokePhase2111.parsed?.phase3351Marker || null,
    phase3352Marker: smokePhase2121.parsed?.phase3352Marker || null,
    phase3353Marker: smokePhase2132.parsed?.phase3353Marker || null,
    phase3354Marker: smokePhase2144.parsed?.phase3354Marker || null,
    phase3355Marker: smokePhase2157.parsed?.phase3355Marker || null,
    phase3356Marker: smokePhase2171.parsed?.phase3356Marker || null,
    phase3357Marker: smokePhase2186.parsed?.phase3357Marker || null,
    phase3358Marker: smokePhase2202.parsed?.phase3358Marker || null,
    phase3359Marker: smokePhase2219.parsed?.phase3359Marker || null,
    phase3360Marker: smokePhase2237.parsed?.phase3360Marker || null,
    phase3361Marker: smokePhase2256.parsed?.phase3361Marker || null,
    phase3362Marker: smokePhase2276.parsed?.phase3362Marker || null,
    phase3363Marker: smokePhase2297.parsed?.phase3363Marker || null,
    phase3364Marker: smokePhase2319.parsed?.phase3364Marker || null,
    phase3365Marker: smokePhase2342.parsed?.phase3365Marker || null,
    phase3366Marker: smokePhase2366.parsed?.phase3366Marker || null,
    phase3367Marker: smokePhase2391.parsed?.phase3367Marker || null,
    phase3368Marker: smokePhase2417.parsed?.phase3368Marker || null,
    phase3369Marker: smokePhase2444.parsed?.phase3369Marker || null,
    phase3370Marker: smokePhase2472.parsed?.phase3370Marker || null,
    phase3371Marker: smokePhase2501.parsed?.phase3371Marker || null,
    phase3372Marker: smokePhase2531.parsed?.phase3372Marker || null,
    phase3373Marker: smokePhase2562.parsed?.phase3373Marker || null,
    phase3374Marker: smokePhase2594.parsed?.phase3374Marker || null,
    phase3375Marker: smokePhase2627.parsed?.phase3375Marker || null,
    phase3376Marker: smokePhase2661.parsed?.phase3376Marker || null,
    phase3377Marker: smokePhase2696.parsed?.phase3377Marker || null,
    phase3378Marker: smokePhase2732.parsed?.phase3378Marker || null,
    phase3379Marker: smokePhase2769.parsed?.phase3379Marker || null,
    phase3380Marker: smokePhase2807.parsed?.phase3380Marker || null,
    phase3381Marker: smokePhase2846.parsed?.phase3381Marker || null,
    phase3382Marker: smokePhase2886.parsed?.phase3382Marker || null,
    phase3383Marker: smokePhase2927.parsed?.phase3383Marker || null,
    phase3384Marker: smokePhase2969.parsed?.phase3384Marker || null,
    phase3385Marker: smokePhase3012.parsed?.phase3385Marker || null,
    phase3386Marker: smokePhase3056.parsed?.phase3386Marker || null,
    phase3387Marker: smokePhase3101.parsed?.phase3387Marker || null,
    phase3388Marker: smokePhase3147.parsed?.phase3388Marker || null,
    phase3389Marker: smokePhase3194.parsed?.phase3389Marker || null,
    phase3390Marker: smokePhase3242.parsed?.phase3390Marker || null,
    phase3391Marker: smokePhase3291.parsed?.phase3391Marker || null,
    providerCallsMade: false,
  ...
  const result = {
    ...
    localFortySixSmokePassed: smokeResult.status === "passed",
    smokePath,
...
function validatePlan(plan) {
  return validateControlledMutationPlan({
    ...
    expectedPermissionMode: "controlled-forty-six-tool-source-mutation",
    expectedOperationCount: 46,
    expectedMaxChangedFiles: 46,
    requiredAllowedFiles: [
    "apps/ai-gateway-service/evidence/phase3341-3391-controlled-forty-six-tool-mutation/result.json",
    "apps/ai-gateway-service/evidence/phase3341-3391-controlled-forty-six-tool-mutation/result.md",
    "apps/ai-gateway-service/evidence/phase3341-3391-controlled-forty-six-tool-mutation/rollback.json",
    "apps/ai-gateway-service/evidence/phase3341-3391-controlled-forty-six-tool-mutation/forty-six-smoke.json",
    "docs/phase3346-forty-six-tool-mutation-target-one.proposal.diff",
    "docs/phase3347-forty-six-tool-mutation-target-two.proposal.diff",
    "docs/phase3348-forty-six-tool-mutation-target-three.proposal.diff",
    "docs/phase3349-forty-six-tool-mutation-target-four.proposal.diff",
    "docs/phase3350-forty-six-tool-mutation-target-five.proposal.diff",
    "docs/phase3351-forty-six-tool-mutation-target-six.proposal.diff",
    "docs/phase3352-forty-six-tool-mutation-target-seven.proposal.diff",
    "docs/phase3353-forty-six-tool-mutation-target-eight.proposal.diff",
    "docs/phase3354-forty-six-tool-mutation-target-nine.proposal.diff",
    "docs/phase3355-forty-six-tool-mutation-target-ten.proposal.diff",
    "docs/phase3356-forty-six-tool-mutation-target-eleven.proposal.diff",
    "docs/phase3357-forty-six-tool-mutation-target-twelve.proposal.diff",
    "docs/phase3358-forty-six-tool-mutation-target-thirteen.proposal.diff",
    "docs/phase3359-forty-six-tool-mutation-target-fourteen.proposal.diff",
    "docs/phase3360-forty-six-tool-mutation-target-fifteen.proposal.diff",
    "docs/phase3361-forty-six-tool-mutation-target-sixteen.proposal.diff",
    "docs/phase3362-forty-six-tool-mutation-target-seventeen.proposal.diff",
    "docs/phase3363-forty-six-tool-mutation-target-eighteen.proposal.diff",
    "docs/phase3364-forty-six-tool-mutation-target-nineteen.proposal.diff",
    "docs/phase3365-forty-six-tool-mutation-target-twenty.proposal.diff",
    "docs/phase3366-forty-six-tool-mutation-target-twenty-one.proposal.diff",
    "docs/phase3367-forty-six-tool-mutation-target-twenty-two.proposal.diff",
    "docs/phase3368-forty-six-tool-mutation-target-twenty-three.proposal.diff",
    "docs/phase3369-forty-six-tool-mutation-target-twenty-four.proposal.diff",
    "docs/phase3370-forty-six-tool-mutation-target-twenty-five.proposal.diff",
    "docs/phase3371-forty-six-tool-mutation-target-twenty-six.proposal.diff",
    "docs/phase3372-forty-six-tool-mutation-target-twenty-seven.proposal.diff",
    "docs/phase3373-forty-six-tool-mutation-target-twenty-eight.proposal.diff",
    "docs/phase3374-forty-six-tool-mutation-target-twenty-nine.proposal.diff",
    "docs/phase3375-forty-six-tool-mutation-target-thirty.proposal.diff",
    "docs/phase3376-forty-six-tool-mutation-target-thirty-one.proposal.diff",
    "docs/phase3377-forty-six-tool-mutation-target-thirty-two.proposal.diff",
    "docs/phase3378-forty-six-tool-mutation-target-thirty-three.proposal.diff",
    "docs/phase3379-forty-six-tool-mutation-target-thirty-four.proposal.diff",
    "docs/phase3380-forty-six-tool-mutation-target-thirty-five.proposal.diff",
    "docs/phase3381-forty-six-tool-mutation-target-thirty-six.proposal.diff",
    "docs/phase3382-forty-six-tool-mutation-target-thirty-seven.proposal.diff",
    "docs/phase3383-forty-six-tool-mutation-target-thirty-eight.proposal.diff",
    "docs/phase3384-forty-six-tool-mutation-target-thirty-nine.proposal.diff",
    "docs/phase3385-forty-six-tool-mutation-target-forty.proposal.diff",
    "docs/phase3386-forty-six-tool-mutation-target-forty-one.proposal.diff",
    "docs/phase3387-forty-six-tool-mutation-target-forty-two.proposal.diff",
    "docs/phase3388-forty-six-tool-mutation-target-forty-three.proposal.diff",
    "docs/phase3389-forty-six-tool-mutation-target-forty-four.proposal.diff",
    "docs/phase3390-forty-six-tool-mutation-target-forty-five.proposal.diff",
    "docs/phase3391-forty-six-tool-mutation-target-forty-six.proposal.diff",
    "tools/phase2091/generated-source-patch-target.mjs",
    ...
    upstreamChecks: [
      ...
      {
        id: "phase3340_sealed",
        path: "apps/ai-gateway-service/evidence/phase3291-3340-controlled-forty-five-tool-mutation/result.json",
        predicate: (evidence) => evidence.recommendedSealed === true && evidence.fortyFiveMutationApplied === true,
        blocker: "phase3340_not_sealed",
      },
    ],
...
function buildBaseResult({ plan, validation, generatedAt, planPath }) {
  return {
    ...
    phase3340Sealed: validation.upstreamResults.some((entry) => entry.id === "phase3340_sealed" && entry.passed),
    codexExecExecuted: false,
    providerCallsMade: false,
    projectProviderCallsMade: false,
    secretRead: false,
