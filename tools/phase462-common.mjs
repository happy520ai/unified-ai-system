...
export const phaseTitle = "Yiyi Demo Low-risk Wrap-up Pack";
export const phaseNumber = 462;
export const phaseName = "Phase462";
export const phaseSlug = "lowrisk-wrapup-pack";
export const phaseType = "commercial_demo_lowrisk_wrapup_pack";
export const phaseDeliverables = [
  "lowriskWrapupPackCreated",
  "wrapupChecklistCreated"
];
