...
const requiredFiles = [
  "docs/phase405a-yiyi-demo-session-agenda-templates.json",
  "docs/phase405a-yiyi-demo-session-agenda-templates.md",
  "apps/ai-gateway-service/evidence/phase405a/yiyi-demo-session-agenda-templates-result.json"
];
...
await writeText(
  "docs/phase405-yiyi-demo-session-agenda-templates-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase405/yiyi-demo-session-agenda-templates-closure-result.json", result);
