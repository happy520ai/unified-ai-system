import {
  ...
  writeJson,
  writeText
} from "../phase459-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase458/yiyi-demo-facilitation-backup-cards-closure-result.json");
...
await writeJson(`docs/phase459a-yiyi-demo-known-boundary-recap.json`, packageJson);
await writeText(
  `docs/phase459a-yiyi-demo-known-boundary-recap.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase459a/yiyi-demo-known-boundary-recap-result.json`, result);
