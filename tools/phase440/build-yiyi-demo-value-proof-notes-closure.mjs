...
const requiredFiles = [
  "docs/phase440a-yiyi-demo-value-proof-notes.json",
  "docs/phase440a-yiyi-demo-value-proof-notes.md",
  "apps/ai-gateway-service/evidence/phase440a/yiyi-demo-value-proof-notes-result.json"
];
...
await writeText(
  "docs/phase440-yiyi-demo-value-proof-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase440/yiyi-demo-value-proof-notes-closure-result.json", result);
