...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase395/yiyi-demo-evidence-index-refresh-trace-map-closure-result.json");
...
await writeJson(`docs/phase396a-yiyi-demo-risk-register-mitigation-notes.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase396a/yiyi-demo-risk-register-mitigation-notes-result.json`, result);
