import {
  ...
  writeJson,
  writeText
} from "../phase442-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase441/yiyi-demo-safe-expansion-backlog-closure-result.json");
...
await writeJson(`docs/phase442a-yiyi-demo-review-board-packet.json`, packageJson);
await writeText(
  `docs/phase442a-yiyi-demo-review-board-packet.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase442a/yiyi-demo-review-board-packet-result.json`, result);
