...
const requiredFiles = [
  "docs/phase484a-yiyi-demo-commercial-decision-brief.json",
  "docs/phase484a-yiyi-demo-commercial-decision-brief.md",
  "apps/ai-gateway-service/evidence/phase484a/yiyi-demo-commercial-decision-brief-result.json"
];
...
await writeText(
  "docs/phase484-yiyi-demo-commercial-decision-brief-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase484/yiyi-demo-commercial-decision-brief-closure-result.json", result);
