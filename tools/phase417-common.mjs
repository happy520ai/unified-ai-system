...
export const phaseTitle = "Yiyi Demo Demo-to-POC Bridge Notes";
export const phaseNumber = 417;
export const phaseName = "Phase417";
export const phaseSlug = "demo-to-poc-bridge-notes";
export const phaseType = "commercial_demo_to_poc_bridge_notes";
export const phaseDeliverables = [
  "demoToPocBridgeNotesCreated",
  "bridgeBoundaryChecklistCreated"
];
