import {
  ...
  writeJson,
  writeText
} from "../phase494-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase493/yiyi-demo-tenth-low-risk-auto-run-closure-closure-result.json");
...
await writeJson(`docs/phase494a-yiyi-demo-commercial-proof-digest.json`, packageJson);
await writeText(
  `docs/phase494a-yiyi-demo-commercial-proof-digest.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase494a/yiyi-demo-commercial-proof-digest-result.json`, result);
