...
export const phaseTitle = "Yiyi Demo Support Intake Template";
export const phaseNumber = 438;
export const phaseName = "Phase438";
export const phaseSlug = "support-intake-template";
export const phaseType = "commercial_demo_support_intake_template";
export const phaseDeliverables = [
  "supportIntakeTemplateCreated",
  "intakeChecklistCreated"
];
