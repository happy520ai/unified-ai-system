...
export const phaseTitle = "Yiyi Demo Proof Point Cue Sheet";
export const phaseNumber = 461;
export const phaseName = "Phase461";
export const phaseSlug = "proof-point-cue-sheet";
export const phaseType = "commercial_demo_proof_point_cue_sheet";
export const phaseDeliverables = [
  "proofPointCueSheetCreated",
  "cueSheetChecklistCreated"
];
