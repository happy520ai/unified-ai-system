...
const requiredFiles = [
  "docs/phase562a-yiyi-demo-safe-continuity-brief.json",
  "docs/phase562a-yiyi-demo-safe-continuity-brief.md",
  "apps/ai-gateway-service/evidence/phase562a/yiyi-demo-safe-continuity-brief-result.json"
];
...
await writeText(
  "docs/phase562-yiyi-demo-safe-continuity-brief-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase562/yiyi-demo-safe-continuity-brief-closure-result.json", result);
