import {
  ...
  writeJson,
  writeText
} from "../phase560-common.mjs";

const requiredFiles = [
  "docs/phase560a-yiyi-demo-review-continuation-ledger.json",
  "docs/phase560a-yiyi-demo-review-continuation-ledger.md",
  "apps/ai-gateway-service/evidence/phase560a/yiyi-demo-review-continuation-ledger-result.json"
];
...
await writeText(
  "docs/phase560-yiyi-demo-review-continuation-ledger-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase560/yiyi-demo-review-continuation-ledger-closure-result.json", result);
