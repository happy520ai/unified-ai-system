...
export const phaseTitle = "Yiyi Demo Twelfth Low-risk Auto-run Closure";
export const phaseNumber = 513;
export const phaseName = "Phase513";
export const phaseSlug = "twelfth-low-risk-auto-run-closure";
export const phaseType = "commercial_demo_twelfth_low_risk_auto_run_closure";
export const phaseDeliverables = [
  "twelfthLowRiskClosureCreated",
