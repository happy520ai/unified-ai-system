import {
  ...
  writeJson,
  writeText
} from "../phase530-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase529/yiyi-demo-controlled-readiness-notes-closure-result.json");
...
await writeJson(`docs/phase530a-yiyi-demo-operator-assurance-pack.json`, packageJson);
await writeText(
  `docs/phase530a-yiyi-demo-operator-assurance-pack.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase530a/yiyi-demo-operator-assurance-pack-result.json`, result);
