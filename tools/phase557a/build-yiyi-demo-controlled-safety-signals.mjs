import {
  ...
  writeJson,
  writeText
} from "../phase557-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase556/yiyi-demo-evidence-reliability-ledger-closure-result.json");
...
await writeJson(`docs/phase557a-yiyi-demo-controlled-safety-signals.json`, packageJson);
await writeText(
  `docs/phase557a-yiyi-demo-controlled-safety-signals.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase557a/yiyi-demo-controlled-safety-signals-result.json`, result);
