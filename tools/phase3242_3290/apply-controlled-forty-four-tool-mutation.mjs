...
export function buildPhase3390FortySixMutationTargetFortyFiveStatus() {
  return {
    phaseId: "Phase3390A-Controlled-Forty-Six-Tool-Mutation-Target-Forty-Five",
    ...
    phase3290Marker: "PHASE3290_FORTY_FOUR_TOOL_TARGET_FORTY_FOUR_OK",
    phase3340Marker: "PHASE3340_FORTY_FIVE_TOOL_TARGET_FORTY_FIVE_OK",
    phase3390Marker: "PHASE3390_FORTY_SIX_TOOL_TARGET_FORTY_FIVE_OK",
...
export function buildPhase3441FortySevenMutationTargetFortyFiveStatus() {
  return {
    phaseId: "Phase3441A-Controlled-Forty-Seven-Tool-Mutation-Target-Forty-Five",
    ...
    phase3340Marker: "PHASE3340_FORTY_FIVE_TOOL_TARGET_FORTY_FIVE_OK",
    phase3390Marker: "PHASE3390_FORTY_SIX_TOOL_TARGET_FORTY_FIVE_OK",
    phase3441Marker: "PHASE3441_FORTY_SEVEN_TOOL_TARGET_FORTY_FIVE_OK",
...
export function buildPhase3493FortyEightMutationTargetFortyFiveStatus() {
  return {
    phaseId: "Phase3493A-Controlled-Forty-Eight-Tool-Mutation-Target-Forty-Five",
    ...
    phase3390Marker: "PHASE3390_FORTY_SIX_TOOL_TARGET_FORTY_FIVE_OK",
    phase3441Marker: "PHASE3441_FORTY_SEVEN_TOOL_TARGET_FORTY_FIVE_OK",
    phase3493Marker: "PHASE3493_FORTY_EIGHT_TOOL_TARGET_FORTY_FIVE_OK",
...
export function buildPhase3546FortyNineMutationTargetFortyFiveStatus() {
  return {
    phaseId: "Phase3546A-Controlled-Forty-Nine-Tool-Mutation-Target-Forty-Five",
    ...
    phase3441Marker: "PHASE3441_FORTY_SEVEN_TOOL_TARGET_FORTY_FIVE_OK",
    phase3493Marker: "PHASE3493_FORTY_EIGHT_TOOL_TARGET_FORTY_FIVE_OK",
    phase3546Marker: "PHASE3546_FORTY_NINE_TOOL_TARGET_FORTY_FIVE_OK",
...
export function buildPhase3600FiftyMutationTargetFortyFiveStatus() {
  return {
    phaseId: "Phase3600A-Controlled-Fifty-Tool-Mutation-Target-Forty-Five",
    ...
    phase3493Marker: "PHASE3493_FORTY_EIGHT_TOOL_TARGET_FORTY_FIVE_OK",
    phase3546Marker: "PHASE3546_FORTY_NINE_TOOL_TARGET_FORTY_FIVE_OK",
    phase3600Marker: "PHASE3600_FIFTY_TOOL_TARGET_FORTY_FIVE_OK",
...
export function buildPhase3655FiftyOneMutationTargetFortyFiveStatus() {
  return {
    phaseId: "Phase3655A-Controlled-Fifty-One-Tool-Mutation-Target-Forty-Five",
    ...
    phase3546Marker: "PHASE3546_FORTY_NINE_TOOL_TARGET_FORTY_FIVE_OK",
    phase3600Marker: "PHASE3600_FIFTY_TOOL_TARGET_FORTY_FIVE_OK",
    phase3655Marker: "PHASE3655_FIFTY_ONE_TOOL_TARGET_FORTY_FIVE_OK",
...
export function buildPhase3711FiftyTwoMutationTargetFortyFiveStatus() {
  return {
    phaseId: "Phase3711A-Controlled-Fifty-Two-Tool-Mutation-Target-Forty-Five",
    ...
    phase3600Marker: "PHASE3600_FIFTY_TOOL_TARGET_FORTY_FIVE_OK",
    phase3655Marker: "PHASE3655_FIFTY_ONE_TOOL_TARGET_FORTY_FIVE_OK",
    phase3711Marker: "PHASE3711_FIFTY_TWO_TOOL_TARGET_FORTY_FIVE_OK",
...
export function buildPhase3768FiftyThreeMutationTargetFortyFiveStatus() {
  return {
    phaseId: "Phase3768A-Controlled-Fifty-Three-Tool-Mutation-Target-Forty-Five",
    ...
    phase3655Marker: "PHASE3655_FIFTY_ONE_TOOL_TARGET_FORTY_FIVE_OK",
    phase3711Marker: "PHASE3711_FIFTY_TWO_TOOL_TARGET_FORTY_FIVE_OK",
    phase3768Marker: "PHASE3768_FIFTY_THREE_TOOL_TARGET_FORTY_FIVE_OK",
...
export function buildPhase3826FiftyFourMutationTargetFortyFiveStatus() {
  return {
    phaseId: "Phase3826A-Controlled-Fifty-Four-Tool-Mutation-Target-Forty-Five",
    ...
    phase3711Marker: "PHASE3711_FIFTY_TWO_TOOL_TARGET_FORTY_FIVE_OK",
    phase3768Marker: "PHASE3768_FIFTY_THREE_TOOL_TARGET_FORTY_FIVE_OK",
    phase3826Marker: "PHASE3826_FIFTY_FOUR_TOOL_TARGET_FORTY_FIVE_OK",
...
export function buildPhase3885FiftyFiveMutationTargetFortyFiveStatus() {
  return {
    phaseId: "Phase3885A-Controlled-Fifty-Five-Tool-Mutation-Target-Forty-Five",
    ...
    phase3768Marker: "PHASE3768_FIFTY_THREE_TOOL_TARGET_FORTY_FIVE_OK",
    phase3826Marker: "PHASE3826_FIFTY_FOUR_TOOL_TARGET_FORTY_FIVE_OK",
    phase3885Marker: "PHASE3885_FIFTY_FIVE_TOOL_TARGET_FORTY_FIVE_OK",
...
export function buildPhase3945FiftySixMutationTargetFortyFiveStatus() {
  return {
    phaseId: "Phase3945A-Controlled-Fifty-Six-Tool-Mutation-Target-Forty-Five",
    ...
    phase3826Marker: "PHASE3826_FIFTY_FOUR_TOOL_TARGET_FORTY_FIVE_OK",
    phase3885Marker: "PHASE3885_FIFTY_FIVE_TOOL_TARGET_FORTY_FIVE_OK",
    phase3945Marker: "PHASE3945_FIFTY_SIX_TOOL_TARGET_FORTY_FIVE_OK",
...
export function main() {
  ...
  const planPath = args.plan || "docs/phase3242-3290-controlled-forty-four-tool-mutation-approval.example.json";
  ...
  if (!validation.valid) {
    const blocked = {
      ...
      fortyFourMutationApplied: false,
      changedFileCount: 0,
      nodeCheckPassed: false,
      localFortyFourSmokePassed: false,
  ...
  },
  {
    ...
    "args": [
      "-e",
      "import('./tools/phase2111_2120/apply-controlled-quint-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3252FortyFourMutationTargetSixStatus())))"
    ]
  },
  {
    "id": "phase2121",
    ...
    "args": [
      "-e",
      "import('./tools/phase2121_2131/apply-controlled-sext-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3253FortyFourMutationTargetSevenStatus())))"
    ]
  },
  {
    "id": "phase2132",
    ...
    "args": [
      "-e",
      "import('./tools/phase2132_2143/apply-controlled-sept-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3254FortyFourMutationTargetEightStatus())))"
    ]
  },
  {
    "id": "phase2144",
    ...
    "args": [
      "-e",
      "import('./tools/phase2144_2156/apply-controlled-oct-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3255FortyFourMutationTargetNineStatus())))"
    ]
  },
  {
    "id": "phase2157",
    ...
    "args": [
      "-e",
      "import('./tools/phase2157_2170/apply-controlled-nonet-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3256FortyFourMutationTargetTenStatus())))"
    ]
  },
  {
    "id": "phase2171",
    ...
    "args": [
      "-e",
      "import('./tools/phase2171_2185/apply-controlled-deca-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3257FortyFourMutationTargetElevenStatus())))"
    ]
  },
  {
    "id": "phase2186",
    ...
    "args": [
      "-e",
      "import('./tools/phase2186_2201/apply-controlled-eleven-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3258FortyFourMutationTargetTwelveStatus())))"
    ]
  },
  {
    "id": "phase2202",
    ...
    "args": [
      "-e",
      "import('./tools/phase2202_2218/apply-controlled-twelve-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3259FortyFourMutationTargetThirteenStatus())))"
    ]
  },
  {
    "id": "phase2219",
    ...
    "args": [
      "-e",
      "import('./tools/phase2219_2236/apply-controlled-thirteen-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3260FortyFourMutationTargetFourteenStatus())))"
    ]
  },
  {
    "id": "phase2237",
    ...
    "args": [
      "-e",
      "import('./tools/phase2237_2255/apply-controlled-fourteen-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3261FortyFourMutationTargetFifteenStatus())))"
    ]
  },
  {
    "id": "phase2256",
    ...
    "args": [
      "-e",
      "import('./tools/phase2256_2275/apply-controlled-fifteen-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3262FortyFourMutationTargetSixteenStatus())))"
    ]
  },
  {
    "id": "phase2276",
    ...
    "args": [
      "-e",
      "import('./tools/phase2276_2296/apply-controlled-sixteen-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3263FortyFourMutationTargetSeventeenStatus())))"
    ]
  },
  {
    "id": "phase2297",
    ...
    "args": [
      "-e",
      "import('./tools/phase2297_2318/apply-controlled-seventeen-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3264FortyFourMutationTargetEighteenStatus())))"
    ]
  },
  {
    "id": "phase2319",
    ...
    "args": [
      "-e",
      "import('./tools/phase2319_2341/apply-controlled-eighteen-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3265FortyFourMutationTargetNineteenStatus())))"
    ]
  },
  {
    "id": "phase2342",
    ...
    "args": [
      "-e",
      "import('./tools/phase2342_2365/apply-controlled-nineteen-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3266FortyFourMutationTargetTwentyStatus())))"
    ]
  },
  {
    "id": "phase2366",
    ...
    "args": [
      "-e",
      "import('./tools/phase2366_2390/apply-controlled-twenty-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3267FortyFourMutationTargetTwentyOneStatus())))"
    ]
  },
  {
    "id": "phase2391",
    ...
    "args": [
      "-e",
      "import('./tools/phase2391_2416/apply-controlled-twenty-one-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3268FortyFourMutationTargetTwentyTwoStatus())))"
    ]
  },
  {
    "id": "phase2417",
    ...
    "args": [
      "-e",
      "import('./tools/phase2417_2443/apply-controlled-twenty-two-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3269FortyFourMutationTargetTwentyThreeStatus())))"
    ]
  },
  {
    "id": "phase2444",
    ...
    "args": [
      "-e",
      "import('./tools/phase2444_2471/apply-controlled-twenty-three-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3270FortyFourMutationTargetTwentyFourStatus())))"
    ]
  },
  {
    "id": "phase2472",
    ...
    "args": [
      "-e",
      "import('./tools/phase2472_2500/apply-controlled-twenty-four-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3271FortyFourMutationTargetTwentyFiveStatus())))"
    ]
  },
  {
    "id": "phase2501",
    ...
    "args": [
      "-e",
      "import('./tools/phase2501_2530/apply-controlled-twenty-five-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3272FortyFourMutationTargetTwentySixStatus())))"
    ]
  },
  {
    "id": "phase2531",
    ...
    "args": [
      "-e",
      "import('./tools/phase2531_2561/apply-controlled-twenty-six-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3273FortyFourMutationTargetTwentySevenStatus())))"
    ]
  },
  {
    "id": "phase2562",
    ...
    "args": [
      "-e",
      "import('./tools/phase2562_2593/apply-controlled-twenty-seven-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3274FortyFourMutationTargetTwentyEightStatus())))"
    ]
  },
  {
    "id": "phase2594",
    ...
    "args": [
      "-e",
      "import('./tools/phase2594_2626/apply-controlled-twenty-eight-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3275FortyFourMutationTargetTwentyNineStatus())))"
    ]
  },
  {
    "id": "phase2627",
    ...
    "args": [
      "-e",
      "import('./tools/phase2627_2660/apply-controlled-twenty-nine-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3276FortyFourMutationTargetThirtyStatus())))"
    ]
  },
  {
    "id": "phase2661",
    ...
    "args": [
      "-e",
      "import('./tools/phase2661_2695/apply-controlled-thirty-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3277FortyFourMutationTargetThirtyOneStatus())))"
    ]
  },
  {
    "id": "phase2696",
    ...
    "args": [
      "-e",
      "import('./tools/phase2696_2731/apply-controlled-thirty-one-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3278FortyFourMutationTargetThirtyTwoStatus())))"
    ]
  },
  {
    "id": "phase2732",
    ...
    "args": [
      "-e",
      "import('./tools/phase2732_2768/apply-controlled-thirty-two-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3279FortyFourMutationTargetThirtyThreeStatus())))"
    ]
  },
  {
    "id": "phase2769",
    ...
    "args": [
      "-e",
      "import('./tools/phase2769_2806/apply-controlled-thirty-three-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3280FortyFourMutationTargetThirtyFourStatus())))"
    ]
  },
  {
    "id": "phase2807",
    ...
    "args": [
      "-e",
      "import('./tools/phase2807_2845/apply-controlled-thirty-four-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3281FortyFourMutationTargetThirtyFiveStatus())))"
    ]
  },
  {
    "id": "phase2846",
    ...
    "args": [
      "-e",
      "import('./tools/phase2846_2885/apply-controlled-thirty-five-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3282FortyFourMutationTargetThirtySixStatus())))"
    ]
  },
  {
    "id": "phase2886",
    ...
    "args": [
      "-e",
      "import('./tools/phase2886_2926/apply-controlled-thirty-six-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3283FortyFourMutationTargetThirtySevenStatus())))"
    ]
  },
  {
    "id": "phase2927",
    ...
    "args": [
      "-e",
      "import('./tools/phase2927_2968/apply-controlled-thirty-seven-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3284FortyFourMutationTargetThirtyEightStatus())))"
    ]
  },
  {
    "id": "phase2969",
    ...
    "args": [
      "-e",
      "import('./tools/phase2969_3011/apply-controlled-thirty-eight-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3285FortyFourMutationTargetThirtyNineStatus())))"
    ]
  },
  {
    "id": "phase3012",
    ...
    "args": [
      "-e",
      "import('./tools/phase3012_3055/apply-controlled-thirty-nine-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3286FortyFourMutationTargetFortyStatus())))"
    ]
  },
  {
    "id": "phase3056",
    ...
    "args": [
      "-e",
      "import('./tools/phase3056_3100/apply-controlled-forty-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3287FortyFourMutationTargetFortyOneStatus())))"
    ]
  },
  {
    "id": "phase3101",
    ...
    "args": [
      "-e",
      "import('./tools/phase3101_3146/apply-controlled-forty-one-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3288FortyFourMutationTargetFortyTwoStatus())))"
    ]
  },
  {
    "id": "phase3147",
    ...
    "args": [
      "-e",
      "import('./tools/phase3147_3193/apply-controlled-forty-two-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3289FortyFourMutationTargetFortyThreeStatus())))"
    ]
  },
  {
    "id": "phase3194",
    ...
    "args": [
      "-e",
      "import('./tools/phase3194_3241/apply-controlled-forty-three-tool-mutation.mjs').then(m=>console.log(JSON.stringify(m.buildPhase3290FortyFourMutationRuntimeStatus())))"
    ]
  }
]);
  ...
  const smokeResult = {
    ...
    status:
      ...
      smokePhase2091.parsed?.phase3247?.marker === "PHASE3247_FORTY_FOUR_TOOL_TARGET_ONE_OK" &&
      ...
      smokePhase2092.parsed?.phase3248Marker === "PHASE3248_FORTY_FOUR_TOOL_TARGET_TWO_OK" &&
      ...
      smokePhase2093.parsed?.phase3249Marker === "PHASE3249_FORTY_FOUR_TOOL_TARGET_THREE_OK" &&
      ...
      smokePhase2096.parsed?.phase3250Marker === "PHASE3250_FORTY_FOUR_TOOL_TARGET_FOUR_OK" &&
      ...
      smokePhase2101.parsed?.phase3251Marker === "PHASE3251_FORTY_FOUR_TOOL_TARGET_FIVE_OK" &&
      smokePhase2111.parsed?.marker === "PHASE3252_FORTY_FOUR_TOOL_TARGET_SIX_OK" &&
      ...
      smokePhase2121.parsed?.marker === "PHASE3253_FORTY_FOUR_TOOL_TARGET_SEVEN_OK" &&
      ...
      smokePhase2132.parsed?.marker === "PHASE3254_FORTY_FOUR_TOOL_TARGET_EIGHT_OK" &&
      ...
      smokePhase2144.parsed?.marker === "PHASE3255_FORTY_FOUR_TOOL_TARGET_NINE_OK" &&
      ...
      smokePhase2157.parsed?.marker === "PHASE3256_FORTY_FOUR_TOOL_TARGET_TEN_OK" &&
      ...
      smokePhase2171.parsed?.marker === "PHASE3257_FORTY_FOUR_TOOL_TARGET_ELEVEN_OK" &&
      ...
      smokePhase2186.parsed?.marker === "PHASE3258_FORTY_FOUR_TOOL_TARGET_TWELVE_OK" &&
      ...
      smokePhase2202.parsed?.marker === "PHASE3259_FORTY_FOUR_TOOL_TARGET_THIRTEEN_OK" &&
      ...
      smokePhase2219.parsed?.marker === "PHASE3260_FORTY_FOUR_TOOL_TARGET_FOURTEEN_OK" &&
      ...
      smokePhase2237.parsed?.marker === "PHASE3261_FORTY_FOUR_TOOL_TARGET_FIFTEEN_OK" &&
      ...
      smokePhase2256.parsed?.marker === "PHASE3262_FORTY_FOUR_TOOL_TARGET_SIXTEEN_OK" &&
      ...
      smokePhase2276.parsed?.marker === "PHASE3263_FORTY_FOUR_TOOL_TARGET_SEVENTEEN_OK" &&
      ...
      smokePhase2297.parsed?.marker === "PHASE3264_FORTY_FOUR_TOOL_TARGET_EIGHTEEN_OK" &&
      ...
      smokePhase2319.parsed?.marker === "PHASE3265_FORTY_FOUR_TOOL_TARGET_NINETEEN_OK" &&
      ...
      smokePhase2342.parsed?.marker === "PHASE3266_FORTY_FOUR_TOOL_TARGET_TWENTY_OK" &&
      ...
      smokePhase2366.parsed?.marker === "PHASE3267_FORTY_FOUR_TOOL_TARGET_TWENTY_ONE_OK" &&
      ...
      smokePhase2391.parsed?.marker === "PHASE3268_FORTY_FOUR_TOOL_TARGET_TWENTY_TWO_OK" &&
      ...
      smokePhase2417.parsed?.marker === "PHASE3269_FORTY_FOUR_TOOL_TARGET_TWENTY_THREE_OK" &&
      ...
      smokePhase2444.parsed?.marker === "PHASE3270_FORTY_FOUR_TOOL_TARGET_TWENTY_FOUR_OK" &&
      ...
      smokePhase2472.parsed?.marker === "PHASE3271_FORTY_FOUR_TOOL_TARGET_TWENTY_FIVE_OK" &&
      ...
      smokePhase2501.parsed?.marker === "PHASE3272_FORTY_FOUR_TOOL_TARGET_TWENTY_SIX_OK" &&
      ...
      smokePhase2531.parsed?.marker === "PHASE3273_FORTY_FOUR_TOOL_TARGET_TWENTY_SEVEN_OK" &&
      ...
      smokePhase2562.parsed?.marker === "PHASE3274_FORTY_FOUR_TOOL_TARGET_TWENTY_EIGHT_OK" &&
      ...
      smokePhase2594.parsed?.marker === "PHASE3275_FORTY_FOUR_TOOL_TARGET_TWENTY_NINE_OK" &&
      ...
      smokePhase2627.parsed?.marker === "PHASE3276_FORTY_FOUR_TOOL_TARGET_THIRTY_OK" &&
      ...
      smokePhase2661.parsed?.marker === "PHASE3277_FORTY_FOUR_TOOL_TARGET_THIRTY_ONE_OK" &&
      ...
      smokePhase2696.parsed?.marker === "PHASE3278_FORTY_FOUR_TOOL_TARGET_THIRTY_TWO_OK" &&
      ...
      smokePhase2732.parsed?.marker === "PHASE3279_FORTY_FOUR_TOOL_TARGET_THIRTY_THREE_OK" &&
      ...
      smokePhase2769.parsed?.marker === "PHASE3280_FORTY_FOUR_TOOL_TARGET_THIRTY_FOUR_OK" &&
      ...
      smokePhase2807.parsed?.marker === "PHASE3281_FORTY_FOUR_TOOL_TARGET_THIRTY_FIVE_OK" &&
      ...
      smokePhase2846.parsed?.marker === "PHASE3282_FORTY_FOUR_TOOL_TARGET_THIRTY_SIX_OK" &&
      ...
      smokePhase2886.parsed?.marker === "PHASE3283_FORTY_FOUR_TOOL_TARGET_THIRTY_SEVEN_OK" &&
      ...
      smokePhase2927.parsed?.marker === "PHASE3284_FORTY_FOUR_TOOL_TARGET_THIRTY_EIGHT_OK" &&
      ...
      smokePhase2969.parsed?.marker === "PHASE3285_FORTY_FOUR_TOOL_TARGET_THIRTY_NINE_OK" &&
      ...
      smokePhase3012.parsed?.marker === "PHASE3286_FORTY_FOUR_TOOL_TARGET_FORTY_OK" &&
      ...
      smokePhase3056.parsed?.marker === "PHASE3287_FORTY_FOUR_TOOL_TARGET_FORTY_ONE_OK" &&
      ...
      smokePhase3101.parsed?.marker === "PHASE3288_FORTY_FOUR_TOOL_TARGET_FORTY_TWO_OK" &&
      ...
      smokePhase3147.parsed?.marker === "PHASE3289_FORTY_FOUR_TOOL_TARGET_FORTY_THREE_OK" &&
      ...
      smokePhase3194.parsed?.marker === "PHASE3290_FORTY_FOUR_TOOL_TARGET_FORTY_FOUR_OK" &&
      ...
      true
        ? "passed"
        : "failed",
    phase3247Marker: smokePhase2091.parsed?.phase3247?.marker || null,
    phase3248Marker: smokePhase2092.parsed?.phase3248Marker || null,
    phase3249Marker: smokePhase2093.parsed?.phase3249Marker || null,
    phase3250Marker: smokePhase2096.parsed?.phase3250Marker || null,
    phase3251Marker: smokePhase2101.parsed?.phase3251Marker || null,
    phase3252Marker: smokePhase2111.parsed?.phase3252Marker || null,
    phase3253Marker: smokePhase2121.parsed?.phase3253Marker || null,
    phase3254Marker: smokePhase2132.parsed?.phase3254Marker || null,
    phase3255Marker: smokePhase2144.parsed?.phase3255Marker || null,
    phase3256Marker: smokePhase2157.parsed?.phase3256Marker || null,
    phase3257Marker: smokePhase2171.parsed?.phase3257Marker || null,
    phase3258Marker: smokePhase2186.parsed?.phase3258Marker || null,
    phase3259Marker: smokePhase2202.parsed?.phase3259Marker || null,
    phase3260Marker: smokePhase2219.parsed?.phase3260Marker || null,
    phase3261Marker: smokePhase2237.parsed?.phase3261Marker || null,
    phase3262Marker: smokePhase2256.parsed?.phase3262Marker || null,
    phase3263Marker: smokePhase2276.parsed?.phase3263Marker || null,
    phase3264Marker: smokePhase2297.parsed?.phase3264Marker || null,
    phase3265Marker: smokePhase2319.parsed?.phase3265Marker || null,
    phase3266Marker: smokePhase2342.parsed?.phase3266Marker || null,
    phase3267Marker: smokePhase2366.parsed?.phase3267Marker || null,
    phase3268Marker: smokePhase2391.parsed?.phase3268Marker || null,
    phase3269Marker: smokePhase2417.parsed?.phase3269Marker || null,
    phase3270Marker: smokePhase2444.parsed?.phase3270Marker || null,
    phase3271Marker: smokePhase2472.parsed?.phase3271Marker || null,
    phase3272Marker: smokePhase2501.parsed?.phase3272Marker || null,
    phase3273Marker: smokePhase2531.parsed?.phase3273Marker || null,
    phase3274Marker: smokePhase2562.parsed?.phase3274Marker || null,
    phase3275Marker: smokePhase2594.parsed?.phase3275Marker || null,
    phase3276Marker: smokePhase2627.parsed?.phase3276Marker || null,
    phase3277Marker: smokePhase2661.parsed?.phase3277Marker || null,
    phase3278Marker: smokePhase2696.parsed?.phase3278Marker || null,
    phase3279Marker: smokePhase2732.parsed?.phase3279Marker || null,
    phase3280Marker: smokePhase2769.parsed?.phase3280Marker || null,
    phase3281Marker: smokePhase2807.parsed?.phase3281Marker || null,
    phase3282Marker: smokePhase2846.parsed?.phase3282Marker || null,
    phase3283Marker: smokePhase2886.parsed?.phase3283Marker || null,
    phase3284Marker: smokePhase2927.parsed?.phase3284Marker || null,
    phase3285Marker: smokePhase2969.parsed?.phase3285Marker || null,
    phase3286Marker: smokePhase3012.parsed?.phase3286Marker || null,
    phase3287Marker: smokePhase3056.parsed?.phase3287Marker || null,
    phase3288Marker: smokePhase3101.parsed?.phase3288Marker || null,
    phase3289Marker: smokePhase3147.parsed?.phase3289Marker || null,
    phase3290Marker: smokePhase3194.parsed?.phase3290Marker || null,
    providerCallsMade: false,
  ...
  const result = {
    ...
    localFortyFourSmokePassed: smokeResult.status === "passed",
    smokePath,
...
function validatePlan(plan) {
  return validateControlledMutationPlan({
    ...
    expectedPermissionMode: "controlled-forty-four-tool-source-mutation",
    expectedOperationCount: 44,
    expectedMaxChangedFiles: 44,
    requiredAllowedFiles: [
    "apps/ai-gateway-service/evidence/phase3242-3290-controlled-forty-four-tool-mutation/result.json",
    "apps/ai-gateway-service/evidence/phase3242-3290-controlled-forty-four-tool-mutation/result.md",
    "apps/ai-gateway-service/evidence/phase3242-3290-controlled-forty-four-tool-mutation/rollback.json",
    "apps/ai-gateway-service/evidence/phase3242-3290-controlled-forty-four-tool-mutation/forty-four-smoke.json",
    "docs/phase3247-forty-four-tool-mutation-target-one.proposal.diff",
    "docs/phase3248-forty-four-tool-mutation-target-two.proposal.diff",
    "docs/phase3249-forty-four-tool-mutation-target-three.proposal.diff",
    "docs/phase3250-forty-four-tool-mutation-target-four.proposal.diff",
    "docs/phase3251-forty-four-tool-mutation-target-five.proposal.diff",
    "docs/phase3252-forty-four-tool-mutation-target-six.proposal.diff",
    "docs/phase3253-forty-four-tool-mutation-target-seven.proposal.diff",
    "docs/phase3254-forty-four-tool-mutation-target-eight.proposal.diff",
    "docs/phase3255-forty-four-tool-mutation-target-nine.proposal.diff",
    "docs/phase3256-forty-four-tool-mutation-target-ten.proposal.diff",
    "docs/phase3257-forty-four-tool-mutation-target-eleven.proposal.diff",
    "docs/phase3258-forty-four-tool-mutation-target-twelve.proposal.diff",
    "docs/phase3259-forty-four-tool-mutation-target-thirteen.proposal.diff",
    "docs/phase3260-forty-four-tool-mutation-target-fourteen.proposal.diff",
    "docs/phase3261-forty-four-tool-mutation-target-fifteen.proposal.diff",
    "docs/phase3262-forty-four-tool-mutation-target-sixteen.proposal.diff",
    "docs/phase3263-forty-four-tool-mutation-target-seventeen.proposal.diff",
    "docs/phase3264-forty-four-tool-mutation-target-eighteen.proposal.diff",
    "docs/phase3265-forty-four-tool-mutation-target-nineteen.proposal.diff",
    "docs/phase3266-forty-four-tool-mutation-target-twenty.proposal.diff",
    "docs/phase3267-forty-four-tool-mutation-target-twenty-one.proposal.diff",
    "docs/phase3268-forty-four-tool-mutation-target-twenty-two.proposal.diff",
    "docs/phase3269-forty-four-tool-mutation-target-twenty-three.proposal.diff",
    "docs/phase3270-forty-four-tool-mutation-target-twenty-four.proposal.diff",
    "docs/phase3271-forty-four-tool-mutation-target-twenty-five.proposal.diff",
    "docs/phase3272-forty-four-tool-mutation-target-twenty-six.proposal.diff",
    "docs/phase3273-forty-four-tool-mutation-target-twenty-seven.proposal.diff",
    "docs/phase3274-forty-four-tool-mutation-target-twenty-eight.proposal.diff",
    "docs/phase3275-forty-four-tool-mutation-target-twenty-nine.proposal.diff",
    "docs/phase3276-forty-four-tool-mutation-target-thirty.proposal.diff",
    "docs/phase3277-forty-four-tool-mutation-target-thirty-one.proposal.diff",
    "docs/phase3278-forty-four-tool-mutation-target-thirty-two.proposal.diff",
    "docs/phase3279-forty-four-tool-mutation-target-thirty-three.proposal.diff",
    "docs/phase3280-forty-four-tool-mutation-target-thirty-four.proposal.diff",
    "docs/phase3281-forty-four-tool-mutation-target-thirty-five.proposal.diff",
    "docs/phase3282-forty-four-tool-mutation-target-thirty-six.proposal.diff",
    "docs/phase3283-forty-four-tool-mutation-target-thirty-seven.proposal.diff",
    "docs/phase3284-forty-four-tool-mutation-target-thirty-eight.proposal.diff",
    "docs/phase3285-forty-four-tool-mutation-target-thirty-nine.proposal.diff",
    "docs/phase3286-forty-four-tool-mutation-target-forty.proposal.diff",
    "docs/phase3287-forty-four-tool-mutation-target-forty-one.proposal.diff",
    "docs/phase3288-forty-four-tool-mutation-target-forty-two.proposal.diff",
    "docs/phase3289-forty-four-tool-mutation-target-forty-three.proposal.diff",
    "docs/phase3290-forty-four-tool-mutation-target-forty-four.proposal.diff",
    "tools/phase2091/generated-source-patch-target.mjs",
    ...
    upstreamChecks: [
      ...
      {
        id: "phase3241_sealed",
        path: "apps/ai-gateway-service/evidence/phase3194-3241-controlled-forty-three-tool-mutation/result.json",
        predicate: (evidence) => evidence.recommendedSealed === true && evidence.fortyThreeMutationApplied === true,
        blocker: "phase3241_not_sealed",
      },
    ],
...
function buildBaseResult({ plan, validation, generatedAt, planPath }) {
  return {
    ...
    phase3241Sealed: validation.upstreamResults.some((entry) => entry.id === "phase3241_sealed" && entry.passed),
    codexExecExecuted: false,
    providerCallsMade: false,
    projectProviderCallsMade: false,
    secretRead: false,
