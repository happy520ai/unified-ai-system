import {
  ...
  writeJson,
  writeText
} from "../phase551-common.mjs";

const requiredFiles = [
  "docs/phase551a-yiyi-demo-buyer-followthrough-index.json",
  "docs/phase551a-yiyi-demo-buyer-followthrough-index.md",
  "apps/ai-gateway-service/evidence/phase551a/yiyi-demo-buyer-followthrough-index-result.json"
];
...
await writeText(
  "docs/phase551-yiyi-demo-buyer-followthrough-index-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase551/yiyi-demo-buyer-followthrough-index-closure-result.json", result);
