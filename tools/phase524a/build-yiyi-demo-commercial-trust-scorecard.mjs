import {
  ...
  writeJson,
  writeText
} from "../phase524-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase523/yiyi-demo-thirteenth-low-risk-auto-run-closure-closure-result.json");
...
await writeJson(`docs/phase524a-yiyi-demo-commercial-trust-scorecard.json`, packageJson);
await writeText(
  `docs/phase524a-yiyi-demo-commercial-trust-scorecard.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase524a/yiyi-demo-commercial-trust-scorecard-result.json`, result);
