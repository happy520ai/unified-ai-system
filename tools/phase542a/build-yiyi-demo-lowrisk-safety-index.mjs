import {
  ...
  writeJson,
  writeText
} from "../phase542-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase541/yiyi-demo-buyer-proof-addendum-closure-result.json");
...
await writeJson(`docs/phase542a-yiyi-demo-lowrisk-safety-index.json`, packageJson);
await writeText(
  `docs/phase542a-yiyi-demo-lowrisk-safety-index.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase542a/yiyi-demo-lowrisk-safety-index-result.json`, result);
