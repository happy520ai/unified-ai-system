import {
  ...
  writeJson,
  writeText
} from "../phase512-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase511/yiyi-demo-safe-buyer-followup-pack-closure-result.json");
...
await writeJson(`docs/phase512a-yiyi-demo-lowrisk-extension-index.json`, packageJson);
await writeText(
  `docs/phase512a-yiyi-demo-lowrisk-extension-index.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase512a/yiyi-demo-lowrisk-extension-index-result.json`, result);
