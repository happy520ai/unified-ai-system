...
export const phaseTitle = "Yiyi Demo Extended Low-risk Auto-run Closure";
export const phaseNumber = 413;
export const phaseName = "Phase413";
export const phaseSlug = "extended-low-risk-auto-run-closure";
export const phaseType = "commercial_demo_extended_low_risk_auto_run_closure";
export const phaseDeliverables = [
  "extendedLowRiskClosureCreated",
