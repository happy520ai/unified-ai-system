...
const requiredFiles = [
  "docs/phase545a-yiyi-demo-buyer-safety-ledger.json",
  "docs/phase545a-yiyi-demo-buyer-safety-ledger.md",
  "apps/ai-gateway-service/evidence/phase545a/yiyi-demo-buyer-safety-ledger-result.json"
];
...
await writeText(
  "docs/phase545-yiyi-demo-buyer-safety-ledger-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase545/yiyi-demo-buyer-safety-ledger-closure-result.json", result);
