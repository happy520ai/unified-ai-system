...
export const phaseTitle = "Yiyi Demo Commercial Safety Digest";
export const phaseNumber = 534;
export const phaseName = "Phase534";
export const phaseSlug = "commercial-safety-digest";
export const phaseType = "commercial_demo_commercial_safety_digest";
export const phaseDeliverables = [
  "commercialSafetyDigestCreated",
  "safetyDigestChecklistCreated"
];
