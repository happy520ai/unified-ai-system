...
const requiredFiles = [
  "docs/phase546a-yiyi-demo-evidence-trust-cards.json",
  "docs/phase546a-yiyi-demo-evidence-trust-cards.md",
  "apps/ai-gateway-service/evidence/phase546a/yiyi-demo-evidence-trust-cards-result.json"
];
...
await writeText(
  "docs/phase546-yiyi-demo-evidence-trust-cards-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase546/yiyi-demo-evidence-trust-cards-closure-result.json", result);
