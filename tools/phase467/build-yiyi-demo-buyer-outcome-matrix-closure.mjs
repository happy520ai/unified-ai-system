...
const requiredFiles = [
  "docs/phase467a-yiyi-demo-buyer-outcome-matrix.json",
  "docs/phase467a-yiyi-demo-buyer-outcome-matrix.md",
  "apps/ai-gateway-service/evidence/phase467a/yiyi-demo-buyer-outcome-matrix-result.json"
];
...
await writeText(
  "docs/phase467-yiyi-demo-buyer-outcome-matrix-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase467/yiyi-demo-buyer-outcome-matrix-closure-result.json", result);
