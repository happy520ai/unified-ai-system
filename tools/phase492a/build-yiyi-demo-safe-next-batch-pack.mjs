import {
  ...
  writeJson,
  writeText
} from "../phase492-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase491/yiyi-demo-review-closure-notes-closure-result.json");
...
await writeJson(`docs/phase492a-yiyi-demo-safe-next-batch-pack.json`, packageJson);
await writeText(
  `docs/phase492a-yiyi-demo-safe-next-batch-pack.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase492a/yiyi-demo-safe-next-batch-pack-result.json`, result);
