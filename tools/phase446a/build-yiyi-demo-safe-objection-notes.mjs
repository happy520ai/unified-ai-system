import {
  ...
  writeJson,
  writeText
} from "../phase446-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase445/yiyi-demo-buyer-readiness-snapshot-closure-result.json");
...
await writeJson(`docs/phase446a-yiyi-demo-safe-objection-notes.json`, packageJson);
await writeText(
  `docs/phase446a-yiyi-demo-safe-objection-notes.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase446a/yiyi-demo-safe-objection-notes-result.json`, result);
