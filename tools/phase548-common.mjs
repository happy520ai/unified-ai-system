...
export const phaseTitle = "Yiyi Demo Operator Confidence Pack";
export const phaseNumber = 548;
export const phaseName = "Phase548";
export const phaseSlug = "operator-confidence-pack";
export const phaseType = "commercial_demo_operator_confidence_pack";
export const phaseDeliverables = [
  "operatorConfidencePackCreated",
  "operatorConfidenceChecklistCreated"
];
