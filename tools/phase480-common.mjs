...
export const phaseTitle = "Yiyi Demo Internal Demo Replay Notes";
export const phaseNumber = 480;
export const phaseName = "Phase480";
export const phaseSlug = "internal-demo-replay-notes";
export const phaseType = "commercial_demo_internal_replay_notes";
export const phaseDeliverables = [
  "internalDemoReplayNotesCreated",
  "replayNotesChecklistCreated"
];
