...
export const phaseTitle = "Yiyi Demo Evidence Reliability Ledger";
export const phaseNumber = 556;
export const phaseName = "Phase556";
export const phaseSlug = "evidence-reliability-ledger";
export const phaseType = "commercial_demo_evidence_reliability_ledger";
export const phaseDeliverables = [
  "evidenceReliabilityLedgerCreated",
  "evidenceReliabilityChecklistCreated"
];
