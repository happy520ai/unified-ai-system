...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase496/yiyi-demo-buyer-review-ledger-closure-result.json");
...
await writeJson(`docs/phase497a-yiyi-demo-pilot-boundary-cue-sheet.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase497a/yiyi-demo-pilot-boundary-cue-sheet-result.json`, result);
