import {
  ...
  writeJson,
  writeText
} from "../phase462-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase461/yiyi-demo-proof-point-cue-sheet-closure-result.json");
...
await writeJson(`docs/phase462a-yiyi-demo-lowrisk-wrapup-pack.json`, packageJson);
await writeText(
  `docs/phase462a-yiyi-demo-lowrisk-wrapup-pack.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase462a/yiyi-demo-lowrisk-wrapup-pack-result.json`, result);
