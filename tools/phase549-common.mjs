...
export const phaseTitle = "Yiyi Demo Commercial Proof Ledger";
export const phaseNumber = 549;
export const phaseName = "Phase549";
export const phaseSlug = "commercial-proof-ledger";
export const phaseType = "commercial_demo_commercial_proof_ledger";
export const phaseDeliverables = [
  "commercialProofLedgerCreated",
  "commercialProofChecklistCreated"
];
