...
const requiredFiles = [
  "docs/phase439a-yiyi-demo-handoff-meeting-kit.json",
  "docs/phase439a-yiyi-demo-handoff-meeting-kit.md",
  "apps/ai-gateway-service/evidence/phase439a/yiyi-demo-handoff-meeting-kit-result.json"
];
...
await writeText(
  "docs/phase439-yiyi-demo-handoff-meeting-kit-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase439/yiyi-demo-handoff-meeting-kit-closure-result.json", result);
