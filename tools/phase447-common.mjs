...
export const phaseTitle = "Yiyi Demo Handoff Readiness Matrix";
export const phaseNumber = 447;
export const phaseName = "Phase447";
export const phaseSlug = "handoff-readiness-matrix";
export const phaseType = "commercial_demo_handoff_readiness_matrix";
export const phaseDeliverables = [
  "handoffReadinessMatrixCreated",
  "handoffMatrixChecklistCreated"
];
