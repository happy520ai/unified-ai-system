...
export const phaseTitle = "Yiyi Demo Safe Objection Notes";
export const phaseNumber = 446;
export const phaseName = "Phase446";
export const phaseSlug = "safe-objection-notes";
export const phaseType = "commercial_demo_safe_objection_notes";
export const phaseDeliverables = [
  "safeObjectionNotesCreated",
  "objectionNotesChecklistCreated"
];
