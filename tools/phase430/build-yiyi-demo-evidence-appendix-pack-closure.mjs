...
const requiredFiles = [
  "docs/phase430a-yiyi-demo-evidence-appendix-pack.json",
  "docs/phase430a-yiyi-demo-evidence-appendix-pack.md",
  "apps/ai-gateway-service/evidence/phase430a/yiyi-demo-evidence-appendix-pack-result.json"
];
...
await writeText(
  "docs/phase430-yiyi-demo-evidence-appendix-pack-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase430/yiyi-demo-evidence-appendix-pack-closure-result.json", result);
