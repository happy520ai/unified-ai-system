import {
  ...
  writeJson,
  writeText
} from "../phase558-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase557/yiyi-demo-controlled-safety-signals-closure-result.json");
...
await writeJson(`docs/phase558a-yiyi-demo-operator-assurance-notes.json`, packageJson);
await writeText(
  `docs/phase558a-yiyi-demo-operator-assurance-notes.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase558a/yiyi-demo-operator-assurance-notes-result.json`, result);
