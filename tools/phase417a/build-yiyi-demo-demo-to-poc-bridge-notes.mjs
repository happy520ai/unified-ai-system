...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase416/yiyi-demo-discovery-question-bank-closure-result.json");
...
await writeJson(`docs/phase417a-yiyi-demo-demo-to-poc-bridge-notes.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase417a/yiyi-demo-demo-to-poc-bridge-notes-result.json`, result);
