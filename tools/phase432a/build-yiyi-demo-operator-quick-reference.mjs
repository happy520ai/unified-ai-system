...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase431/yiyi-demo-manual-acceptance-notes-closure-result.json");
...
await writeJson(`docs/phase432a-yiyi-demo-operator-quick-reference.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase432a/yiyi-demo-operator-quick-reference-result.json`, result);
