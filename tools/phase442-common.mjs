...
export const phaseTitle = "Yiyi Demo Review Board Packet";
export const phaseNumber = 442;
export const phaseName = "Phase442";
export const phaseSlug = "review-board-packet";
export const phaseType = "commercial_demo_review_board_packet";
export const phaseDeliverables = [
  "reviewBoardPacketCreated",
  "reviewBoardChecklistCreated"
];
