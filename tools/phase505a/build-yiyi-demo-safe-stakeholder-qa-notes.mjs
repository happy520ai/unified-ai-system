import {
  ...
  writeJson,
  writeText
} from "../phase505-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase504/yiyi-demo-commercial-readiness-scorecard-closure-result.json");
...
await writeJson(`docs/phase505a-yiyi-demo-safe-stakeholder-qa-notes.json`, packageJson);
await writeText(
  `docs/phase505a-yiyi-demo-safe-stakeholder-qa-notes.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase505a/yiyi-demo-safe-stakeholder-qa-notes-result.json`, result);
