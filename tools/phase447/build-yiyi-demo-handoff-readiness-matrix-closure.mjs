import {
  ...
  writeJson,
  writeText
} from "../phase447-common.mjs";

const requiredFiles = [
  "docs/phase447a-yiyi-demo-handoff-readiness-matrix.json",
  "docs/phase447a-yiyi-demo-handoff-readiness-matrix.md",
  "apps/ai-gateway-service/evidence/phase447a/yiyi-demo-handoff-readiness-matrix-result.json"
];
...
await writeText(
  "docs/phase447-yiyi-demo-handoff-readiness-matrix-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase447/yiyi-demo-handoff-readiness-matrix-closure-result.json", result);
