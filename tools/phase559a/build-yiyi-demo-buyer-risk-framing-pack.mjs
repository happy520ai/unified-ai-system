import {
  ...
  writeJson,
  writeText
} from "../phase559-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase558/yiyi-demo-operator-assurance-notes-closure-result.json");
...
await writeJson(`docs/phase559a-yiyi-demo-buyer-risk-framing-pack.json`, packageJson);
await writeText(
  `docs/phase559a-yiyi-demo-buyer-risk-framing-pack.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase559a/yiyi-demo-buyer-risk-framing-pack-result.json`, result);
