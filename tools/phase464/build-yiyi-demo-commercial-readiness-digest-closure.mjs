...
const requiredFiles = [
  "docs/phase464a-yiyi-demo-commercial-readiness-digest.json",
  "docs/phase464a-yiyi-demo-commercial-readiness-digest.md",
  "apps/ai-gateway-service/evidence/phase464a/yiyi-demo-commercial-readiness-digest-result.json"
];
...
await writeText(
  "docs/phase464-yiyi-demo-commercial-readiness-digest-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase464/yiyi-demo-commercial-readiness-digest-closure-result.json", result);
