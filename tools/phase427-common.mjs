...
export const phaseTitle = "Yiyi Demo Readiness Snapshot Pack";
export const phaseNumber = 427;
export const phaseName = "Phase427";
export const phaseSlug = "readiness-snapshot-pack";
export const phaseType = "commercial_demo_readiness_snapshot_pack";
export const phaseDeliverables = [
  "readinessSnapshotPackCreated",
  "snapshotChecklistCreated"
];
