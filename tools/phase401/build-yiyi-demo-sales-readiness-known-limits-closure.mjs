import {
  ...
  writeJson,
  writeText
} from "../phase401-common.mjs";

const requiredFiles = [
  "docs/phase401a-yiyi-demo-sales-readiness-known-limits.json",
  "docs/phase401a-yiyi-demo-sales-readiness-known-limits.md",
  "apps/ai-gateway-service/evidence/phase401a/yiyi-demo-sales-readiness-known-limits-result.json"
];
...
await writeText(
  "docs/phase401-yiyi-demo-sales-readiness-known-limits-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase401/yiyi-demo-sales-readiness-known-limits-closure-result.json", result);
