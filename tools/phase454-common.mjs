...
export const phaseTitle = "Yiyi Demo Readiness Briefing Notes";
export const phaseNumber = 454;
export const phaseName = "Phase454";
export const phaseSlug = "readiness-briefing-notes";
export const phaseType = "commercial_demo_readiness_briefing_notes";
export const phaseDeliverables = [
  "readinessBriefingNotesCreated",
  "briefingNotesChecklistCreated"
];
