...
export const phaseTitle = "Yiyi Demo Controlled Assurance Brief";
export const phaseNumber = 537;
export const phaseName = "Phase537";
export const phaseSlug = "controlled-assurance-brief";
export const phaseType = "commercial_demo_controlled_assurance_brief";
export const phaseDeliverables = [
  "controlledAssuranceBriefCreated",
  "assuranceBriefChecklistCreated"
];
