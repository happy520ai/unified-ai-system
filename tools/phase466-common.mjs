...
export const phaseTitle = "Yiyi Demo Pilot Intake Notes";
export const phaseNumber = 466;
export const phaseName = "Phase466";
export const phaseSlug = "pilot-intake-notes";
export const phaseType = "commercial_demo_pilot_intake_notes";
export const phaseDeliverables = [
  "pilotIntakeNotesCreated",
  "pilotIntakeChecklistCreated"
];
