import {
  ...
  writeJson,
  writeText
} from "../phase498-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase497/yiyi-demo-pilot-boundary-cue-sheet-closure-result.json");
...
await writeJson(`docs/phase498a-yiyi-demo-internal-confidence-recap.json`, packageJson);
await writeText(
  `docs/phase498a-yiyi-demo-internal-confidence-recap.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase498a/yiyi-demo-internal-confidence-recap-result.json`, result);
