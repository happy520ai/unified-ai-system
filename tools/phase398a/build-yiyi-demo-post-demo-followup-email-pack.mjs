...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase397/yiyi-demo-buyer-persona-talk-track-pack-closure-result.json");
...
await writeJson(`docs/phase398a-yiyi-demo-post-demo-followup-email-pack.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase398a/yiyi-demo-post-demo-followup-email-pack-result.json`, result);
