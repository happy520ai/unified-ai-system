...
const requiredFiles = [
  "docs/phase499a-yiyi-demo-governance-followup-pack.json",
  "docs/phase499a-yiyi-demo-governance-followup-pack.md",
  "apps/ai-gateway-service/evidence/phase499a/yiyi-demo-governance-followup-pack-result.json"
];
...
await writeText(
  "docs/phase499-yiyi-demo-governance-followup-pack-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase499/yiyi-demo-governance-followup-pack-closure-result.json", result);
