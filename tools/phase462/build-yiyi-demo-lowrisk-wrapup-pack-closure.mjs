...
const requiredFiles = [
  "docs/phase462a-yiyi-demo-lowrisk-wrapup-pack.json",
  "docs/phase462a-yiyi-demo-lowrisk-wrapup-pack.md",
  "apps/ai-gateway-service/evidence/phase462a/yiyi-demo-lowrisk-wrapup-pack-result.json"
];
...
await writeText(
  "docs/phase462-yiyi-demo-lowrisk-wrapup-pack-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase462/yiyi-demo-lowrisk-wrapup-pack-closure-result.json", result);
