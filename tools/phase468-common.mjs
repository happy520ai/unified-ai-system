...
export const phaseTitle = "Yiyi Demo Review Follow-through Notes";
export const phaseNumber = 468;
export const phaseName = "Phase468";
export const phaseSlug = "review-followthrough-notes";
export const phaseType = "commercial_demo_review_followthrough_notes";
export const phaseDeliverables = [
  "reviewFollowthroughNotesCreated",
  "followthroughChecklistCreated"
];
