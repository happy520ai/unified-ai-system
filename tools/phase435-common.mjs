...
export const phaseTitle = "Yiyi Demo Stakeholder Alignment Notes";
export const phaseNumber = 435;
export const phaseName = "Phase435";
export const phaseSlug = "stakeholder-alignment-notes";
export const phaseType = "commercial_demo_stakeholder_alignment_notes";
export const phaseDeliverables = [
  "stakeholderAlignmentNotesCreated",
  "alignmentChecklistCreated"
];
