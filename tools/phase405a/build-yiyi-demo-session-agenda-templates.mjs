import {
  ...
  writeJson,
  writeText
} from "../phase405-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase404/yiyi-demo-channel-briefing-pack-closure-result.json");
...
await writeJson(`docs/phase405a-yiyi-demo-session-agenda-templates.json`, packageJson);
await writeText(
  `docs/phase405a-yiyi-demo-session-agenda-templates.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase405a/yiyi-demo-session-agenda-templates-result.json`, result);
