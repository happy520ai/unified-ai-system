import {
  ...
  writeJson,
  writeText
} from "../phase539-common.mjs";

const requiredFiles = [
  "docs/phase539a-yiyi-demo-commercial-continuity-notes.json",
  "docs/phase539a-yiyi-demo-commercial-continuity-notes.md",
  "apps/ai-gateway-service/evidence/phase539a/yiyi-demo-commercial-continuity-notes-result.json"
];
...
await writeText(
  "docs/phase539-yiyi-demo-commercial-continuity-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase539/yiyi-demo-commercial-continuity-notes-closure-result.json", result);
