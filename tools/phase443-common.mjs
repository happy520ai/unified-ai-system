...
export const phaseTitle = "Yiyi Demo Fifth Low-risk Auto-run Closure";
export const phaseNumber = 443;
export const phaseName = "Phase443";
export const phaseSlug = "fifth-low-risk-auto-run-closure";
export const phaseType = "commercial_demo_fifth_low_risk_auto_run_closure";
export const phaseDeliverables = [
  "fifthLowRiskClosureCreated",
