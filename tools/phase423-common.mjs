...
export const phaseTitle = "Yiyi Demo Third Low-risk Auto-run Closure";
export const phaseNumber = 423;
export const phaseName = "Phase423";
export const phaseSlug = "third-low-risk-auto-run-closure";
export const phaseType = "commercial_demo_third_low_risk_auto_run_closure";
export const phaseDeliverables = [
  "thirdLowRiskClosureCreated",
