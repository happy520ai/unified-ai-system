...
export const phaseTitle = "Yiyi Demo Internal QA Scorecard";
export const phaseNumber = 399;
export const phaseName = "Phase399";
export const phaseSlug = "internal-qa-scorecard";
export const phaseType = "commercial_demo_internal_qa_scorecard";
export const phaseDeliverables = [
  "internalQaScorecardCreated",
  "reviewCriteriaCreated"
];
