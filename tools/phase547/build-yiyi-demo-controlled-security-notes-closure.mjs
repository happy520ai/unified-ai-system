import {
  ...
  writeJson,
  writeText
} from "../phase547-common.mjs";

const requiredFiles = [
  "docs/phase547a-yiyi-demo-controlled-security-notes.json",
  "docs/phase547a-yiyi-demo-controlled-security-notes.md",
  "apps/ai-gateway-service/evidence/phase547a/yiyi-demo-controlled-security-notes-result.json"
];
...
await writeText(
  "docs/phase547-yiyi-demo-controlled-security-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase547/yiyi-demo-controlled-security-notes-closure-result.json", result);
