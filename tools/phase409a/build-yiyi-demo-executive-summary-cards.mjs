import {
  ...
  writeJson,
  writeText
} from "../phase409-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase408/yiyi-demo-audience-question-routing-pack-closure-result.json");
...
await writeJson(`docs/phase409a-yiyi-demo-executive-summary-cards.json`, packageJson);
await writeText(
  `docs/phase409a-yiyi-demo-executive-summary-cards.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase409a/yiyi-demo-executive-summary-cards-result.json`, result);
