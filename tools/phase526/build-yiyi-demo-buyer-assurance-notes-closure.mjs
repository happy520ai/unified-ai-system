import {
  ...
  writeJson,
  writeText
} from "../phase526-common.mjs";

const requiredFiles = [
  "docs/phase526a-yiyi-demo-buyer-assurance-notes.json",
  "docs/phase526a-yiyi-demo-buyer-assurance-notes.md",
  "apps/ai-gateway-service/evidence/phase526a/yiyi-demo-buyer-assurance-notes-result.json"
];
...
await writeText(
  "docs/phase526-yiyi-demo-buyer-assurance-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase526/yiyi-demo-buyer-assurance-notes-closure-result.json", result);
