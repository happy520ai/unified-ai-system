...
export const phaseTitle = "Yiyi Demo Follow-up Sequencing Notes";
export const phaseNumber = 448;
export const phaseName = "Phase448";
export const phaseSlug = "followup-sequencing-notes";
export const phaseType = "commercial_demo_followup_sequencing_notes";
export const phaseDeliverables = [
  "followupSequencingNotesCreated",
  "followupSequenceChecklistCreated"
];
