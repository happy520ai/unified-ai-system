...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase430/yiyi-demo-evidence-appendix-pack-closure-result.json");
...
await writeJson(`docs/phase431a-yiyi-demo-manual-acceptance-notes.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase431a/yiyi-demo-manual-acceptance-notes-result.json`, result);
