import {
  ...
  writeJson,
  writeText
} from "../phase430-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase429/yiyi-demo-security-faq-addendum-closure-result.json");
...
await writeJson(`docs/phase430a-yiyi-demo-evidence-appendix-pack.json`, packageJson);
await writeText(
  `docs/phase430a-yiyi-demo-evidence-appendix-pack.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase430a/yiyi-demo-evidence-appendix-pack-result.json`, result);
