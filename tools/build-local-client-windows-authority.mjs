...
async function buildPackage(options) {
  ...
  try {
    ...
    const manifest = { version: options.nativeOnly ? 'local-client-windows-authority-native-build-v1' : 'local-client-windows-authority-package-v1', files, anchorIds: slots };
