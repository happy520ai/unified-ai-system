import {
  ...
  writeJson,
  writeText
} from "../phase556-common.mjs";

const requiredFiles = [
  "docs/phase556a-yiyi-demo-evidence-reliability-ledger.json",
  "docs/phase556a-yiyi-demo-evidence-reliability-ledger.md",
  "apps/ai-gateway-service/evidence/phase556a/yiyi-demo-evidence-reliability-ledger-result.json"
];
...
await writeText(
  "docs/phase556-yiyi-demo-evidence-reliability-ledger-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase556/yiyi-demo-evidence-reliability-ledger-closure-result.json", result);
