...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase559/yiyi-demo-buyer-risk-framing-pack-closure-result.json");
...
await writeJson(`docs/phase560a-yiyi-demo-review-continuation-ledger.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase560a/yiyi-demo-review-continuation-ledger-result.json`, result);
