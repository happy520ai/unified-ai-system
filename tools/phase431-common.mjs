...
export const phaseTitle = "Yiyi Demo Manual Acceptance Notes";
export const phaseNumber = 431;
export const phaseName = "Phase431";
export const phaseSlug = "manual-acceptance-notes";
export const phaseType = "commercial_demo_manual_acceptance_notes";
export const phaseDeliverables = [
  "manualAcceptanceNotesCreated",
  "acceptanceChecklistCreated"
];
