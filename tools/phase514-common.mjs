...
export const phaseTitle = "Yiyi Demo Commercial Operator Brief";
export const phaseNumber = 514;
export const phaseName = "Phase514";
export const phaseSlug = "commercial-operator-brief";
export const phaseType = "commercial_demo_commercial_operator_brief";
export const phaseDeliverables = [
  "commercialOperatorBriefCreated",
  "operatorBriefChecklistCreated"
];
