import {
  ...
  writeJson,
  writeText
} from "../phase424-common.mjs";

const requiredFiles = [
  "docs/phase424a-yiyi-demo-demo-asset-inventory-refresh.json",
  "docs/phase424a-yiyi-demo-demo-asset-inventory-refresh.md",
  "apps/ai-gateway-service/evidence/phase424a/yiyi-demo-demo-asset-inventory-refresh-result.json"
];
...
await writeText(
  "docs/phase424-yiyi-demo-demo-asset-inventory-refresh-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase424/yiyi-demo-demo-asset-inventory-refresh-closure-result.json", result);
