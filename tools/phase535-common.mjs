...
export const phaseTitle = "Yiyi Demo Buyer Trust Ledger";
export const phaseNumber = 535;
export const phaseName = "Phase535";
export const phaseSlug = "buyer-trust-ledger";
export const phaseType = "commercial_demo_buyer_trust_ledger";
export const phaseDeliverables = [
  "buyerTrustLedgerCreated",
  "buyerTrustChecklistCreated"
];
