import {
  ...
  writeJson,
  writeText
} from "../phase435-common.mjs";

const requiredFiles = [
  "docs/phase435a-yiyi-demo-stakeholder-alignment-notes.json",
  "docs/phase435a-yiyi-demo-stakeholder-alignment-notes.md",
  "apps/ai-gateway-service/evidence/phase435a/yiyi-demo-stakeholder-alignment-notes-result.json"
];
...
await writeText(
  "docs/phase435-yiyi-demo-stakeholder-alignment-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase435/yiyi-demo-stakeholder-alignment-notes-closure-result.json", result);
