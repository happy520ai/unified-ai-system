import {
  ...
  writeJson,
  writeText
} from "../phase536-common.mjs";

const requiredFiles = [
  "docs/phase536a-yiyi-demo-evidence-stewardship-notes.json",
  "docs/phase536a-yiyi-demo-evidence-stewardship-notes.md",
  "apps/ai-gateway-service/evidence/phase536a/yiyi-demo-evidence-stewardship-notes-result.json"
];
...
await writeText(
  "docs/phase536-yiyi-demo-evidence-stewardship-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase536/yiyi-demo-evidence-stewardship-notes-closure-result.json", result);
