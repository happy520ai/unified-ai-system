...
export const phaseTitle = "Yiyi Demo Internal Narrative Sync";
export const phaseNumber = 510;
export const phaseName = "Phase510";
export const phaseSlug = "internal-narrative-sync";
export const phaseType = "commercial_demo_internal_narrative_sync";
export const phaseDeliverables = [
  "internalNarrativeSyncCreated",
  "narrativeSyncChecklistCreated"
];
