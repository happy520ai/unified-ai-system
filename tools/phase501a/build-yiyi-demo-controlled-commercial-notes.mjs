...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase500/yiyi-demo-evidence-readiness-ledger-closure-result.json");
...
await writeJson(`docs/phase501a-yiyi-demo-controlled-commercial-notes.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase501a/yiyi-demo-controlled-commercial-notes-result.json`, result);
