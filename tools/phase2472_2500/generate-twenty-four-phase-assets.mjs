...
async function buildProposalDiff(target, beforeText, afterText) {
  ...
  const tempDir = resolve("tmp/phase2472-2500-proposals");
...
function buildDoc() {
  return `# Phase2472A-2500A Controlled Twenty-Four Tool Mutation
  ...
  return JSON.stringify(
    {
      ...
      planId: "phase2472-2500-controlled-twenty-four-tool-mutation",
      maxChangedFiles: 24,
      runNodeCheck: true,
      runLocalSmoke: true,
      approvalRecord: {
        ...
        approvedAtLeastOnceByOwner: [
          {
            ...
            scope: "phase2472-2500-controlled-twenty-four-tool-mutation",
          },
        ],
...
function buildBaseResult({ plan, validation, generatedAt, planPath }) {
  return {
    ...
    phase2471Sealed: validation.upstreamResults.some((entry) => entry.id === "${previousPhaseMeta.sealCheckId}" && entry.passed),
    codexExecExecuted: false,
    providerCallsMade: false,
    projectProviderCallsMade: false,
    secretRead: false,
