...
export const phaseTitle = "Yiyi Demo Operator Continuity Ledger";
export const phaseNumber = 490;
export const phaseName = "Phase490";
export const phaseSlug = "operator-continuity-ledger";
export const phaseType = "commercial_demo_operator_continuity_ledger";
export const phaseDeliverables = [
  "operatorContinuityLedgerCreated",
  "operatorContinuityChecklistCreated"
];
