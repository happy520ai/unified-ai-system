import {
  ...
  writeJson,
  writeText
} from "../phase529-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase528/yiyi-demo-security-response-cards-closure-result.json");
...
await writeJson(`docs/phase529a-yiyi-demo-controlled-readiness-notes.json`, packageJson);
await writeText(
  `docs/phase529a-yiyi-demo-controlled-readiness-notes.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase529a/yiyi-demo-controlled-readiness-notes-result.json`, result);
