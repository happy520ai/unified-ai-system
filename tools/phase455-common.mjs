...
export const phaseTitle = "Yiyi Demo Audience Fit Summary";
export const phaseNumber = 455;
export const phaseName = "Phase455";
export const phaseSlug = "audience-fit-summary";
export const phaseType = "commercial_demo_audience_fit_summary";
export const phaseDeliverables = [
  "audienceFitSummaryCreated",
  "audienceFitChecklistCreated"
];
