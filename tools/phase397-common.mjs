...
export const phaseTitle = "Yiyi Demo Buyer Persona Talk Track Pack";
export const phaseNumber = 397;
export const phaseName = "Phase397";
export const phaseSlug = "buyer-persona-talk-track-pack";
export const phaseType = "commercial_demo_buyer_persona_talk_track";
export const phaseDeliverables = [
  "buyerPersonaPackCreated",
  "talkTrackPackCreated"
];
