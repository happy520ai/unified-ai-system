...
export const phaseTitle = "Yiyi Demo Commercial Follow-up Ledger";
export const phaseNumber = 479;
export const phaseName = "Phase479";
export const phaseSlug = "commercial-followup-ledger";
export const phaseType = "commercial_demo_commercial_followup_ledger";
export const phaseDeliverables = [
  "commercialFollowupLedgerCreated",
  "followupLedgerChecklistCreated"
];
