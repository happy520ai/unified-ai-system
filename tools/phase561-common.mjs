...
export const phaseTitle = "Yiyi Demo Low-risk Buyer Path Index";
export const phaseNumber = 561;
export const phaseName = "Phase561";
export const phaseSlug = "lowrisk-buyer-path-index";
export const phaseType = "commercial_demo_lowrisk_buyer_path_index";
export const phaseDeliverables = [
  "lowriskBuyerPathIndexCreated",
  "buyerPathChecklistCreated"
];
