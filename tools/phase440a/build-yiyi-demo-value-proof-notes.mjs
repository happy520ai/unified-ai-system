import {
  ...
  writeJson,
  writeText
} from "../phase440-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase439/yiyi-demo-handoff-meeting-kit-closure-result.json");
...
await writeJson(`docs/phase440a-yiyi-demo-value-proof-notes.json`, packageJson);
await writeText(
  `docs/phase440a-yiyi-demo-value-proof-notes.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase440a/yiyi-demo-value-proof-notes-result.json`, result);
