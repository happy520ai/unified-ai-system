...
export const phaseTitle = "Yiyi Demo Executive Summary Cards";
export const phaseNumber = 409;
export const phaseName = "Phase409";
export const phaseSlug = "executive-summary-cards";
export const phaseType = "commercial_demo_executive_summary_cards";
export const phaseDeliverables = [
  "executiveSummaryCardsCreated",
  "summaryCueCardsCreated"
];
