...
const requiredFiles = [
  "docs/phase406a-yiyi-demo-moderator-notes-pack.json",
  "docs/phase406a-yiyi-demo-moderator-notes-pack.md",
  "apps/ai-gateway-service/evidence/phase406a/yiyi-demo-moderator-notes-pack-result.json"
];
...
await writeText(
  "docs/phase406-yiyi-demo-moderator-notes-pack-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase406/yiyi-demo-moderator-notes-pack-closure-result.json", result);
