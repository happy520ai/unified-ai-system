...
const requiredFiles = [
  "docs/phase541a-yiyi-demo-buyer-proof-addendum.json",
  "docs/phase541a-yiyi-demo-buyer-proof-addendum.md",
  "apps/ai-gateway-service/evidence/phase541a/yiyi-demo-buyer-proof-addendum-result.json"
];
...
await writeText(
  "docs/phase541-yiyi-demo-buyer-proof-addendum-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase541/yiyi-demo-buyer-proof-addendum-closure-result.json", result);
