import {
  ...
  writeJson,
  writeText
} from "../phase449-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase448/yiyi-demo-followup-sequencing-notes-closure-result.json");
...
await writeJson(`docs/phase449a-yiyi-demo-review-facilitation-pack.json`, packageJson);
await writeText(
  `docs/phase449a-yiyi-demo-review-facilitation-pack.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase449a/yiyi-demo-review-facilitation-pack-result.json`, result);
