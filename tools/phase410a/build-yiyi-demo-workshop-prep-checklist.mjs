import {
  ...
  writeJson,
  writeText
} from "../phase410-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase409/yiyi-demo-executive-summary-cards-closure-result.json");
...
await writeJson(`docs/phase410a-yiyi-demo-workshop-prep-checklist.json`, packageJson);
await writeText(
  `docs/phase410a-yiyi-demo-workshop-prep-checklist.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase410a/yiyi-demo-workshop-prep-checklist-result.json`, result);
