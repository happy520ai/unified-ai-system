import {
  ...
  writeJson,
  writeText
} from "../phase467-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase466/yiyi-demo-pilot-intake-notes-closure-result.json");
...
await writeJson(`docs/phase467a-yiyi-demo-buyer-outcome-matrix.json`, packageJson);
await writeText(
  `docs/phase467a-yiyi-demo-buyer-outcome-matrix.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase467a/yiyi-demo-buyer-outcome-matrix-result.json`, result);
