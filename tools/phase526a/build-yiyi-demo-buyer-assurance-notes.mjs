...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase525/yiyi-demo-safe-review-brief-closure-result.json");
...
await writeJson(`docs/phase526a-yiyi-demo-buyer-assurance-notes.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase526a/yiyi-demo-buyer-assurance-notes-result.json`, result);
