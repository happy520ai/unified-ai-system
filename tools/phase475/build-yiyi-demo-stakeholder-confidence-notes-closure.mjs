import {
  ...
  writeJson,
  writeText
} from "../phase475-common.mjs";

const requiredFiles = [
  "docs/phase475a-yiyi-demo-stakeholder-confidence-notes.json",
  "docs/phase475a-yiyi-demo-stakeholder-confidence-notes.md",
  "apps/ai-gateway-service/evidence/phase475a/yiyi-demo-stakeholder-confidence-notes-result.json"
];
...
await writeText(
  "docs/phase475-yiyi-demo-stakeholder-confidence-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase475/yiyi-demo-stakeholder-confidence-notes-closure-result.json", result);
