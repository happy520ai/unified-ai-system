...
export const phaseTitle = "Yiyi Demo Cross-functional Review Notes";
export const phaseNumber = 411;
export const phaseName = "Phase411";
export const phaseSlug = "cross-functional-review-notes";
export const phaseType = "commercial_demo_cross_functional_review_notes";
export const phaseDeliverables = [
  "crossFunctionalReviewNotesCreated",
  "reviewOutcomeTemplateCreated"
];
