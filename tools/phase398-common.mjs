...
export const phaseTitle = "Yiyi Demo Post-demo Follow-up Email Pack";
export const phaseNumber = 398;
export const phaseName = "Phase398";
export const phaseSlug = "post-demo-followup-email-pack";
export const phaseType = "commercial_demo_followup_email_pack";
export const phaseDeliverables = [
  "followupEmailPackCreated",
  "followupBoundaryNotesCreated"
];
