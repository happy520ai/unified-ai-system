...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase425/yiyi-demo-safe-claims-review-pack-closure-result.json");
...
await writeJson(`docs/phase426a-yiyi-demo-narrative-consistency-sweep.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase426a/yiyi-demo-narrative-consistency-sweep-result.json`, result);
