...
export const phaseTitle = "Yiyi Demo Review Continuation Ledger";
export const phaseNumber = 560;
export const phaseName = "Phase560";
export const phaseSlug = "review-continuation-ledger";
export const phaseType = "commercial_demo_review_continuation_ledger";
export const phaseDeliverables = [
  "reviewContinuationLedgerCreated",
  "reviewContinuationChecklistCreated"
];
