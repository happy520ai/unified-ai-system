...
export const phaseTitle = "Yiyi Demo Controlled Buyer Notes";
export const phaseNumber = 519;
export const phaseName = "Phase519";
export const phaseSlug = "controlled-buyer-notes";
export const phaseType = "commercial_demo_controlled_buyer_notes";
export const phaseDeliverables = [
  "controlledBuyerNotesCreated",
  "controlledBuyerChecklistCreated"
];
