...
const phaseMeta = {
  ...
  docPath: "docs/phase2969-3011-controlled-thirty-eight-tool-mutation.md",
  approvalPath: "docs/phase2969-3011-controlled-thirty-eight-tool-mutation-approval.example.json",
  runnerPath: "tools/phase2969_3011/apply-controlled-thirty-eight-tool-mutation.mjs",
  verifierPath: "tools/phase2969_3011/validate-controlled-thirty-eight-tool-mutation.mjs",
  resultDir: "apps/ai-gateway-service/evidence/phase2969-3011-controlled-thirty-eight-tool-mutation",
  resultPath: "apps/ai-gateway-service/evidence/phase2969-3011-controlled-thirty-eight-tool-mutation/result.json",
  resultMdPath: "apps/ai-gateway-service/evidence/phase2969-3011-controlled-thirty-eight-tool-mutation/result.md",
  rollbackPath: "apps/ai-gateway-service/evidence/phase2969-3011-controlled-thirty-eight-tool-mutation/rollback.json",
  smokePath: "apps/ai-gateway-service/evidence/phase2969-3011-controlled-thirty-eight-tool-mutation/thirty-eight-smoke.json",
  permissionMode: "controlled-thirty-eight-tool-source-mutation",
  label: "thirty-eight",
  runnerReadyField: "thirtyEightRunnerReady",
  ...
  verifyScript: "verify:phase2969-3011-controlled-thirty-eight-tool-mutation",
  applyScript: "apply:phase2969-3011-controlled-thirty-eight-tool-mutation",
  smokeScript: "smoke:phase2969-3011-controlled-thirty-eight-tool-mutation",
};

const previousPhaseMeta = {
  phaseId: "Phase2927A-2968A-Controlled-Thirty-Seven-Tool-Mutation",
  resultPath: "apps/ai-gateway-service/evidence/phase2927-2968-controlled-thirty-seven-tool-mutation/result.json",
  sealCheckId: "phase2968_sealed",
  sealCheckField: "thirtySevenMutationApplied",
  sealCheckBlocker: "phase2968_not_sealed",
};
...
async function buildProposalDiff(target, beforeText, afterText) {
  ...
  const tempDir = resolve("tmp/phase2969-3011-proposals");
...
function buildDoc() {
  return `# Phase2969A-3011A Controlled Thirty-Eight Tool Mutation
  ...
  return JSON.stringify(
    {
      ...
      planId: "phase2969-3011-controlled-thirty-eight-tool-mutation",
      maxChangedFiles: 38,
      runNodeCheck: true,
      runLocalSmoke: true,
      approvalRecord: {
        ...
        approvedAtLeastOnceByOwner: [
          {
            ...
            scope: "phase2969-3011-controlled-thirty-eight-tool-mutation",
          },
        ],
...
function buildBaseResult({ plan, validation, generatedAt, planPath }) {
  return {
    ...
    phase2968Sealed: validation.upstreamResults.some((entry) => entry.id === "${previousPhaseMeta.sealCheckId}" && entry.passed),
    codexExecExecuted: false,
    providerCallsMade: false,
    projectProviderCallsMade: false,
    secretRead: false,
...
const phase2968 = readJson("${previousPhaseMeta.resultPath}") || {};
...
check("${previousPhaseMeta.sealCheckId}", phase2968.recommendedSealed === true && phase2968.${previousPhaseMeta.sealCheckField} === true);
