...
export const phaseTitle = "Yiyi Demo Operator Assurance Pack";
export const phaseNumber = 530;
export const phaseName = "Phase530";
export const phaseSlug = "operator-assurance-pack";
export const phaseType = "commercial_demo_operator_assurance_pack";
export const phaseDeliverables = [
  "operatorAssurancePackCreated",
  "operatorAssuranceChecklistCreated"
];
