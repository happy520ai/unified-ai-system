...
const requiredFiles = [
  "docs/phase555a-yiyi-demo-buyer-confidence-notes.json",
  "docs/phase555a-yiyi-demo-buyer-confidence-notes.md",
  "apps/ai-gateway-service/evidence/phase555a/yiyi-demo-buyer-confidence-notes-result.json"
];
...
await writeText(
  "docs/phase555-yiyi-demo-buyer-confidence-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase555/yiyi-demo-buyer-confidence-notes-closure-result.json", result);
