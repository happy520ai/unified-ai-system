...
const phaseMeta = {
  ...
  docPath: "docs/phase2886-2926-controlled-thirty-six-tool-mutation.md",
  approvalPath: "docs/phase2886-2926-controlled-thirty-six-tool-mutation-approval.example.json",
  runnerPath: "tools/phase2886_2926/apply-controlled-thirty-six-tool-mutation.mjs",
  verifierPath: "tools/phase2886_2926/validate-controlled-thirty-six-tool-mutation.mjs",
  resultDir: "apps/ai-gateway-service/evidence/phase2886-2926-controlled-thirty-six-tool-mutation",
  resultPath: "apps/ai-gateway-service/evidence/phase2886-2926-controlled-thirty-six-tool-mutation/result.json",
  resultMdPath: "apps/ai-gateway-service/evidence/phase2886-2926-controlled-thirty-six-tool-mutation/result.md",
  rollbackPath: "apps/ai-gateway-service/evidence/phase2886-2926-controlled-thirty-six-tool-mutation/rollback.json",
  smokePath: "apps/ai-gateway-service/evidence/phase2886-2926-controlled-thirty-six-tool-mutation/thirty-six-smoke.json",
  permissionMode: "controlled-thirty-six-tool-source-mutation",
  label: "thirty-six",
  runnerReadyField: "thirtySixRunnerReady",
  ...
  verifyScript: "verify:phase2886-2926-controlled-thirty-six-tool-mutation",
  applyScript: "apply:phase2886-2926-controlled-thirty-six-tool-mutation",
  smokeScript: "smoke:phase2886-2926-controlled-thirty-six-tool-mutation",
};

const previousPhaseMeta = {
  phaseId: "Phase2846A-2885A-Controlled-Thirty-Five-Tool-Mutation",
  resultPath: "apps/ai-gateway-service/evidence/phase2846-2885-controlled-thirty-five-tool-mutation/result.json",
  sealCheckId: "phase2885_sealed",
  sealCheckField: "thirtyFiveMutationApplied",
  sealCheckBlocker: "phase2885_not_sealed",
};
...
async function buildProposalDiff(target, beforeText, afterText) {
  ...
  const tempDir = resolve("tmp/phase2886-2926-proposals");
...
function buildDoc() {
  return `# Phase2886A-2926A Controlled Thirty-Six Tool Mutation
  ...
  return JSON.stringify(
    {
      ...
      planId: "phase2886-2926-controlled-thirty-six-tool-mutation",
      maxChangedFiles: 36,
      runNodeCheck: true,
      runLocalSmoke: true,
      approvalRecord: {
        ...
        approvedAtLeastOnceByOwner: [
          {
            ...
            scope: "phase2886-2926-controlled-thirty-six-tool-mutation",
          },
        ],
...
${smokeMarkers}
  ...
  const result = {
    ...
    blocker: completed ? "none" : "thirty_six_mutation_node_check_or_smoke_failed",
...
function buildBaseResult({ plan, validation, generatedAt, planPath }) {
  return {
    ...
    phase2885Sealed: validation.upstreamResults.some((entry) => entry.id === "${previousPhaseMeta.sealCheckId}" && entry.passed),
    codexExecExecuted: false,
    providerCallsMade: false,
    projectProviderCallsMade: false,
    secretRead: false,
...
function printSummary(result) {
  console.log(JSON.stringify({
    status: result.status,
    blocker: result.blocker,
    thirtySixMutationApplied: result.thirtySixMutationApplied,
    changedFileCount: result.changedFileCount,
    nodeCheckPassed: result.nodeCheckPassed,
    localThirtySixSmokePassed: result.localThirtySixSmokePassed,
...
const phase2885 = readJson("${previousPhaseMeta.resultPath}") || {};
...
check("${previousPhaseMeta.sealCheckId}", phase2885.recommendedSealed === true && phase2885.${previousPhaseMeta.sealCheckField} === true);
