...
const requiredFiles = [
  "docs/phase414a-yiyi-demo-demo-enablement-onepager.json",
  "docs/phase414a-yiyi-demo-demo-enablement-onepager.md",
  "apps/ai-gateway-service/evidence/phase414a/yiyi-demo-demo-enablement-onepager-result.json"
];
...
await writeText(
  "docs/phase414-yiyi-demo-demo-enablement-onepager-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase414/yiyi-demo-demo-enablement-onepager-closure-result.json", result);
