import {
  ...
  writeJson,
  writeText
} from "../phase445-common.mjs";

const requiredFiles = [
  "docs/phase445a-yiyi-demo-buyer-readiness-snapshot.json",
  "docs/phase445a-yiyi-demo-buyer-readiness-snapshot.md",
  "apps/ai-gateway-service/evidence/phase445a/yiyi-demo-buyer-readiness-snapshot-result.json"
];
...
await writeText(
  "docs/phase445-yiyi-demo-buyer-readiness-snapshot-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase445/yiyi-demo-buyer-readiness-snapshot-closure-result.json", result);
