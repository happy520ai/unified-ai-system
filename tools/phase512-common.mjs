...
export const phaseTitle = "Yiyi Demo Low-risk Extension Index";
export const phaseNumber = 512;
export const phaseName = "Phase512";
export const phaseSlug = "lowrisk-extension-index";
export const phaseType = "commercial_demo_lowrisk_extension_index";
export const phaseDeliverables = [
  "lowriskExtensionIndexCreated",
  "extensionIndexChecklistCreated"
];
