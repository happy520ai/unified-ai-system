...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase398/yiyi-demo-post-demo-followup-email-pack-closure-result.json");
...
await writeJson(`docs/phase399a-yiyi-demo-internal-qa-scorecard.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase399a/yiyi-demo-internal-qa-scorecard-result.json`, result);
