...
const phaseMeta = {
  ...
  docPath: "docs/phase3012-3055-controlled-thirty-nine-tool-mutation.md",
  approvalPath: "docs/phase3012-3055-controlled-thirty-nine-tool-mutation-approval.example.json",
  runnerPath: "tools/phase3012_3055/apply-controlled-thirty-nine-tool-mutation.mjs",
  verifierPath: "tools/phase3012_3055/validate-controlled-thirty-nine-tool-mutation.mjs",
  resultDir: "apps/ai-gateway-service/evidence/phase3012-3055-controlled-thirty-nine-tool-mutation",
  resultPath: "apps/ai-gateway-service/evidence/phase3012-3055-controlled-thirty-nine-tool-mutation/result.json",
  resultMdPath: "apps/ai-gateway-service/evidence/phase3012-3055-controlled-thirty-nine-tool-mutation/result.md",
  rollbackPath: "apps/ai-gateway-service/evidence/phase3012-3055-controlled-thirty-nine-tool-mutation/rollback.json",
  smokePath: "apps/ai-gateway-service/evidence/phase3012-3055-controlled-thirty-nine-tool-mutation/thirty-nine-smoke.json",
  permissionMode: "controlled-thirty-nine-tool-source-mutation",
  label: "thirty-nine",
  runnerReadyField: "thirtyNineRunnerReady",
  ...
  verifyScript: "verify:phase3012-3055-controlled-thirty-nine-tool-mutation",
  applyScript: "apply:phase3012-3055-controlled-thirty-nine-tool-mutation",
  smokeScript: "smoke:phase3012-3055-controlled-thirty-nine-tool-mutation",
};
...
const previousPhaseMeta = {
  ...
  sealCheckId: "phase3011_sealed",
  sealCheckField: "thirtyEightMutationApplied",
  sealCheckBlocker: "phase3011_not_sealed",
};
...
async function buildProposalDiff(target, beforeText, afterText) {
  ...
  const tempDir = resolve("tmp/phase3012-3055-proposals");
...
function buildDoc() {
  return `# Phase3012A-3055A Controlled Thirty-Nine Tool Mutation
  ...
  return JSON.stringify(
    {
      ...
      planId: "phase3012-3055-controlled-thirty-nine-tool-mutation",
      maxChangedFiles: 39,
      runNodeCheck: true,
      runLocalSmoke: true,
      approvalRecord: {
        ...
        approvedAtLeastOnceByOwner: [
          {
            ...
            scope: "phase3012-3055-controlled-thirty-nine-tool-mutation",
          },
        ],
...
${smokeMarkers}
  ...
  const result = {
    ...
    blocker: completed ? "none" : "thirty_nine_mutation_node_check_or_smoke_failed",
...
function validatePlan(plan) {
  return validateControlledMutationPlan({
    ...
    expectedOperationCount: 39,
    expectedMaxChangedFiles: 39,
...
function buildBaseResult({ plan, validation, generatedAt, planPath }) {
  return {
    ...
    phase3011Sealed: validation.upstreamResults.some((entry) => entry.id === "${previousPhaseMeta.sealCheckId}" && entry.passed),
    codexExecExecuted: false,
    providerCallsMade: false,
    projectProviderCallsMade: false,
    secretRead: false,
...
function printSummary(result) {
  console.log(JSON.stringify({
    status: result.status,
    blocker: result.blocker,
    thirtyNineMutationApplied: result.thirtyNineMutationApplied,
    changedFileCount: result.changedFileCount,
    nodeCheckPassed: result.nodeCheckPassed,
    localThirtyNineSmokePassed: result.localThirtyNineSmokePassed,
...
const phase3011 = readJson("${previousPhaseMeta.resultPath}") || {};
...
check("${previousPhaseMeta.sealCheckId}", phase3011.recommendedSealed === true && phase3011.${previousPhaseMeta.sealCheckField} === true);
