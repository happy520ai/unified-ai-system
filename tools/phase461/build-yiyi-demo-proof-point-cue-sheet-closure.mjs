...
const requiredFiles = [
  "docs/phase461a-yiyi-demo-proof-point-cue-sheet.json",
  "docs/phase461a-yiyi-demo-proof-point-cue-sheet.md",
  "apps/ai-gateway-service/evidence/phase461a/yiyi-demo-proof-point-cue-sheet-result.json"
];
...
await writeText(
  "docs/phase461-yiyi-demo-proof-point-cue-sheet-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase461/yiyi-demo-proof-point-cue-sheet-closure-result.json", result);
