import {
  ...
  writeJson,
  writeText
} from "../phase395-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase394/yiyi-demo-stakeholder-review-packet-closure-result.json");
...
await writeJson(`docs/phase395a-yiyi-demo-evidence-index-refresh-trace-map.json`, packageJson);
await writeText(
  `docs/phase395a-yiyi-demo-evidence-index-refresh-trace-map.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase395a/yiyi-demo-evidence-index-refresh-trace-map-result.json`, result);
