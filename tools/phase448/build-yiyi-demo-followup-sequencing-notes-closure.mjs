import {
  ...
  writeJson,
  writeText
} from "../phase448-common.mjs";

const requiredFiles = [
  "docs/phase448a-yiyi-demo-followup-sequencing-notes.json",
  "docs/phase448a-yiyi-demo-followup-sequencing-notes.md",
  "apps/ai-gateway-service/evidence/phase448a/yiyi-demo-followup-sequencing-notes-result.json"
];
...
await writeText(
  "docs/phase448-yiyi-demo-followup-sequencing-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase448/yiyi-demo-followup-sequencing-notes-closure-result.json", result);
