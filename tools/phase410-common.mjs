...
export const phaseTitle = "Yiyi Demo Workshop Prep Checklist";
export const phaseNumber = 410;
export const phaseName = "Phase410";
export const phaseSlug = "workshop-prep-checklist";
export const phaseType = "commercial_demo_workshop_prep_checklist";
export const phaseDeliverables = [
  "workshopPrepChecklistCreated",
  "prepBoundaryNotesCreated"
];
