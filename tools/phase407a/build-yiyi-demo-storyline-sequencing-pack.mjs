...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase406/yiyi-demo-moderator-notes-pack-closure-result.json");
...
await writeJson(`docs/phase407a-yiyi-demo-storyline-sequencing-pack.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase407a/yiyi-demo-storyline-sequencing-pack-result.json`, result);
