...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase547/yiyi-demo-controlled-security-notes-closure-result.json");
...
await writeJson(`docs/phase548a-yiyi-demo-operator-confidence-pack.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase548a/yiyi-demo-operator-confidence-pack-result.json`, result);
