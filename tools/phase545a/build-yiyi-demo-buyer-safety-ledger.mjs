import {
  ...
  writeJson,
  writeText
} from "../phase545-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase544/yiyi-demo-commercial-confidence-digest-closure-result.json");
...
await writeJson(`docs/phase545a-yiyi-demo-buyer-safety-ledger.json`, packageJson);
await writeText(
  `docs/phase545a-yiyi-demo-buyer-safety-ledger.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase545a/yiyi-demo-buyer-safety-ledger-result.json`, result);
