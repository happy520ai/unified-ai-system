import {
  ...
  writeJson,
  writeText
} from "../phase554-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase553/yiyi-demo-sixteenth-low-risk-auto-run-closure-closure-result.json");
...
await writeJson(`docs/phase554a-yiyi-demo-commercial-guardrail-brief.json`, packageJson);
await writeText(
  `docs/phase554a-yiyi-demo-commercial-guardrail-brief.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase554a/yiyi-demo-commercial-guardrail-brief-result.json`, result);
