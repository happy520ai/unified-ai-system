...
export const phaseTitle = "Yiyi Demo Internal Signoff Reminder Pack";
export const phaseNumber = 421;
export const phaseName = "Phase421";
export const phaseSlug = "internal-signoff-reminder-pack";
export const phaseType = "commercial_demo_internal_signoff_reminder_pack";
export const phaseDeliverables = [
  "internalSignoffReminderPackCreated",
  "reminderChecklistCreated"
];
