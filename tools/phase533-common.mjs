...
export const phaseTitle = "Yiyi Demo Fourteenth Low-risk Auto-run Closure";
export const phaseNumber = 533;
export const phaseName = "Phase533";
export const phaseSlug = "fourteenth-low-risk-auto-run-closure";
export const phaseType = "commercial_demo_fourteenth_low_risk_auto_run_closure";
export const phaseDeliverables = [
  "fourteenthLowRiskClosureCreated",
