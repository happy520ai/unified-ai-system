...
export const phaseTitle = "Yiyi Demo Operator Prep Ledger";
export const phaseNumber = 451;
export const phaseName = "Phase451";
export const phaseSlug = "operator-prep-ledger";
export const phaseType = "commercial_demo_operator_prep_ledger";
export const phaseDeliverables = [
  "operatorPrepLedgerCreated",
  "operatorPrepChecklistCreated"
];
