...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase478/yiyi-demo-security-review-cue-sheet-closure-result.json");
...
await writeJson(`docs/phase479a-yiyi-demo-commercial-followup-ledger.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase479a/yiyi-demo-commercial-followup-ledger-result.json`, result);
