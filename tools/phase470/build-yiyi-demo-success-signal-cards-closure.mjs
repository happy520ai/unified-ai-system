...
const requiredFiles = [
  "docs/phase470a-yiyi-demo-success-signal-cards.json",
  "docs/phase470a-yiyi-demo-success-signal-cards.md",
  "apps/ai-gateway-service/evidence/phase470a/yiyi-demo-success-signal-cards-result.json"
];
...
await writeText(
  "docs/phase470-yiyi-demo-success-signal-cards-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase470/yiyi-demo-success-signal-cards-closure-result.json", result);
