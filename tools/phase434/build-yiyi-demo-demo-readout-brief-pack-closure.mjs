...
const requiredFiles = [
  "docs/phase434a-yiyi-demo-demo-readout-brief-pack.json",
  "docs/phase434a-yiyi-demo-demo-readout-brief-pack.md",
  "apps/ai-gateway-service/evidence/phase434a/yiyi-demo-demo-readout-brief-pack-result.json"
];
...
await writeText(
  "docs/phase434-yiyi-demo-demo-readout-brief-pack-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase434/yiyi-demo-demo-readout-brief-pack-closure-result.json", result);
