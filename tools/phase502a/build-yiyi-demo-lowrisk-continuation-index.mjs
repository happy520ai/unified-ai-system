...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase501/yiyi-demo-controlled-commercial-notes-closure-result.json");
...
await writeJson(`docs/phase502a-yiyi-demo-lowrisk-continuation-index.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase502a/yiyi-demo-lowrisk-continuation-index-result.json`, result);
