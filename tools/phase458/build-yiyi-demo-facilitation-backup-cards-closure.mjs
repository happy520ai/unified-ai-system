import {
  ...
  writeJson,
  writeText
} from "../phase458-common.mjs";

const requiredFiles = [
  "docs/phase458a-yiyi-demo-facilitation-backup-cards.json",
  "docs/phase458a-yiyi-demo-facilitation-backup-cards.md",
  "apps/ai-gateway-service/evidence/phase458a/yiyi-demo-facilitation-backup-cards-result.json"
];
...
await writeText(
  "docs/phase458-yiyi-demo-facilitation-backup-cards-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase458/yiyi-demo-facilitation-backup-cards-closure-result.json", result);
