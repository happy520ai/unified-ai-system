...
const requiredFiles = [
  "docs/phase509a-yiyi-demo-controlled-trial-framing.json",
  "docs/phase509a-yiyi-demo-controlled-trial-framing.md",
  "apps/ai-gateway-service/evidence/phase509a/yiyi-demo-controlled-trial-framing-result.json"
];
...
await writeText(
  "docs/phase509-yiyi-demo-controlled-trial-framing-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase509/yiyi-demo-controlled-trial-framing-closure-result.json", result);
