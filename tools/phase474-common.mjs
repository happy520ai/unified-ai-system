...
export const phaseTitle = "Yiyi Demo Governance Brief";
export const phaseNumber = 474;
export const phaseName = "Phase474";
export const phaseSlug = "demo-governance-brief";
export const phaseType = "commercial_demo_governance_brief";
export const phaseDeliverables = [
  "demoGovernanceBriefCreated",
  "governanceBriefChecklistCreated"
];
