import {
  ...
  writeJson,
  writeText
} from "../phase541-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase540/yiyi-demo-operator-safety-ledger-closure-result.json");
...
await writeJson(`docs/phase541a-yiyi-demo-buyer-proof-addendum.json`, packageJson);
await writeText(
  `docs/phase541a-yiyi-demo-buyer-proof-addendum.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase541a/yiyi-demo-buyer-proof-addendum-result.json`, result);
