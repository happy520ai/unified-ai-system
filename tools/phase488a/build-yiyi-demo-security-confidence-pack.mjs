import {
  ...
  writeJson,
  writeText
} from "../phase488-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase487/yiyi-demo-buyer-journey-handoff-closure-result.json");
...
await writeJson(`docs/phase488a-yiyi-demo-security-confidence-pack.json`, packageJson);
await writeText(
  `docs/phase488a-yiyi-demo-security-confidence-pack.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase488a/yiyi-demo-security-confidence-pack-result.json`, result);
