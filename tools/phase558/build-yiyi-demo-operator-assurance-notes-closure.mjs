...
const requiredFiles = [
  "docs/phase558a-yiyi-demo-operator-assurance-notes.json",
  "docs/phase558a-yiyi-demo-operator-assurance-notes.md",
  "apps/ai-gateway-service/evidence/phase558a/yiyi-demo-operator-assurance-notes-result.json"
];
...
await writeText(
  "docs/phase558-yiyi-demo-operator-assurance-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase558/yiyi-demo-operator-assurance-notes-closure-result.json", result);
