...
export const phaseTitle = "Yiyi Demo Sales Readiness Known Limits Sheet";
export const phaseNumber = 401;
export const phaseName = "Phase401";
export const phaseSlug = "sales-readiness-known-limits";
export const phaseType = "commercial_demo_sales_readiness_known_limits";
export const phaseDeliverables = [
  "knownLimitsSheetCreated",
  "salesReadinessBoundaryCreated"
];
