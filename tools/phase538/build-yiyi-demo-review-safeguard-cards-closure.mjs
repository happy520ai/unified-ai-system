...
const requiredFiles = [
  "docs/phase538a-yiyi-demo-review-safeguard-cards.json",
  "docs/phase538a-yiyi-demo-review-safeguard-cards.md",
  "apps/ai-gateway-service/evidence/phase538a/yiyi-demo-review-safeguard-cards-result.json"
];
...
await writeText(
  "docs/phase538-yiyi-demo-review-safeguard-cards-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase538/yiyi-demo-review-safeguard-cards-closure-result.json", result);
