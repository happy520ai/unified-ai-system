...
export const phaseTitle = "Yiyi Demo Enablement One-pager";
export const phaseNumber = 414;
export const phaseName = "Phase414";
export const phaseSlug = "demo-enablement-onepager";
export const phaseType = "commercial_demo_enablement_onepager";
export const phaseDeliverables = [
  "enablementOnepagerCreated",
  "onepagerChecklistCreated"
];
