...
export const phaseTitle = "Yiyi Demo Final Operator Handoff Index";
export const phaseNumber = 402;
export const phaseName = "Phase402";
export const phaseSlug = "final-operator-handoff-index";
export const phaseType = "commercial_demo_final_operator_handoff_index";
export const phaseDeliverables = [
  "operatorHandoffIndexCreated",
  "handoffChecklistCreated"
];
