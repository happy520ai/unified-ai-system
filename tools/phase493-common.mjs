...
export const phaseTitle = "Yiyi Demo Tenth Low-risk Auto-run Closure";
export const phaseNumber = 493;
export const phaseName = "Phase493";
export const phaseSlug = "tenth-low-risk-auto-run-closure";
export const phaseType = "commercial_demo_tenth_low_risk_auto_run_closure";
export const phaseDeliverables = [
  "tenthLowRiskClosureCreated",
