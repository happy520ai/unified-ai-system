...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase538/yiyi-demo-review-safeguard-cards-closure-result.json");
...
await writeJson(`docs/phase539a-yiyi-demo-commercial-continuity-notes.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase539a/yiyi-demo-commercial-continuity-notes-result.json`, result);
