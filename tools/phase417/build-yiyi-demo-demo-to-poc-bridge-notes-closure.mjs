import {
  ...
  writeJson,
  writeText
} from "../phase417-common.mjs";

const requiredFiles = [
  "docs/phase417a-yiyi-demo-demo-to-poc-bridge-notes.json",
  "docs/phase417a-yiyi-demo-demo-to-poc-bridge-notes.md",
  "apps/ai-gateway-service/evidence/phase417a/yiyi-demo-demo-to-poc-bridge-notes-result.json"
];
...
await writeText(
  "docs/phase417-yiyi-demo-demo-to-poc-bridge-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase417/yiyi-demo-demo-to-poc-bridge-notes-closure-result.json", result);
