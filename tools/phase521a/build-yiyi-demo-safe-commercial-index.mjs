import {
  ...
  writeJson,
  writeText
} from "../phase521-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase520/yiyi-demo-internal-review-addendum-closure-result.json");
...
await writeJson(`docs/phase521a-yiyi-demo-safe-commercial-index.json`, packageJson);
await writeText(
  `docs/phase521a-yiyi-demo-safe-commercial-index.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase521a/yiyi-demo-safe-commercial-index-result.json`, result);
