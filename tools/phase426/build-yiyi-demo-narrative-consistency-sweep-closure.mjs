import {
  ...
  writeJson,
  writeText
} from "../phase426-common.mjs";

const requiredFiles = [
  "docs/phase426a-yiyi-demo-narrative-consistency-sweep.json",
  "docs/phase426a-yiyi-demo-narrative-consistency-sweep.md",
  "apps/ai-gateway-service/evidence/phase426a/yiyi-demo-narrative-consistency-sweep-result.json"
];
...
await writeText(
  "docs/phase426-yiyi-demo-narrative-consistency-sweep-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase426/yiyi-demo-narrative-consistency-sweep-closure-result.json", result);
