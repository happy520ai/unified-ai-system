...
export const phaseTitle = "Yiyi Demo Buyer Safety Ledger";
export const phaseNumber = 545;
export const phaseName = "Phase545";
export const phaseSlug = "buyer-safety-ledger";
export const phaseType = "commercial_demo_buyer_safety_ledger";
export const phaseDeliverables = [
  "buyerSafetyLedgerCreated",
  "buyerSafetyLedgerChecklistCreated"
];
