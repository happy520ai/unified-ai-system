...
const requiredFiles = [
  "docs/phase488a-yiyi-demo-security-confidence-pack.json",
  "docs/phase488a-yiyi-demo-security-confidence-pack.md",
  "apps/ai-gateway-service/evidence/phase488a/yiyi-demo-security-confidence-pack-result.json"
];
...
await writeText(
  "docs/phase488-yiyi-demo-security-confidence-pack-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase488/yiyi-demo-security-confidence-pack-closure-result.json", result);
