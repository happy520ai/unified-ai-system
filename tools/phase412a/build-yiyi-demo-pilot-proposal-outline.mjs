import {
  ...
  writeJson,
  writeText
} from "../phase412-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase411/yiyi-demo-cross-functional-review-notes-closure-result.json");
...
await writeJson(`docs/phase412a-yiyi-demo-pilot-proposal-outline.json`, packageJson);
await writeText(
  `docs/phase412a-yiyi-demo-pilot-proposal-outline.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase412a/yiyi-demo-pilot-proposal-outline-result.json`, result);
