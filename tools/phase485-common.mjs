...
export const phaseTitle = "Yiyi Demo Trust Boundary Notes";
export const phaseNumber = 485;
export const phaseName = "Phase485";
export const phaseSlug = "trust-boundary-notes";
export const phaseType = "commercial_demo_trust_boundary_notes";
export const phaseDeliverables = [
  "trustBoundaryNotesCreated",
  "trustBoundaryChecklistCreated"
];
