import {
  ...
  writeJson,
  writeText
} from "../phase444-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase443/yiyi-demo-fifth-low-risk-auto-run-closure-closure-result.json");
...
await writeJson(`docs/phase444a-yiyi-demo-field-enablement-brief.json`, packageJson);
await writeText(
  `docs/phase444a-yiyi-demo-field-enablement-brief.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase444a/yiyi-demo-field-enablement-brief-result.json`, result);
