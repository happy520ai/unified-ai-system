...
const requiredFiles = [
  "docs/phase540a-yiyi-demo-operator-safety-ledger.json",
  "docs/phase540a-yiyi-demo-operator-safety-ledger.md",
  "apps/ai-gateway-service/evidence/phase540a/yiyi-demo-operator-safety-ledger-result.json"
];
...
await writeText(
  "docs/phase540-yiyi-demo-operator-safety-ledger-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase540/yiyi-demo-operator-safety-ledger-closure-result.json", result);
