import {
  ...
  writeJson,
  writeText
} from "../phase546-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase545/yiyi-demo-buyer-safety-ledger-closure-result.json");
...
await writeJson(`docs/phase546a-yiyi-demo-evidence-trust-cards.json`, packageJson);
await writeText(
  `docs/phase546a-yiyi-demo-evidence-trust-cards.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase546a/yiyi-demo-evidence-trust-cards-result.json`, result);
