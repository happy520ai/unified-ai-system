...
export const phaseTitle = "Yiyi Demo Thirteenth Low-risk Auto-run Closure";
export const phaseNumber = 523;
export const phaseName = "Phase523";
export const phaseSlug = "thirteenth-low-risk-auto-run-closure";
export const phaseType = "commercial_demo_thirteenth_low_risk_auto_run_closure";
export const phaseDeliverables = [
  "thirteenthLowRiskClosureCreated",
