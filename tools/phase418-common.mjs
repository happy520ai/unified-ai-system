...
export const phaseTitle = "Yiyi Demo Objection Escalation Matrix";
export const phaseNumber = 418;
export const phaseName = "Phase418";
export const phaseSlug = "objection-escalation-matrix";
export const phaseType = "commercial_demo_objection_escalation_matrix";
export const phaseDeliverables = [
  "objectionEscalationMatrixCreated",
  "escalationDecisionGuideCreated"
];
