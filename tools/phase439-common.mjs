...
export const phaseTitle = "Yiyi Demo Handoff Meeting Kit";
export const phaseNumber = 439;
export const phaseName = "Phase439";
export const phaseSlug = "handoff-meeting-kit";
export const phaseType = "commercial_demo_handoff_meeting_kit";
export const phaseDeliverables = [
  "handoffMeetingKitCreated",
  "meetingChecklistCreated"
];
