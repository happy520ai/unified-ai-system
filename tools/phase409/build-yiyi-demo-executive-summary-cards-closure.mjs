...
const requiredFiles = [
  "docs/phase409a-yiyi-demo-executive-summary-cards.json",
  "docs/phase409a-yiyi-demo-executive-summary-cards.md",
  "apps/ai-gateway-service/evidence/phase409a/yiyi-demo-executive-summary-cards-result.json"
];
...
await writeText(
  "docs/phase409-yiyi-demo-executive-summary-cards-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase409/yiyi-demo-executive-summary-cards-closure-result.json", result);
