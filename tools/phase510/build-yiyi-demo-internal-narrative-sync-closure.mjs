...
const requiredFiles = [
  "docs/phase510a-yiyi-demo-internal-narrative-sync.json",
  "docs/phase510a-yiyi-demo-internal-narrative-sync.md",
  "apps/ai-gateway-service/evidence/phase510a/yiyi-demo-internal-narrative-sync-result.json"
];
...
await writeText(
  "docs/phase510-yiyi-demo-internal-narrative-sync-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase510/yiyi-demo-internal-narrative-sync-closure-result.json", result);
