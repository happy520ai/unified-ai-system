...
export const phaseTitle = "Yiyi Demo Stakeholder Confidence Notes";
export const phaseNumber = 475;
export const phaseName = "Phase475";
export const phaseSlug = "stakeholder-confidence-notes";
export const phaseType = "commercial_demo_stakeholder_confidence_notes";
export const phaseDeliverables = [
  "stakeholderConfidenceNotesCreated",
  "confidenceChecklistCreated"
];
