import {
  ...
  writeJson,
  writeText
} from "../phase474-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase473/yiyi-demo-eighth-low-risk-auto-run-closure-closure-result.json");
...
await writeJson(`docs/phase474a-yiyi-demo-demo-governance-brief.json`, packageJson);
await writeText(
  `docs/phase474a-yiyi-demo-demo-governance-brief.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase474a/yiyi-demo-demo-governance-brief-result.json`, result);
