import {
  ...
  writeJson,
  writeText
} from "../phase431-common.mjs";

const requiredFiles = [
  "docs/phase431a-yiyi-demo-manual-acceptance-notes.json",
  "docs/phase431a-yiyi-demo-manual-acceptance-notes.md",
  "apps/ai-gateway-service/evidence/phase431a/yiyi-demo-manual-acceptance-notes-result.json"
];
...
await writeText(
  "docs/phase431-yiyi-demo-manual-acceptance-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase431/yiyi-demo-manual-acceptance-notes-closure-result.json", result);
