...
const requiredFiles = [
  "docs/phase535a-yiyi-demo-buyer-trust-ledger.json",
  "docs/phase535a-yiyi-demo-buyer-trust-ledger.md",
  "apps/ai-gateway-service/evidence/phase535a/yiyi-demo-buyer-trust-ledger-result.json"
];
...
await writeText(
  "docs/phase535-yiyi-demo-buyer-trust-ledger-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase535/yiyi-demo-buyer-trust-ledger-closure-result.json", result);
