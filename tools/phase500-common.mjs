...
export const phaseTitle = "Yiyi Demo Evidence Readiness Ledger";
export const phaseNumber = 500;
export const phaseName = "Phase500";
export const phaseSlug = "evidence-readiness-ledger";
export const phaseType = "commercial_demo_evidence_readiness_ledger";
export const phaseDeliverables = [
  "evidenceReadinessLedgerCreated",
  "evidenceReadinessChecklistCreated"
];
