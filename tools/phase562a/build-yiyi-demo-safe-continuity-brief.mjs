import {
  ...
  writeJson,
  writeText
} from "../phase562-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase561/yiyi-demo-lowrisk-buyer-path-index-closure-result.json");
...
await writeJson(`docs/phase562a-yiyi-demo-safe-continuity-brief.json`, packageJson);
await writeText(
  `docs/phase562a-yiyi-demo-safe-continuity-brief.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase562a/yiyi-demo-safe-continuity-brief-result.json`, result);
