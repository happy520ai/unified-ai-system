import {
  ...
  writeJson,
  writeText
} from "../phase425-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase424/yiyi-demo-demo-asset-inventory-refresh-closure-result.json");
...
await writeJson(`docs/phase425a-yiyi-demo-safe-claims-review-pack.json`, packageJson);
await writeText(
  `docs/phase425a-yiyi-demo-safe-claims-review-pack.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase425a/yiyi-demo-safe-claims-review-pack-result.json`, result);
