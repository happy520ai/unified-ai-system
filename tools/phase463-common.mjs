...
export const phaseTitle = "Yiyi Demo Seventh Low-risk Auto-run Closure";
export const phaseNumber = 463;
export const phaseName = "Phase463";
export const phaseSlug = "seventh-low-risk-auto-run-closure";
export const phaseType = "commercial_demo_seventh_low_risk_auto_run_closure";
export const phaseDeliverables = [
  "seventhLowRiskClosureCreated",
