import {
  ...
  writeJson,
  writeText
} from "../phase515-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase514/yiyi-demo-commercial-operator-brief-closure-result.json");
...
await writeJson(`docs/phase515a-yiyi-demo-safe-proof-notes.json`, packageJson);
await writeText(
  `docs/phase515a-yiyi-demo-safe-proof-notes.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase515a/yiyi-demo-safe-proof-notes-result.json`, result);
