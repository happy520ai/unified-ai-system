import {
  ...
  writeJson,
  writeText
} from "../phase471-common.mjs";

const requiredFiles = [
  "docs/phase471a-yiyi-demo-post-review-action-ledger.json",
  "docs/phase471a-yiyi-demo-post-review-action-ledger.md",
  "apps/ai-gateway-service/evidence/phase471a/yiyi-demo-post-review-action-ledger-result.json"
];
...
await writeText(
  "docs/phase471-yiyi-demo-post-review-action-ledger-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase471/yiyi-demo-post-review-action-ledger-closure-result.json", result);
