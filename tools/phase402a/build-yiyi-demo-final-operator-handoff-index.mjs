...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase401/yiyi-demo-sales-readiness-known-limits-closure-result.json");
...
await writeJson(`docs/phase402a-yiyi-demo-final-operator-handoff-index.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase402a/yiyi-demo-final-operator-handoff-index-result.json`, result);
