import {
  ...
  writeJson,
  writeText
} from "../phase537-common.mjs";

const requiredFiles = [
  "docs/phase537a-yiyi-demo-controlled-assurance-brief.json",
  "docs/phase537a-yiyi-demo-controlled-assurance-brief.md",
  "apps/ai-gateway-service/evidence/phase537a/yiyi-demo-controlled-assurance-brief-result.json"
];
...
await writeText(
  "docs/phase537-yiyi-demo-controlled-assurance-brief-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase537/yiyi-demo-controlled-assurance-brief-closure-result.json", result);
