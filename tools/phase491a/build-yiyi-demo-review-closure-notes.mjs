import {
  ...
  writeJson,
  writeText
} from "../phase491-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase490/yiyi-demo-operator-continuity-ledger-closure-result.json");
...
await writeJson(`docs/phase491a-yiyi-demo-review-closure-notes.json`, packageJson);
await writeText(
  `docs/phase491a-yiyi-demo-review-closure-notes.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase491a/yiyi-demo-review-closure-notes-result.json`, result);
