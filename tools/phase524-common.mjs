...
export const phaseTitle = "Yiyi Demo Commercial Trust Scorecard";
export const phaseNumber = 524;
export const phaseName = "Phase524";
export const phaseSlug = "commercial-trust-scorecard";
export const phaseType = "commercial_demo_commercial_trust_scorecard";
export const phaseDeliverables = [
  "commercialTrustScorecardCreated",
  "trustScorecardChecklistCreated"
];
