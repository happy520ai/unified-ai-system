...
const requiredFiles = [
  "docs/phase403a-yiyi-demo-low-risk-auto-run-closure.json",
  "docs/phase403a-yiyi-demo-low-risk-auto-run-closure.md",
  "apps/ai-gateway-service/evidence/phase403a/yiyi-demo-low-risk-auto-run-closure-result.json"
];
...
await writeText(
  "docs/phase403-yiyi-demo-low-risk-auto-run-closure-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase403/yiyi-demo-low-risk-auto-run-closure-closure-result.json", result);
