...
export const phaseTitle = "Yiyi Demo Post-review Action Ledger";
export const phaseNumber = 471;
export const phaseName = "Phase471";
export const phaseSlug = "post-review-action-ledger";
export const phaseType = "commercial_demo_post_review_action_ledger";
export const phaseDeliverables = [
  "postReviewActionLedgerCreated",
  "actionLedgerChecklistCreated"
];
