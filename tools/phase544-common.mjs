...
export const phaseTitle = "Yiyi Demo Commercial Confidence Digest";
export const phaseNumber = 544;
export const phaseName = "Phase544";
export const phaseSlug = "commercial-confidence-digest";
export const phaseType = "commercial_demo_commercial_confidence_digest";
export const phaseDeliverables = [
  "commercialConfidenceDigestCreated",
  "confidenceDigestChecklistCreated"
];
