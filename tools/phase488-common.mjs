...
export const phaseTitle = "Yiyi Demo Security Confidence Pack";
export const phaseNumber = 488;
export const phaseName = "Phase488";
export const phaseSlug = "security-confidence-pack";
export const phaseType = "commercial_demo_security_confidence_pack";
export const phaseDeliverables = [
  "securityConfidencePackCreated",
  "securityConfidenceChecklistCreated"
];
