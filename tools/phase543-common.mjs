...
export const phaseTitle = "Yiyi Demo Fifteenth Low-risk Auto-run Closure";
export const phaseNumber = 543;
export const phaseName = "Phase543";
export const phaseSlug = "fifteenth-low-risk-auto-run-closure";
export const phaseType = "commercial_demo_fifteenth_low_risk_auto_run_closure";
export const phaseDeliverables = [
  "fifteenthLowRiskClosureCreated",
