import {
  ...
  writeJson,
  writeText
} from "../phase477-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase476/yiyi-demo-controlled-rollout-questions-closure-result.json");
...
await writeJson(`docs/phase477a-yiyi-demo-evidence-tour-notes.json`, packageJson);
await writeText(
  `docs/phase477a-yiyi-demo-evidence-tour-notes.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase477a/yiyi-demo-evidence-tour-notes-result.json`, result);
