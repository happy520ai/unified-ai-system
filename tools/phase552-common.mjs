...
export const phaseTitle = "Yiyi Demo Low-risk Evidence Forward Pack";
export const phaseNumber = 552;
export const phaseName = "Phase552";
export const phaseSlug = "lowrisk-evidence-forward-pack";
export const phaseType = "commercial_demo_lowrisk_evidence_forward_pack";
export const phaseDeliverables = [
  "lowriskEvidenceForwardPackCreated",
  "evidenceForwardChecklistCreated"
];
