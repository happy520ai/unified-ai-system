import {
  ...
  writeJson,
  writeText
} from "../phase514-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase513/yiyi-demo-twelfth-low-risk-auto-run-closure-closure-result.json");
...
await writeJson(`docs/phase514a-yiyi-demo-commercial-operator-brief.json`, packageJson);
await writeText(
  `docs/phase514a-yiyi-demo-commercial-operator-brief.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase514a/yiyi-demo-commercial-operator-brief-result.json`, result);
