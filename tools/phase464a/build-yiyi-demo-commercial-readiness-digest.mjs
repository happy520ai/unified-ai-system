import {
  ...
  writeJson,
  writeText
} from "../phase464-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase463/yiyi-demo-seventh-low-risk-auto-run-closure-closure-result.json");
...
await writeJson(`docs/phase464a-yiyi-demo-commercial-readiness-digest.json`, packageJson);
await writeText(
  `docs/phase464a-yiyi-demo-commercial-readiness-digest.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase464a/yiyi-demo-commercial-readiness-digest-result.json`, result);
