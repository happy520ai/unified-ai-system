...
export const phaseTitle = "Yiyi Demo Review Confidence Ledger";
export const phaseNumber = 516;
export const phaseName = "Phase516";
export const phaseSlug = "review-confidence-ledger";
export const phaseType = "commercial_demo_review_confidence_ledger";
export const phaseDeliverables = [
  "reviewConfidenceLedgerCreated",
  "reviewConfidenceChecklistCreated"
];
