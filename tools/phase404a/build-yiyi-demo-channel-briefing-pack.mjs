import {
  ...
  writeJson,
  writeText
} from "../phase404-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase403/yiyi-demo-low-risk-auto-run-closure-closure-result.json");
...
await writeJson(`docs/phase404a-yiyi-demo-channel-briefing-pack.json`, packageJson);
await writeText(
  `docs/phase404a-yiyi-demo-channel-briefing-pack.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase404a/yiyi-demo-channel-briefing-pack-result.json`, result);
