...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase521/yiyi-demo-safe-commercial-index-closure-result.json");
...
await writeJson(`docs/phase522a-yiyi-demo-lowrisk-carryforward-pack.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase522a/yiyi-demo-lowrisk-carryforward-pack-result.json`, result);
