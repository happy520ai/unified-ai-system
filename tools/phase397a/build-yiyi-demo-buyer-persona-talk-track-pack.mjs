...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase396/yiyi-demo-risk-register-mitigation-notes-closure-result.json");
...
await writeJson(`docs/phase397a-yiyi-demo-buyer-persona-talk-track-pack.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase397a/yiyi-demo-buyer-persona-talk-track-pack-result.json`, result);
