import {
  ...
  writeJson,
  writeText
} from "../phase540-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase539/yiyi-demo-commercial-continuity-notes-closure-result.json");
...
await writeJson(`docs/phase540a-yiyi-demo-operator-safety-ledger.json`, packageJson);
await writeText(
  `docs/phase540a-yiyi-demo-operator-safety-ledger.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase540a/yiyi-demo-operator-safety-ledger-result.json`, result);
