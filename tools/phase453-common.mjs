...
export const phaseTitle = "Yiyi Demo Sixth Low-risk Auto-run Closure";
export const phaseNumber = 453;
export const phaseName = "Phase453";
export const phaseSlug = "sixth-low-risk-auto-run-closure";
export const phaseType = "commercial_demo_sixth_low_risk_auto_run_closure";
export const phaseDeliverables = [
  "sixthLowRiskClosureCreated",
