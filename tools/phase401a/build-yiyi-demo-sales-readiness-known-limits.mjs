...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase400/yiyi-demo-manual-trial-feedback-form-closure-result.json");
...
await writeJson(`docs/phase401a-yiyi-demo-sales-readiness-known-limits.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase401a/yiyi-demo-sales-readiness-known-limits-result.json`, result);
