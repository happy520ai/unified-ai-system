...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase451/yiyi-demo-operator-prep-ledger-closure-result.json");
...
await writeJson(`docs/phase452a-yiyi-demo-controlled-nextstep-pack.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase452a/yiyi-demo-controlled-nextstep-pack-result.json`, result);
