...
export const phaseTitle = "Yiyi Demo Evidence Assurance Pack";
export const phaseNumber = 518;
export const phaseName = "Phase518";
export const phaseSlug = "evidence-assurance-pack";
export const phaseType = "commercial_demo_evidence_assurance_pack";
export const phaseDeliverables = [
  "evidenceAssurancePackCreated",
  "evidenceAssuranceChecklistCreated"
];
