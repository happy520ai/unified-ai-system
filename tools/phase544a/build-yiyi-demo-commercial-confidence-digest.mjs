import {
  ...
  writeJson,
  writeText
} from "../phase544-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase543/yiyi-demo-fifteenth-low-risk-auto-run-closure-closure-result.json");
...
await writeJson(`docs/phase544a-yiyi-demo-commercial-confidence-digest.json`, packageJson);
await writeText(
  `docs/phase544a-yiyi-demo-commercial-confidence-digest.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase544a/yiyi-demo-commercial-confidence-digest-result.json`, result);
