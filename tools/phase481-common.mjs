...
export const phaseTitle = "Yiyi Demo Buyer Enablement Addendum";
export const phaseNumber = 481;
export const phaseName = "Phase481";
export const phaseSlug = "buyer-enablement-addendum";
export const phaseType = "commercial_demo_buyer_enablement_addendum";
export const phaseDeliverables = [
  "buyerEnablementAddendumCreated",
  "enablementAddendumChecklistCreated"
];
