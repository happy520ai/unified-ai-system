...
export const phaseTitle = "Yiyi Demo Security Response Cards";
export const phaseNumber = 528;
export const phaseName = "Phase528";
export const phaseSlug = "security-response-cards";
export const phaseType = "commercial_demo_security_response_cards";
export const phaseDeliverables = [
  "securityResponseCardsCreated",
  "securityResponseChecklistCreated"
];
