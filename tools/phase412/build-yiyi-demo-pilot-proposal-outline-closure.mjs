...
const requiredFiles = [
  "docs/phase412a-yiyi-demo-pilot-proposal-outline.json",
  "docs/phase412a-yiyi-demo-pilot-proposal-outline.md",
  "apps/ai-gateway-service/evidence/phase412a/yiyi-demo-pilot-proposal-outline-result.json"
];
...
await writeText(
  "docs/phase412-yiyi-demo-pilot-proposal-outline-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase412/yiyi-demo-pilot-proposal-outline-closure-result.json", result);
