...
export const phaseTitle = "Yiyi Demo Buyer Follow-through Index";
export const phaseNumber = 551;
export const phaseName = "Phase551";
export const phaseSlug = "buyer-followthrough-index";
export const phaseType = "commercial_demo_buyer_followthrough_index";
export const phaseDeliverables = [
  "buyerFollowthroughIndexCreated",
  "buyerFollowthroughChecklistCreated"
];
