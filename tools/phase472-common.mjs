...
export const phaseTitle = "Yiyi Demo Low-risk Continuity Pack";
export const phaseNumber = 472;
export const phaseName = "Phase472";
export const phaseSlug = "lowrisk-continuity-pack";
export const phaseType = "commercial_demo_lowrisk_continuity_pack";
export const phaseDeliverables = [
  "lowriskContinuityPackCreated",
  "continuityChecklistCreated"
];
