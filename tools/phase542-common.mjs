...
export const phaseTitle = "Yiyi Demo Low-risk Safety Index";
export const phaseNumber = 542;
export const phaseName = "Phase542";
export const phaseSlug = "lowrisk-safety-index";
export const phaseType = "commercial_demo_lowrisk_safety_index";
export const phaseDeliverables = [
  "lowriskSafetyIndexCreated",
  "safetyIndexChecklistCreated"
];
