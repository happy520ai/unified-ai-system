...
export const phaseTitle = "Yiyi Demo Safe Commercial Index";
export const phaseNumber = 521;
export const phaseName = "Phase521";
export const phaseSlug = "safe-commercial-index";
export const phaseType = "commercial_demo_safe_commercial_index";
export const phaseDeliverables = [
  "safeCommercialIndexCreated",
  "safeCommercialChecklistCreated"
];
