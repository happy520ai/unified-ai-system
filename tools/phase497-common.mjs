...
export const phaseTitle = "Yiyi Demo Pilot Boundary Cue Sheet";
export const phaseNumber = 497;
export const phaseName = "Phase497";
export const phaseSlug = "pilot-boundary-cue-sheet";
export const phaseType = "commercial_demo_pilot_boundary_cue_sheet";
export const phaseDeliverables = [
  "pilotBoundaryCueSheetCreated",
  "pilotBoundaryChecklistCreated"
];
