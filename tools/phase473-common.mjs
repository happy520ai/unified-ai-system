...
export const phaseTitle = "Yiyi Demo Eighth Low-risk Auto-run Closure";
export const phaseNumber = 473;
export const phaseName = "Phase473";
export const phaseSlug = "eighth-low-risk-auto-run-closure";
export const phaseType = "commercial_demo_eighth_low_risk_auto_run_closure";
export const phaseDeliverables = [
  "eighthLowRiskClosureCreated",
