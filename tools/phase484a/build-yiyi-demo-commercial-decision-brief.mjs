import {
  ...
  writeJson,
  writeText
} from "../phase484-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase483/yiyi-demo-ninth-low-risk-auto-run-closure-closure-result.json");
...
await writeJson(`docs/phase484a-yiyi-demo-commercial-decision-brief.json`, packageJson);
await writeText(
  `docs/phase484a-yiyi-demo-commercial-decision-brief.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase484a/yiyi-demo-commercial-decision-brief-result.json`, result);
