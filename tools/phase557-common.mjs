...
export const phaseTitle = "Yiyi Demo Controlled Safety Signals";
export const phaseNumber = 557;
export const phaseName = "Phase557";
export const phaseSlug = "controlled-safety-signals";
export const phaseType = "commercial_demo_controlled_safety_signals";
export const phaseDeliverables = [
  "controlledSafetySignalsCreated",
  "safetySignalsChecklistCreated"
];
