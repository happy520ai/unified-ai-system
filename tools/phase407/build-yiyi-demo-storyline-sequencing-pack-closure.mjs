import {
  ...
  writeJson,
  writeText
} from "../phase407-common.mjs";

const requiredFiles = [
  "docs/phase407a-yiyi-demo-storyline-sequencing-pack.json",
  "docs/phase407a-yiyi-demo-storyline-sequencing-pack.md",
  "apps/ai-gateway-service/evidence/phase407a/yiyi-demo-storyline-sequencing-pack-result.json"
];
...
await writeText(
  "docs/phase407-yiyi-demo-storyline-sequencing-pack-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase407/yiyi-demo-storyline-sequencing-pack-closure-result.json", result);
