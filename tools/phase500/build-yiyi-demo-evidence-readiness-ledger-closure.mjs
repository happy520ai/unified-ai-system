...
const requiredFiles = [
  "docs/phase500a-yiyi-demo-evidence-readiness-ledger.json",
  "docs/phase500a-yiyi-demo-evidence-readiness-ledger.md",
  "apps/ai-gateway-service/evidence/phase500a/yiyi-demo-evidence-readiness-ledger-result.json"
];
...
await writeText(
  "docs/phase500-yiyi-demo-evidence-readiness-ledger-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase500/yiyi-demo-evidence-readiness-ledger-closure-result.json", result);
