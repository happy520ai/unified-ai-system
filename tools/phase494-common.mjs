...
export const phaseTitle = "Yiyi Demo Commercial Proof Digest";
export const phaseNumber = 494;
export const phaseName = "Phase494";
export const phaseSlug = "commercial-proof-digest";
export const phaseType = "commercial_demo_commercial_proof_digest";
export const phaseDeliverables = [
  "commercialProofDigestCreated",
  "proofDigestChecklistCreated"
];
