...
export const phaseTitle = "Yiyi Demo Support Handoff Notes";
export const phaseNumber = 428;
export const phaseName = "Phase428";
export const phaseSlug = "support-handoff-notes";
export const phaseType = "commercial_demo_support_handoff_notes";
export const phaseDeliverables = [
  "supportHandoffNotesCreated",
  "supportBoundaryChecklistCreated"
];
