...
export const phaseTitle = "Yiyi Demo Field Enablement Brief";
export const phaseNumber = 444;
export const phaseName = "Phase444";
export const phaseSlug = "field-enablement-brief";
export const phaseType = "commercial_demo_field_enablement_brief";
export const phaseDeliverables = [
  "fieldEnablementBriefCreated",
  "enablementBriefChecklistCreated"
];
