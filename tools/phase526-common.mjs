...
export const phaseTitle = "Yiyi Demo Buyer Assurance Notes";
export const phaseNumber = 526;
export const phaseName = "Phase526";
export const phaseSlug = "buyer-assurance-notes";
export const phaseType = "commercial_demo_buyer_assurance_notes";
export const phaseDeliverables = [
  "buyerAssuranceNotesCreated",
  "buyerAssuranceChecklistCreated"
];
