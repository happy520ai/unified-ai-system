...
const requiredFiles = [
  "docs/phase506a-yiyi-demo-buyer-confidence-ledger.json",
  "docs/phase506a-yiyi-demo-buyer-confidence-ledger.md",
  "apps/ai-gateway-service/evidence/phase506a/yiyi-demo-buyer-confidence-ledger-result.json"
];
...
await writeText(
  "docs/phase506-yiyi-demo-buyer-confidence-ledger-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase506/yiyi-demo-buyer-confidence-ledger-closure-result.json", result);
