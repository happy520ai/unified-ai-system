import {
  ...
  writeJson,
  writeText
} from "../phase502-common.mjs";

const requiredFiles = [
  "docs/phase502a-yiyi-demo-lowrisk-continuation-index.json",
  "docs/phase502a-yiyi-demo-lowrisk-continuation-index.md",
  "apps/ai-gateway-service/evidence/phase502a/yiyi-demo-lowrisk-continuation-index-result.json"
];
...
await writeText(
  "docs/phase502-yiyi-demo-lowrisk-continuation-index-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase502/yiyi-demo-lowrisk-continuation-index-closure-result.json", result);
