...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase444/yiyi-demo-field-enablement-brief-closure-result.json");
...
await writeJson(`docs/phase445a-yiyi-demo-buyer-readiness-snapshot.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase445a/yiyi-demo-buyer-readiness-snapshot-result.json`, result);
