...
export const phaseTitle = "Yiyi Demo Buyer Continuation Index";
export const phaseNumber = 531;
export const phaseName = "Phase531";
export const phaseSlug = "buyer-continuation-index";
export const phaseType = "commercial_demo_buyer_continuation_index";
export const phaseDeliverables = [
  "buyerContinuationIndexCreated",
  "buyerContinuationChecklistCreated"
];
