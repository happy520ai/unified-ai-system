...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase546/yiyi-demo-evidence-trust-cards-closure-result.json");
...
await writeJson(`docs/phase547a-yiyi-demo-controlled-security-notes.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase547a/yiyi-demo-controlled-security-notes-result.json`, result);
