...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase454/yiyi-demo-readiness-briefing-notes-closure-result.json");
...
await writeJson(`docs/phase455a-yiyi-demo-audience-fit-summary.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase455a/yiyi-demo-audience-fit-summary-result.json`, result);
