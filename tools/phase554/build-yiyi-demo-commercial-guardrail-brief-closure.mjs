...
const requiredFiles = [
  "docs/phase554a-yiyi-demo-commercial-guardrail-brief.json",
  "docs/phase554a-yiyi-demo-commercial-guardrail-brief.md",
  "apps/ai-gateway-service/evidence/phase554a/yiyi-demo-commercial-guardrail-brief-result.json"
];
...
await writeText(
  "docs/phase554-yiyi-demo-commercial-guardrail-brief-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase554/yiyi-demo-commercial-guardrail-brief-closure-result.json", result);
