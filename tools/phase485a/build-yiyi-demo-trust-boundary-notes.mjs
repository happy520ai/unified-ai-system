import {
  ...
  writeJson,
  writeText
} from "../phase485-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase484/yiyi-demo-commercial-decision-brief-closure-result.json");
...
await writeJson(`docs/phase485a-yiyi-demo-trust-boundary-notes.json`, packageJson);
await writeText(
  `docs/phase485a-yiyi-demo-trust-boundary-notes.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase485a/yiyi-demo-trust-boundary-notes-result.json`, result);
