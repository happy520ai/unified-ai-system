...
const phaseMeta = {
  ...
  docPath: "docs/phase2927-2968-controlled-thirty-seven-tool-mutation.md",
  approvalPath: "docs/phase2927-2968-controlled-thirty-seven-tool-mutation-approval.example.json",
  runnerPath: "tools/phase2927_2968/apply-controlled-thirty-seven-tool-mutation.mjs",
  verifierPath: "tools/phase2927_2968/validate-controlled-thirty-seven-tool-mutation.mjs",
  resultDir: "apps/ai-gateway-service/evidence/phase2927-2968-controlled-thirty-seven-tool-mutation",
  resultPath: "apps/ai-gateway-service/evidence/phase2927-2968-controlled-thirty-seven-tool-mutation/result.json",
  resultMdPath: "apps/ai-gateway-service/evidence/phase2927-2968-controlled-thirty-seven-tool-mutation/result.md",
  rollbackPath: "apps/ai-gateway-service/evidence/phase2927-2968-controlled-thirty-seven-tool-mutation/rollback.json",
  smokePath: "apps/ai-gateway-service/evidence/phase2927-2968-controlled-thirty-seven-tool-mutation/thirty-seven-smoke.json",
  permissionMode: "controlled-thirty-seven-tool-source-mutation",
  label: "thirty-seven",
  runnerReadyField: "thirtySevenRunnerReady",
  ...
  verifyScript: "verify:phase2927-2968-controlled-thirty-seven-tool-mutation",
  applyScript: "apply:phase2927-2968-controlled-thirty-seven-tool-mutation",
  smokeScript: "smoke:phase2927-2968-controlled-thirty-seven-tool-mutation",
};

const previousPhaseMeta = {
  phaseId: "Phase2886A-2926A-Controlled-Thirty-Six-Tool-Mutation",
  resultPath: "apps/ai-gateway-service/evidence/phase2886-2926-controlled-thirty-six-tool-mutation/result.json",
  sealCheckId: "phase2926_sealed",
  sealCheckField: "thirtySixMutationApplied",
  sealCheckBlocker: "phase2926_not_sealed",
};
...
async function buildProposalDiff(target, beforeText, afterText) {
  ...
  const tempDir = resolve("tmp/phase2927-2968-proposals");
...
function buildDoc() {
  return `# Phase2927A-2968A Controlled Thirty-Seven Tool Mutation
  ...
  return JSON.stringify(
    {
      ...
      planId: "phase2927-2968-controlled-thirty-seven-tool-mutation",
      maxChangedFiles: 37,
      runNodeCheck: true,
      runLocalSmoke: true,
      approvalRecord: {
        ...
        approvedAtLeastOnceByOwner: [
          {
            ...
            scope: "phase2927-2968-controlled-thirty-seven-tool-mutation",
          },
        ],
...
${smokeMarkers}
  ...
  const result = {
    ...
    blocker: completed ? "none" : "thirty_seven_mutation_node_check_or_smoke_failed",
...
function validatePlan(plan) {
  return validateControlledMutationPlan({
    ...
    expectedOperationCount: 37,
    expectedMaxChangedFiles: 37,
...
function buildBaseResult({ plan, validation, generatedAt, planPath }) {
  return {
    ...
    phase2926Sealed: validation.upstreamResults.some((entry) => entry.id === "${previousPhaseMeta.sealCheckId}" && entry.passed),
    codexExecExecuted: false,
    providerCallsMade: false,
    projectProviderCallsMade: false,
    secretRead: false,
...
function printSummary(result) {
  console.log(JSON.stringify({
    status: result.status,
    blocker: result.blocker,
    thirtySevenMutationApplied: result.thirtySevenMutationApplied,
    changedFileCount: result.changedFileCount,
    nodeCheckPassed: result.nodeCheckPassed,
    localThirtySevenSmokePassed: result.localThirtySevenSmokePassed,
...
const phase2926 = readJson("${previousPhaseMeta.resultPath}") || {};
...
check("${previousPhaseMeta.sealCheckId}", phase2926.recommendedSealed === true && phase2926.${previousPhaseMeta.sealCheckField} === true);
