import {
  ...
  writeJson,
  writeText
} from "../phase476-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase475/yiyi-demo-stakeholder-confidence-notes-closure-result.json");
...
await writeJson(`docs/phase476a-yiyi-demo-controlled-rollout-questions.json`, packageJson);
await writeText(
  `docs/phase476a-yiyi-demo-controlled-rollout-questions.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase476a/yiyi-demo-controlled-rollout-questions-result.json`, result);
