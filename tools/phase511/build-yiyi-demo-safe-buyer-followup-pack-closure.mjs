import {
  ...
  writeJson,
  writeText
} from "../phase511-common.mjs";

const requiredFiles = [
  "docs/phase511a-yiyi-demo-safe-buyer-followup-pack.json",
  "docs/phase511a-yiyi-demo-safe-buyer-followup-pack.md",
  "apps/ai-gateway-service/evidence/phase511a/yiyi-demo-safe-buyer-followup-pack-result.json"
];
...
await writeText(
  "docs/phase511-yiyi-demo-safe-buyer-followup-pack-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase511/yiyi-demo-safe-buyer-followup-pack-closure-result.json", result);
