...
export const phaseTitle = "Yiyi Demo Low-risk Forward Notes";
export const phaseNumber = 532;
export const phaseName = "Phase532";
export const phaseSlug = "lowrisk-forward-notes";
export const phaseType = "commercial_demo_lowrisk_forward_notes";
export const phaseDeliverables = [
  "lowriskForwardNotesCreated",
  "forwardNotesChecklistCreated"
];
