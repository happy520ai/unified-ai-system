...
export const phaseTitle = "Yiyi Demo Security Review Cue Sheet";
export const phaseNumber = 478;
export const phaseName = "Phase478";
export const phaseSlug = "security-review-cue-sheet";
export const phaseType = "commercial_demo_security_review_cue_sheet";
export const phaseDeliverables = [
  "securityReviewCueSheetCreated",
  "securityReviewChecklistCreated"
];
