...
export const phaseTitle = "Yiyi Demo Safe Continuity Brief";
export const phaseNumber = 562;
export const phaseName = "Phase562";
export const phaseSlug = "safe-continuity-brief";
export const phaseType = "commercial_demo_safe_continuity_brief";
export const phaseDeliverables = [
  "safeContinuityBriefCreated",
  "continuityBriefChecklistCreated"
];
