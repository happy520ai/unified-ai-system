import {
  ...
  writeJson,
  writeText
} from "../phase452-common.mjs";

const requiredFiles = [
  "docs/phase452a-yiyi-demo-controlled-nextstep-pack.json",
  "docs/phase452a-yiyi-demo-controlled-nextstep-pack.md",
  "apps/ai-gateway-service/evidence/phase452a/yiyi-demo-controlled-nextstep-pack-result.json"
];
...
await writeText(
  "docs/phase452-yiyi-demo-controlled-nextstep-pack-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase452/yiyi-demo-controlled-nextstep-pack-closure-result.json", result);
