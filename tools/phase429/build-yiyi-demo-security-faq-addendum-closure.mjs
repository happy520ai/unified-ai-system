...
const requiredFiles = [
  "docs/phase429a-yiyi-demo-security-faq-addendum.json",
  "docs/phase429a-yiyi-demo-security-faq-addendum.md",
  "apps/ai-gateway-service/evidence/phase429a/yiyi-demo-security-faq-addendum-result.json"
];
...
await writeText(
  "docs/phase429-yiyi-demo-security-faq-addendum-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase429/yiyi-demo-security-faq-addendum-closure-result.json", result);
