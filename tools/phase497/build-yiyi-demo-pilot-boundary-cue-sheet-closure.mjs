import {
  ...
  writeJson,
  writeText
} from "../phase497-common.mjs";

const requiredFiles = [
  "docs/phase497a-yiyi-demo-pilot-boundary-cue-sheet.json",
  "docs/phase497a-yiyi-demo-pilot-boundary-cue-sheet.md",
  "apps/ai-gateway-service/evidence/phase497a/yiyi-demo-pilot-boundary-cue-sheet-result.json"
];
...
await writeText(
  "docs/phase497-yiyi-demo-pilot-boundary-cue-sheet-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase497/yiyi-demo-pilot-boundary-cue-sheet-closure-result.json", result);
