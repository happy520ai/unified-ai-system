import {
  ...
  writeJson,
  writeText
} from "../phase438-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase437/yiyi-demo-implementation-boundary-notes-closure-result.json");
...
await writeJson(`docs/phase438a-yiyi-demo-support-intake-template.json`, packageJson);
await writeText(
  `docs/phase438a-yiyi-demo-support-intake-template.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase438a/yiyi-demo-support-intake-template-result.json`, result);
