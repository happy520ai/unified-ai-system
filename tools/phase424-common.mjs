...
export const phaseTitle = "Yiyi Demo Asset Inventory Refresh";
export const phaseNumber = 424;
export const phaseName = "Phase424";
export const phaseSlug = "demo-asset-inventory-refresh";
export const phaseType = "commercial_demo_asset_inventory_refresh";
export const phaseDeliverables = [
  "assetInventoryRefreshed",
  "assetCoverageChecklistCreated"
];
