...
export const phaseTitle = "Yiyi Demo Ninth Low-risk Auto-run Closure";
export const phaseNumber = 483;
export const phaseName = "Phase483";
export const phaseSlug = "ninth-low-risk-auto-run-closure";
export const phaseType = "commercial_demo_ninth_low_risk_auto_run_closure";
export const phaseDeliverables = [
  "ninthLowRiskClosureCreated",
