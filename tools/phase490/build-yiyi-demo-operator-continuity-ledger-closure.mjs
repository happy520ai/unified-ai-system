import {
  ...
  writeJson,
  writeText
} from "../phase490-common.mjs";

const requiredFiles = [
  "docs/phase490a-yiyi-demo-operator-continuity-ledger.json",
  "docs/phase490a-yiyi-demo-operator-continuity-ledger.md",
  "apps/ai-gateway-service/evidence/phase490a/yiyi-demo-operator-continuity-ledger-result.json"
];
...
await writeText(
  "docs/phase490-yiyi-demo-operator-continuity-ledger-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase490/yiyi-demo-operator-continuity-ledger-closure-result.json", result);
