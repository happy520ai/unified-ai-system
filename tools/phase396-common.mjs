...
export const phaseTitle = "Yiyi Demo Risk Register + Mitigation Notes";
export const phaseNumber = 396;
export const phaseName = "Phase396";
export const phaseSlug = "risk-register-mitigation-notes";
export const phaseType = "commercial_demo_risk_register_mitigation_notes";
export const phaseDeliverables = [
  "riskRegisterCreated",
  "mitigationNotesCreated"
];
