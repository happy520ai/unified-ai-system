...
export const phaseTitle = "Yiyi Demo Success Signal Cards";
export const phaseNumber = 470;
export const phaseName = "Phase470";
export const phaseSlug = "success-signal-cards";
export const phaseType = "commercial_demo_success_signal_cards";
export const phaseDeliverables = [
  "successSignalCardsCreated",
  "successSignalChecklistCreated"
];
