import {
  ...
  writeJson,
  writeText
} from "../phase451-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase450/yiyi-demo-risk-acknowledgement-notes-closure-result.json");
...
await writeJson(`docs/phase451a-yiyi-demo-operator-prep-ledger.json`, packageJson);
await writeText(
  `docs/phase451a-yiyi-demo-operator-prep-ledger.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase451a/yiyi-demo-operator-prep-ledger-result.json`, result);
