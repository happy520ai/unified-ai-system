import {
  ...
  writeJson,
  writeText
} from "../phase516-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase515/yiyi-demo-safe-proof-notes-closure-result.json");
...
await writeJson(`docs/phase516a-yiyi-demo-review-confidence-ledger.json`, packageJson);
await writeText(
  `docs/phase516a-yiyi-demo-review-confidence-ledger.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase516a/yiyi-demo-review-confidence-ledger-result.json`, result);
