...
const requiredFiles = [
  "docs/phase415a-yiyi-demo-partner-intro-script-pack.json",
  "docs/phase415a-yiyi-demo-partner-intro-script-pack.md",
  "apps/ai-gateway-service/evidence/phase415a/yiyi-demo-partner-intro-script-pack-result.json"
];
...
await writeText(
  "docs/phase415-yiyi-demo-partner-intro-script-pack-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase415/yiyi-demo-partner-intro-script-pack-closure-result.json", result);
