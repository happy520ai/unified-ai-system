...
export const phaseTitle = "Yiyi Demo Internal Confidence Recap";
export const phaseNumber = 498;
export const phaseName = "Phase498";
export const phaseSlug = "internal-confidence-recap";
export const phaseType = "commercial_demo_internal_confidence_recap";
export const phaseDeliverables = [
  "internalConfidenceRecapCreated",
  "confidenceRecapChecklistCreated"
];
