import {
  ...
  writeJson,
  writeText
} from "../phase517-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase516/yiyi-demo-review-confidence-ledger-closure-result.json");
...
await writeJson(`docs/phase517a-yiyi-demo-buyer-safety-brief.json`, packageJson);
await writeText(
  `docs/phase517a-yiyi-demo-buyer-safety-brief.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase517a/yiyi-demo-buyer-safety-brief-result.json`, result);
