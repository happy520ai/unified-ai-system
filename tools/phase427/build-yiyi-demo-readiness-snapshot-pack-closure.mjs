...
const requiredFiles = [
  "docs/phase427a-yiyi-demo-readiness-snapshot-pack.json",
  "docs/phase427a-yiyi-demo-readiness-snapshot-pack.md",
  "apps/ai-gateway-service/evidence/phase427a/yiyi-demo-readiness-snapshot-pack-result.json"
];
...
await writeText(
  "docs/phase427-yiyi-demo-readiness-snapshot-pack-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase427/yiyi-demo-readiness-snapshot-pack-closure-result.json", result);
