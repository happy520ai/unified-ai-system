...
export const phaseTitle = "Yiyi Demo Multi-stakeholder Summary Pack";
export const phaseNumber = 420;
export const phaseName = "Phase420";
export const phaseSlug = "multi-stakeholder-summary-pack";
export const phaseType = "commercial_demo_multi_stakeholder_summary_pack";
export const phaseDeliverables = [
  "multiStakeholderSummaryPackCreated",
  "stakeholderSummaryNotesCreated"
];
