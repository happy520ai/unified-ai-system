import {
  ...
  writeJson,
  writeText
} from "../phase427-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase426/yiyi-demo-narrative-consistency-sweep-closure-result.json");
...
await writeJson(`docs/phase427a-yiyi-demo-readiness-snapshot-pack.json`, packageJson);
await writeText(
  `docs/phase427a-yiyi-demo-readiness-snapshot-pack.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase427a/yiyi-demo-readiness-snapshot-pack-result.json`, result);
