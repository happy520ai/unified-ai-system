...
export const phaseTitle = "Yiyi Demo Partner Intro Script Pack";
export const phaseNumber = 415;
export const phaseName = "Phase415";
export const phaseSlug = "partner-intro-script-pack";
export const phaseType = "commercial_demo_partner_intro_script_pack";
export const phaseDeliverables = [
  "partnerIntroScriptPackCreated",
  "partnerBriefChecklistCreated"
];
