...
export const phaseTitle = "Yiyi Demo Commercial Decision Brief";
export const phaseNumber = 484;
export const phaseName = "Phase484";
export const phaseSlug = "commercial-decision-brief";
export const phaseType = "commercial_demo_commercial_decision_brief";
export const phaseDeliverables = [
  "commercialDecisionBriefCreated",
  "decisionBriefChecklistCreated"
];
