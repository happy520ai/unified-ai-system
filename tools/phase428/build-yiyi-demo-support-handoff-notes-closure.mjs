...
const requiredFiles = [
  "docs/phase428a-yiyi-demo-support-handoff-notes.json",
  "docs/phase428a-yiyi-demo-support-handoff-notes.md",
  "apps/ai-gateway-service/evidence/phase428a/yiyi-demo-support-handoff-notes-result.json"
];
...
await writeText(
  "docs/phase428-yiyi-demo-support-handoff-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase428/yiyi-demo-support-handoff-notes-closure-result.json", result);
