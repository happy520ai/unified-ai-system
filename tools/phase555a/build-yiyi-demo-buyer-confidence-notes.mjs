import {
  ...
  writeJson,
  writeText
} from "../phase555-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase554/yiyi-demo-commercial-guardrail-brief-closure-result.json");
...
await writeJson(`docs/phase555a-yiyi-demo-buyer-confidence-notes.json`, packageJson);
await writeText(
  `docs/phase555a-yiyi-demo-buyer-confidence-notes.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase555a/yiyi-demo-buyer-confidence-notes-result.json`, result);
