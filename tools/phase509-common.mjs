...
export const phaseTitle = "Yiyi Demo Controlled Trial Framing";
export const phaseNumber = 509;
export const phaseName = "Phase509";
export const phaseSlug = "controlled-trial-framing";
export const phaseType = "commercial_demo_controlled_trial_framing";
export const phaseDeliverables = [
  "controlledTrialFramingCreated",
  "trialFramingChecklistCreated"
];
