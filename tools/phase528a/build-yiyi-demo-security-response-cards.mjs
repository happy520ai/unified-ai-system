import {
  ...
  writeJson,
  writeText
} from "../phase528-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase527/yiyi-demo-evidence-control-ledger-closure-result.json");
...
await writeJson(`docs/phase528a-yiyi-demo-security-response-cards.json`, packageJson);
await writeText(
  `docs/phase528a-yiyi-demo-security-response-cards.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase528a/yiyi-demo-security-response-cards-result.json`, result);
