...
export const phaseTitle = "Yiyi Demo Buyer Safety Brief";
export const phaseNumber = 517;
export const phaseName = "Phase517";
export const phaseSlug = "buyer-safety-brief";
export const phaseType = "commercial_demo_buyer_safety_brief";
export const phaseDeliverables = [
  "buyerSafetyBriefCreated",
  "buyerSafetyChecklistCreated"
];
