import {
  ...
  writeJson,
  writeText
} from "../phase534-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase533/yiyi-demo-fourteenth-low-risk-auto-run-closure-closure-result.json");
...
await writeJson(`docs/phase534a-yiyi-demo-commercial-safety-digest.json`, packageJson);
await writeText(
  `docs/phase534a-yiyi-demo-commercial-safety-digest.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase534a/yiyi-demo-commercial-safety-digest-result.json`, result);
