...
export const phaseTitle = "Yiyi Demo Security Positioning Notes";
export const phaseNumber = 507;
export const phaseName = "Phase507";
export const phaseSlug = "security-positioning-notes";
export const phaseType = "commercial_demo_security_positioning_notes";
export const phaseDeliverables = [
  "securityPositioningNotesCreated",
  "securityPositioningChecklistCreated"
];
