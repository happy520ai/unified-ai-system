...
const requiredFiles = [
  "docs/phase442a-yiyi-demo-review-board-packet.json",
  "docs/phase442a-yiyi-demo-review-board-packet.md",
  "apps/ai-gateway-service/evidence/phase442a/yiyi-demo-review-board-packet-result.json"
];
...
await writeText(
  "docs/phase442-yiyi-demo-review-board-packet-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase442/yiyi-demo-review-board-packet-closure-result.json", result);
