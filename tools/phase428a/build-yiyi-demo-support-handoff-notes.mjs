import {
  ...
  writeJson,
  writeText
} from "../phase428-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase427/yiyi-demo-readiness-snapshot-pack-closure-result.json");
...
await writeJson(`docs/phase428a-yiyi-demo-support-handoff-notes.json`, packageJson);
await writeText(
  `docs/phase428a-yiyi-demo-support-handoff-notes.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase428a/yiyi-demo-support-handoff-notes-result.json`, result);
