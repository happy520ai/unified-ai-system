...
const requiredFiles = [
  "docs/phase528a-yiyi-demo-security-response-cards.json",
  "docs/phase528a-yiyi-demo-security-response-cards.md",
  "apps/ai-gateway-service/evidence/phase528a/yiyi-demo-security-response-cards-result.json"
];
...
await writeText(
  "docs/phase528-yiyi-demo-security-response-cards-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase528/yiyi-demo-security-response-cards-closure-result.json", result);
