...
const phaseMeta = {
  ...
  docPath: "docs/phase2846-2885-controlled-thirty-five-tool-mutation.md",
  approvalPath: "docs/phase2846-2885-controlled-thirty-five-tool-mutation-approval.example.json",
  runnerPath: "tools/phase2846_2885/apply-controlled-thirty-five-tool-mutation.mjs",
  verifierPath: "tools/phase2846_2885/validate-controlled-thirty-five-tool-mutation.mjs",
  resultDir: "apps/ai-gateway-service/evidence/phase2846-2885-controlled-thirty-five-tool-mutation",
  resultPath: "apps/ai-gateway-service/evidence/phase2846-2885-controlled-thirty-five-tool-mutation/result.json",
  resultMdPath: "apps/ai-gateway-service/evidence/phase2846-2885-controlled-thirty-five-tool-mutation/result.md",
  rollbackPath: "apps/ai-gateway-service/evidence/phase2846-2885-controlled-thirty-five-tool-mutation/rollback.json",
  smokePath: "apps/ai-gateway-service/evidence/phase2846-2885-controlled-thirty-five-tool-mutation/thirty-five-smoke.json",
  permissionMode: "controlled-thirty-five-tool-source-mutation",
  label: "thirty-five",
  runnerReadyField: "thirtyFiveRunnerReady",
  ...
  verifyScript: "verify:phase2846-2885-controlled-thirty-five-tool-mutation",
  applyScript: "apply:phase2846-2885-controlled-thirty-five-tool-mutation",
  smokeScript: "smoke:phase2846-2885-controlled-thirty-five-tool-mutation",
};
...
const previousPhaseMeta = {
  ...
  sealCheckId: "phase2845_sealed",
  sealCheckField: "thirtyFourMutationApplied",
  sealCheckBlocker: "phase2845_not_sealed",
};
...
async function buildProposalDiff(target, beforeText, afterText) {
  ...
  const tempDir = resolve("tmp/phase2846-2885-proposals");
...
function buildDoc() {
  return `# Phase2846A-2885A Controlled Thirty-Five Tool Mutation
  ...
  return JSON.stringify(
    {
      ...
      planId: "phase2846-2885-controlled-thirty-five-tool-mutation",
      maxChangedFiles: 35,
      runNodeCheck: true,
      runLocalSmoke: true,
      approvalRecord: {
        ...
        approvedAtLeastOnceByOwner: [
          {
            ...
            scope: "phase2846-2885-controlled-thirty-five-tool-mutation",
          },
        ],
...
${smokeMarkers}
  ...
  const result = {
    ...
    blocker: completed ? "none" : "thirty_five_mutation_node_check_or_smoke_failed",
...
function buildBaseResult({ plan, validation, generatedAt, planPath }) {
  return {
    ...
    phase2845Sealed: validation.upstreamResults.some((entry) => entry.id === "${previousPhaseMeta.sealCheckId}" && entry.passed),
    codexExecExecuted: false,
    providerCallsMade: false,
    projectProviderCallsMade: false,
    secretRead: false,
...
function printSummary(result) {
  console.log(JSON.stringify({
    status: result.status,
    blocker: result.blocker,
    thirtyFiveMutationApplied: result.thirtyFiveMutationApplied,
    changedFileCount: result.changedFileCount,
    nodeCheckPassed: result.nodeCheckPassed,
    localThirtyFiveSmokePassed: result.localThirtyFiveSmokePassed,
...
const phase2845 = readJson("${previousPhaseMeta.resultPath}") || {};
...
check("${previousPhaseMeta.sealCheckId}", phase2845.recommendedSealed === true && phase2845.${previousPhaseMeta.sealCheckField} === true);
