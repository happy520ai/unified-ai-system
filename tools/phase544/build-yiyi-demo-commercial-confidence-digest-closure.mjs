...
const requiredFiles = [
  "docs/phase544a-yiyi-demo-commercial-confidence-digest.json",
  "docs/phase544a-yiyi-demo-commercial-confidence-digest.md",
  "apps/ai-gateway-service/evidence/phase544a/yiyi-demo-commercial-confidence-digest-result.json"
];
...
await writeText(
  "docs/phase544-yiyi-demo-commercial-confidence-digest-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase544/yiyi-demo-commercial-confidence-digest-closure-result.json", result);
