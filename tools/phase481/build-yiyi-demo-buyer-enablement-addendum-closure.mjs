import {
  ...
  writeJson,
  writeText
} from "../phase481-common.mjs";

const requiredFiles = [
  "docs/phase481a-yiyi-demo-buyer-enablement-addendum.json",
  "docs/phase481a-yiyi-demo-buyer-enablement-addendum.md",
  "apps/ai-gateway-service/evidence/phase481a/yiyi-demo-buyer-enablement-addendum-result.json"
];
...
await writeText(
  "docs/phase481-yiyi-demo-buyer-enablement-addendum-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase481/yiyi-demo-buyer-enablement-addendum-closure-result.json", result);
