...
export const phaseTitle = "Yiyi Demo Review Facilitation Pack";
export const phaseNumber = 449;
export const phaseName = "Phase449";
export const phaseSlug = "review-facilitation-pack";
export const phaseType = "commercial_demo_review_facilitation_pack";
export const phaseDeliverables = [
  "reviewFacilitationPackCreated",
  "facilitationChecklistCreated"
];
