...
export const phaseTitle = "Yiyi Demo Buyer Proof Addendum";
export const phaseNumber = 541;
export const phaseName = "Phase541";
export const phaseSlug = "buyer-proof-addendum";
export const phaseType = "commercial_demo_buyer_proof_addendum";
export const phaseDeliverables = [
  "buyerProofAddendumCreated",
  "buyerProofChecklistCreated"
];
