...
export const phaseTitle = "Yiyi Demo Safe Scope Reminder Pack";
export const phaseNumber = 456;
export const phaseName = "Phase456";
export const phaseSlug = "safe-scope-reminder-pack";
export const phaseType = "commercial_demo_safe_scope_reminder_pack";
export const phaseDeliverables = [
  "safeScopeReminderPackCreated",
  "scopeReminderChecklistCreated"
];
