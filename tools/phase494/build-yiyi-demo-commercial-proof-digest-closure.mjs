...
const requiredFiles = [
  "docs/phase494a-yiyi-demo-commercial-proof-digest.json",
  "docs/phase494a-yiyi-demo-commercial-proof-digest.md",
  "apps/ai-gateway-service/evidence/phase494a/yiyi-demo-commercial-proof-digest-result.json"
];
...
await writeText(
  "docs/phase494-yiyi-demo-commercial-proof-digest-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase494/yiyi-demo-commercial-proof-digest-closure-result.json", result);
