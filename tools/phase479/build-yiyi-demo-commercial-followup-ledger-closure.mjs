import {
  ...
  writeJson,
  writeText
} from "../phase479-common.mjs";

const requiredFiles = [
  "docs/phase479a-yiyi-demo-commercial-followup-ledger.json",
  "docs/phase479a-yiyi-demo-commercial-followup-ledger.md",
  "apps/ai-gateway-service/evidence/phase479a/yiyi-demo-commercial-followup-ledger-result.json"
];
...
await writeText(
  "docs/phase479-yiyi-demo-commercial-followup-ledger-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase479/yiyi-demo-commercial-followup-ledger-closure-result.json", result);
