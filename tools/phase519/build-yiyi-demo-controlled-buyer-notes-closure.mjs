...
const requiredFiles = [
  "docs/phase519a-yiyi-demo-controlled-buyer-notes.json",
  "docs/phase519a-yiyi-demo-controlled-buyer-notes.md",
  "apps/ai-gateway-service/evidence/phase519a/yiyi-demo-controlled-buyer-notes-result.json"
];
...
await writeText(
  "docs/phase519-yiyi-demo-controlled-buyer-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase519/yiyi-demo-controlled-buyer-notes-closure-result.json", result);
