...
export const phaseTitle = "Yiyi Demo Safe Next Batch Pack";
export const phaseNumber = 492;
export const phaseName = "Phase492";
export const phaseSlug = "safe-next-batch-pack";
export const phaseType = "commercial_demo_safe_next_batch_pack";
export const phaseDeliverables = [
  "safeNextBatchPackCreated",
  "nextBatchChecklistCreated"
];
