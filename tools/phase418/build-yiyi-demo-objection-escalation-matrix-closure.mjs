import {
  ...
  writeJson,
  writeText
} from "../phase418-common.mjs";

const requiredFiles = [
  "docs/phase418a-yiyi-demo-objection-escalation-matrix.json",
  "docs/phase418a-yiyi-demo-objection-escalation-matrix.md",
  "apps/ai-gateway-service/evidence/phase418a/yiyi-demo-objection-escalation-matrix-result.json"
];
...
await writeText(
  "docs/phase418-yiyi-demo-objection-escalation-matrix-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase418/yiyi-demo-objection-escalation-matrix-closure-result.json", result);
