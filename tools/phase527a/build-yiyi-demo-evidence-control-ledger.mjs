...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase526/yiyi-demo-buyer-assurance-notes-closure-result.json");
...
await writeJson(`docs/phase527a-yiyi-demo-evidence-control-ledger.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase527a/yiyi-demo-evidence-control-ledger-result.json`, result);
