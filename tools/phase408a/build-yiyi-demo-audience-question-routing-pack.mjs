...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase407/yiyi-demo-storyline-sequencing-pack-closure-result.json");
...
await writeJson(`docs/phase408a-yiyi-demo-audience-question-routing-pack.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase408a/yiyi-demo-audience-question-routing-pack-result.json`, result);
