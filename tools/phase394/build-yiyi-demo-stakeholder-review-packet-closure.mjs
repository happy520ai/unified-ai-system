import {
  ...
  writeJson,
  writeText
} from "../phase394-common.mjs";

const requiredFiles = [
  "docs/phase394a-yiyi-demo-stakeholder-review-packet.json",
  "docs/phase394a-yiyi-demo-stakeholder-review-packet.md",
  "apps/ai-gateway-service/evidence/phase394a/yiyi-demo-stakeholder-review-packet-result.json"
];
...
await writeText(
  "docs/phase394-yiyi-demo-stakeholder-review-packet-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase394/yiyi-demo-stakeholder-review-packet-closure-result.json", result);
