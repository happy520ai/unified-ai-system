...
export const phaseTitle = "Yiyi Demo Known Boundary Recap";
export const phaseNumber = 459;
export const phaseName = "Phase459";
export const phaseSlug = "known-boundary-recap";
export const phaseType = "commercial_demo_known_boundary_recap";
export const phaseDeliverables = [
  "knownBoundaryRecapCreated",
  "boundaryRecapChecklistCreated"
];
