...
export const phaseTitle = "Yiyi Demo Buyer Journey Handoff";
export const phaseNumber = 487;
export const phaseName = "Phase487";
export const phaseSlug = "buyer-journey-handoff";
export const phaseType = "commercial_demo_buyer_journey_handoff";
export const phaseDeliverables = [
  "buyerJourneyHandoffCreated",
  "journeyHandoffChecklistCreated"
];
