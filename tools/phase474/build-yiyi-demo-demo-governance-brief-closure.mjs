...
const requiredFiles = [
  "docs/phase474a-yiyi-demo-demo-governance-brief.json",
  "docs/phase474a-yiyi-demo-demo-governance-brief.md",
  "apps/ai-gateway-service/evidence/phase474a/yiyi-demo-demo-governance-brief-result.json"
];
...
await writeText(
  "docs/phase474-yiyi-demo-demo-governance-brief-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase474/yiyi-demo-demo-governance-brief-closure-result.json", result);
