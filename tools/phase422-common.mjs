...
export const phaseTitle = "Yiyi Demo Final Handoff Recap Cards";
export const phaseNumber = 422;
export const phaseName = "Phase422";
export const phaseSlug = "final-handoff-recap-cards";
export const phaseType = "commercial_demo_final_handoff_recap_cards";
export const phaseDeliverables = [
  "finalHandoffRecapCardsCreated",
  "recapUsageNotesCreated"
];
