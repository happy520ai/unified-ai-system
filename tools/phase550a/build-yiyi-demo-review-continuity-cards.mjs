import {
  ...
  writeJson,
  writeText
} from "../phase550-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase549/yiyi-demo-commercial-proof-ledger-closure-result.json");
...
await writeJson(`docs/phase550a-yiyi-demo-review-continuity-cards.json`, packageJson);
await writeText(
  `docs/phase550a-yiyi-demo-review-continuity-cards.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase550a/yiyi-demo-review-continuity-cards-result.json`, result);
