...
export const phaseTitle = "Yiyi Demo Buyer Readiness Snapshot";
export const phaseNumber = 445;
export const phaseName = "Phase445";
export const phaseSlug = "buyer-readiness-snapshot";
export const phaseType = "commercial_demo_buyer_readiness_snapshot";
export const phaseDeliverables = [
  "buyerReadinessSnapshotCreated",
  "buyerReadinessChecklistCreated"
];
