...
export const phaseTitle = "Yiyi Demo Eleventh Low-risk Auto-run Closure";
export const phaseNumber = 503;
export const phaseName = "Phase503";
export const phaseSlug = "eleventh-low-risk-auto-run-closure";
export const phaseType = "commercial_demo_eleventh_low_risk_auto_run_closure";
export const phaseDeliverables = [
  "eleventhLowRiskClosureCreated",
