...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase552/yiyi-demo-lowrisk-evidence-forward-pack-closure-result.json");
...
await writeJson(`docs/phase553a-yiyi-demo-sixteenth-low-risk-auto-run-closure.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase553a/yiyi-demo-sixteenth-low-risk-auto-run-closure-result.json`, result);
