import {
  ...
  writeJson,
  writeText
} from "../phase509-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase508/yiyi-demo-evidence-walkthrough-cards-closure-result.json");
...
await writeJson(`docs/phase509a-yiyi-demo-controlled-trial-framing.json`, packageJson);
await writeText(
  `docs/phase509a-yiyi-demo-controlled-trial-framing.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase509a/yiyi-demo-controlled-trial-framing-result.json`, result);
