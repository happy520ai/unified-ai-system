...
export const phaseTitle = "Yiyi Demo Fourth Low-risk Auto-run Closure";
export const phaseNumber = 433;
export const phaseName = "Phase433";
export const phaseSlug = "fourth-low-risk-auto-run-closure";
export const phaseType = "commercial_demo_fourth_low_risk_auto_run_closure";
export const phaseDeliverables = [
  "fourthLowRiskClosureCreated",
