...
export const phaseTitle = "Yiyi Demo Readout Brief Pack";
export const phaseNumber = 434;
export const phaseName = "Phase434";
export const phaseSlug = "demo-readout-brief-pack";
export const phaseType = "commercial_demo_readout_brief_pack";
export const phaseDeliverables = [
  "demoReadoutBriefPackCreated",
  "readoutChecklistCreated"
];
