...
export const phaseTitle = "Yiyi Demo Safe Claims Review Pack";
export const phaseNumber = 425;
export const phaseName = "Phase425";
export const phaseSlug = "safe-claims-review-pack";
export const phaseType = "commercial_demo_safe_claims_review_pack";
export const phaseDeliverables = [
  "safeClaimsReviewPackCreated",
  "claimBoundaryChecklistCreated"
];
