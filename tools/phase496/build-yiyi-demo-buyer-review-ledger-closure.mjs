...
const requiredFiles = [
  "docs/phase496a-yiyi-demo-buyer-review-ledger.json",
  "docs/phase496a-yiyi-demo-buyer-review-ledger.md",
  "apps/ai-gateway-service/evidence/phase496a/yiyi-demo-buyer-review-ledger-result.json"
];
...
await writeText(
  "docs/phase496-yiyi-demo-buyer-review-ledger-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase496/yiyi-demo-buyer-review-ledger-closure-result.json", result);
