import {
  ...
  writeJson,
  writeText
} from "../phase469-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase468/yiyi-demo-review-followthrough-notes-closure-result.json");
...
await writeJson(`docs/phase469a-yiyi-demo-controlled-pilot-outline.json`, packageJson);
await writeText(
  `docs/phase469a-yiyi-demo-controlled-pilot-outline.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase469a/yiyi-demo-controlled-pilot-outline-result.json`, result);
