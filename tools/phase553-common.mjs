...
export const phaseTitle = "Yiyi Demo Sixteenth Low-risk Auto-run Closure";
export const phaseNumber = 553;
export const phaseName = "Phase553";
export const phaseSlug = "sixteenth-low-risk-auto-run-closure";
export const phaseType = "commercial_demo_sixteenth_low_risk_auto_run_closure";
export const phaseDeliverables = [
  "sixteenthLowRiskClosureCreated",
