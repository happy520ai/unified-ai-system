import {
  ...
  writeJson,
  writeText
} from "../phase482-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase481/yiyi-demo-buyer-enablement-addendum-closure-result.json");
...
await writeJson(`docs/phase482a-yiyi-demo-safe-continuation-notes.json`, packageJson);
await writeText(
  `docs/phase482a-yiyi-demo-safe-continuation-notes.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase482a/yiyi-demo-safe-continuation-notes-result.json`, result);
