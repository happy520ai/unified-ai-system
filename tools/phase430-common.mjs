...
export const phaseTitle = "Yiyi Demo Evidence Appendix Pack";
export const phaseNumber = 430;
export const phaseName = "Phase430";
export const phaseSlug = "evidence-appendix-pack";
export const phaseType = "commercial_demo_evidence_appendix_pack";
export const phaseDeliverables = [
  "evidenceAppendixPackCreated",
  "appendixChecklistCreated"
];
