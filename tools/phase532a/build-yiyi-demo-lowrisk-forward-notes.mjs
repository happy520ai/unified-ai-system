import {
  ...
  writeJson,
  writeText
} from "../phase532-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase531/yiyi-demo-buyer-continuation-index-closure-result.json");
...
await writeJson(`docs/phase532a-yiyi-demo-lowrisk-forward-notes.json`, packageJson);
await writeText(
  `docs/phase532a-yiyi-demo-lowrisk-forward-notes.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase532a/yiyi-demo-lowrisk-forward-notes-result.json`, result);
