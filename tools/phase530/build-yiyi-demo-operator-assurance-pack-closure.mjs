...
const requiredFiles = [
  "docs/phase530a-yiyi-demo-operator-assurance-pack.json",
  "docs/phase530a-yiyi-demo-operator-assurance-pack.md",
  "apps/ai-gateway-service/evidence/phase530a/yiyi-demo-operator-assurance-pack-result.json"
];
...
await writeText(
  "docs/phase530-yiyi-demo-operator-assurance-pack-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase530/yiyi-demo-operator-assurance-pack-closure-result.json", result);
