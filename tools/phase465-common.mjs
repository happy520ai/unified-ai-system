...
export const phaseTitle = "Yiyi Demo Safety Boundary Cue Pack";
export const phaseNumber = 465;
export const phaseName = "Phase465";
export const phaseSlug = "safety-boundary-cue-pack";
export const phaseType = "commercial_demo_safety_boundary_cue_pack";
export const phaseDeliverables = [
  "safetyBoundaryCuePackCreated",
  "boundaryCueChecklistCreated"
];
