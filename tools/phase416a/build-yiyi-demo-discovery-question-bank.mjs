import {
  ...
  writeJson,
  writeText
} from "../phase416-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase415/yiyi-demo-partner-intro-script-pack-closure-result.json");
...
await writeJson(`docs/phase416a-yiyi-demo-discovery-question-bank.json`, packageJson);
await writeText(
  `docs/phase416a-yiyi-demo-discovery-question-bank.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase416a/yiyi-demo-discovery-question-bank-result.json`, result);
