...
const requiredFiles = [
  "docs/phase482a-yiyi-demo-safe-continuation-notes.json",
  "docs/phase482a-yiyi-demo-safe-continuation-notes.md",
  "apps/ai-gateway-service/evidence/phase482a/yiyi-demo-safe-continuation-notes-result.json"
];
...
await writeText(
  "docs/phase482-yiyi-demo-safe-continuation-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase482/yiyi-demo-safe-continuation-notes-closure-result.json", result);
