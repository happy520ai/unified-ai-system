...
const requiredFiles = [
  "docs/phase422a-yiyi-demo-final-handoff-recap-cards.json",
  "docs/phase422a-yiyi-demo-final-handoff-recap-cards.md",
  "apps/ai-gateway-service/evidence/phase422a/yiyi-demo-final-handoff-recap-cards-result.json"
];
...
await writeText(
  "docs/phase422-yiyi-demo-final-handoff-recap-cards-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase422/yiyi-demo-final-handoff-recap-cards-closure-result.json", result);
