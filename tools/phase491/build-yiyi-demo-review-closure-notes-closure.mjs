...
const requiredFiles = [
  "docs/phase491a-yiyi-demo-review-closure-notes.json",
  "docs/phase491a-yiyi-demo-review-closure-notes.md",
  "apps/ai-gateway-service/evidence/phase491a/yiyi-demo-review-closure-notes-result.json"
];
...
await writeText(
  "docs/phase491-yiyi-demo-review-closure-notes-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase491/yiyi-demo-review-closure-notes-closure-result.json", result);
