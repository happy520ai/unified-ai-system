...
const requiredFiles = [
  "docs/phase542a-yiyi-demo-lowrisk-safety-index.json",
  "docs/phase542a-yiyi-demo-lowrisk-safety-index.md",
  "apps/ai-gateway-service/evidence/phase542a/yiyi-demo-lowrisk-safety-index-result.json"
];
...
await writeText(
  "docs/phase542-yiyi-demo-lowrisk-safety-index-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase542/yiyi-demo-lowrisk-safety-index-closure-result.json", result);
