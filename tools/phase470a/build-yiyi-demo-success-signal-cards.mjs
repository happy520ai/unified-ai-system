import {
  ...
  writeJson,
  writeText
} from "../phase470-common.mjs";

const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase469/yiyi-demo-controlled-pilot-outline-closure-result.json");
...
await writeJson(`docs/phase470a-yiyi-demo-success-signal-cards.json`, packageJson);
await writeText(
  `docs/phase470a-yiyi-demo-success-signal-cards.md`,
  [
...
await writeJson(`apps/ai-gateway-service/evidence/phase470a/yiyi-demo-success-signal-cards-result.json`, result);
