...
const previousClosure = fileInfo("apps/ai-gateway-service/evidence/phase517/yiyi-demo-buyer-safety-brief-closure-result.json");
...
await writeJson(`docs/phase518a-yiyi-demo-evidence-assurance-pack.json`, packageJson);
await writeText(
...
await writeJson(`apps/ai-gateway-service/evidence/phase518a/yiyi-demo-evidence-assurance-pack-result.json`, result);
