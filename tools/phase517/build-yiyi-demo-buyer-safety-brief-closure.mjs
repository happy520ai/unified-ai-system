...
const requiredFiles = [
  "docs/phase517a-yiyi-demo-buyer-safety-brief.json",
  "docs/phase517a-yiyi-demo-buyer-safety-brief.md",
  "apps/ai-gateway-service/evidence/phase517a/yiyi-demo-buyer-safety-brief-result.json"
];
...
await writeText(
  "docs/phase517-yiyi-demo-buyer-safety-brief-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase517/yiyi-demo-buyer-safety-brief-closure-result.json", result);
