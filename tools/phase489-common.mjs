...
export const phaseTitle = "Yiyi Demo Evidence Confidence Notes";
export const phaseNumber = 489;
export const phaseName = "Phase489";
export const phaseSlug = "evidence-confidence-notes";
export const phaseType = "commercial_demo_evidence_confidence_notes";
export const phaseDeliverables = [
  "evidenceConfidenceNotesCreated",
  "evidenceConfidenceChecklistCreated"
];
