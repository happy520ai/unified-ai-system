import {
  ...
  writeJson,
  writeText
} from "../phase436-common.mjs";

const requiredFiles = [
  "docs/phase436a-yiyi-demo-pilot-success-criteria-pack.json",
  "docs/phase436a-yiyi-demo-pilot-success-criteria-pack.md",
  "apps/ai-gateway-service/evidence/phase436a/yiyi-demo-pilot-success-criteria-pack-result.json"
];
...
await writeText(
  "docs/phase436-yiyi-demo-pilot-success-criteria-pack-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase436/yiyi-demo-pilot-success-criteria-pack-closure-result.json", result);
