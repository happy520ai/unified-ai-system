...
const requiredFiles = [
  "docs/phase476a-yiyi-demo-controlled-rollout-questions.json",
  "docs/phase476a-yiyi-demo-controlled-rollout-questions.md",
  "apps/ai-gateway-service/evidence/phase476a/yiyi-demo-controlled-rollout-questions-result.json"
];
...
await writeText(
  "docs/phase476-yiyi-demo-controlled-rollout-questions-closure.md",
  [
...
await writeJson("apps/ai-gateway-service/evidence/phase476/yiyi-demo-controlled-rollout-questions-closure-result.json", result);
