...
export const phaseTitle = "Yiyi Demo Safe Evaluation Notes";
export const phaseNumber = 495;
export const phaseName = "Phase495";
export const phaseSlug = "safe-evaluation-notes";
export const phaseType = "commercial_demo_safe_evaluation_notes";
export const phaseDeliverables = [
  "safeEvaluationNotesCreated",
  "evaluationNotesChecklistCreated"
];
