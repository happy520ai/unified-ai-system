...
export const phaseTitle = "Yiyi Demo Safe Proof Notes";
export const phaseNumber = 515;
export const phaseName = "Phase515";
export const phaseSlug = "safe-proof-notes";
export const phaseType = "commercial_demo_safe_proof_notes";
export const phaseDeliverables = [
  "safeProofNotesCreated",
  "safeProofChecklistCreated"
];
