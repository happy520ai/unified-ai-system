...
export const phaseTitle = "Yiyi Demo Evidence Walkthrough Cards";
export const phaseNumber = 508;
export const phaseName = "Phase508";
export const phaseSlug = "evidence-walkthrough-cards";
export const phaseType = "commercial_demo_evidence_walkthrough_cards";
export const phaseDeliverables = [
  "evidenceWalkthroughCardsCreated",
  "walkthroughCardsChecklistCreated"
];
