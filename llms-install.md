...
```bash
cline mcp install unified-ai-system --yes --json -- docker run --rm -i ghcr.io/happy520ai/unified-ai-system/mcp-server:0.5.0
```
...
- The server exposes twelve tools, including provider-free prompt enhancement.
...
```bash
docker pull ghcr.io/happy520ai/unified-ai-system/mcp-server:0.5.0
```
