...
```bash
cline mcp install unified-ai-system --yes --json -- docker run --rm -i ghcr.io/happy520ai/unified-ai-system/mcp-server:0.4.3
```
...
```bash
docker pull ghcr.io/happy520ai/unified-ai-system/mcp-server:0.4.3
```
