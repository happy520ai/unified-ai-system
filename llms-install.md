...
```bash
cline mcp install unified-ai-system --yes --json -- docker run --rm -i ghcr.io/happy520ai/unified-ai-system/mcp-server:0.8.0
```
...
- The server exposes fifteen tools, including provider-free prompt enhancement.
...
```bash
docker pull ghcr.io/happy520ai/unified-ai-system/mcp-server:0.8.0
```
