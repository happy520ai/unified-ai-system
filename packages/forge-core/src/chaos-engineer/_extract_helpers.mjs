...
const faultTypesLines = lines.slice(27, 92); // lines 28-92 (1-indexed)
...
// Replace FAULT_TYPES references with _FAULT_TYPES
...
// Fix _simulateExperiment call to pass this.#history
...
// Fix _executeRealExperiment call to pass this.#safetyTimeout and this.#blastRadius
sectionC = sectionC.replace(
...
// Replace inline suiteExperiments array with _SUITE_EXPERIMENTS reference
