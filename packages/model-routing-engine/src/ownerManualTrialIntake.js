export const OWNER_FEEDBACK_REQUIRED_FIELDS = [
  "feedbackSource",
  "ownerName",
  "isRealManualTrial",
  "trialDate",
...
export function createOwnerFeedbackInputSchema() {
  return {
    $schema: "https://json-schema.org/draft/2020-12/schema",
    title: "Owner real manual trial feedback input",
    type: "object",
    required: OWNER_FEEDBACK_REQUIRED_FIELDS,
    properties: {
      feedbackSource: { const: "owner" },
      ownerName: { type: "string", minLength: 1 },
      isRealManualTrial: { const: true },
      trialDate: { type: "string", minLength: 8 },
      ...
      readyForBugFixPhase: { type: "boolean" },
      notes: { type: "string" }
    },
...
export function createOwnerFeedbackTemplate() {
  return {
