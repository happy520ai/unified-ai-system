...
export const PROVIDER_CATALOG_EXTENDED = [
  ...
  },
  {
    ...
    defaultModels: [
      { modelId: "deepseek-v4-flash", modelDisplayName: "DeepSeek V4 Flash", capabilities: ["chat", "reasoning", "coding", "summary"] },
      { modelId: "hy3", modelDisplayName: "HY3", capabilities: ["chat", "summary"] },
      { modelId: "mimo-v2.5", modelDisplayName: "MiMo V2.5", capabilities: ["chat", "reasoning", "coding", "summary"] },
      { modelId: "glm-5.3-flash", modelDisplayName: "GLM 5.3 Flash", capabilities: ["chat", "reasoning", "coding", "summary"] },
      { modelId: "qwen3.8-flash", modelDisplayName: "Qwen 3.8 Flash", capabilities: ["chat", "reasoning", "coding", "summary"] },
      { modelId: "deepseek-v4-flash-vision-exp", modelDisplayName: "DeepSeek V4 Flash Vision Experimental", capabilities: ["chat", "vision", "reasoning", "summary"] },
    ],
    reason: "B.AI exposes an OpenAI-compatible model list and chat endpoint. Promotional model availability can change and must be verified against the current account response.",
  },
  {
    family: "gemini",
    providerId: "gemini",
    ...
    modelListAuth: "gemini-api-key-header",
    defaultModels: [
    ...
    reason: "Detected a Gemini key. Native generateContent/streamGenerateContent adapter is available for chat; embedding and media models stay on their own lanes.",
  },
  {
    family: "anthropic",
    ...
    reason: "Detected an Anthropic key. Native Anthropic Messages API adapter is available for chat.",
  },
];
