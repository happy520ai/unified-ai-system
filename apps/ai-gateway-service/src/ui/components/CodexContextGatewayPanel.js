import {
  buildAuthorizationEvidenceDryRunSimulationReport,
  buildControlledBaseUrlIntegrationDesignReport,
  buildPhase599AuthorizationReviewReport,
  buildPhase600ReadinessReviewReport,
  buildPhase601PreparationReport,
  buildPhase602OneShotReport,
  buildPhase603PreparationReport,
  buildPhase604OneShotReport,
  buildRealUsageTrialReport,
  buildRepeatedUsageBenchmarkReport,
  buildUsageWorkflowPreview,
...
import { buildDetailPayload } from "./CodexContextGatewayPanelDetail.js";
import {
  displaySafePath,
  displaySafeText,
  escapeAttr,
  escapeHtml,
} from "./CodexContextGatewayPanelEscaping.js";
import { renderCodexContextGatewayPanelMarkup } from "./CodexContextGatewayPanelMarkup.js";
import {
...
} from "./CodexContextGatewayPanelReadersA.js";
import {
...
} from "./CodexContextGatewayPanelReadersB.js";
...
export function renderCodexContextGatewayPanel() {
  ...
  return renderCodexContextGatewayPanelMarkup({
    escapeHtml, escapeAttr, displaySafeText, codexContextGatewayCopy,
    preview,
    usage, trial,
    benchmark, baseUrlDesign, authorizationDesign, humanApprovalReview,
    readinessReview, preparationReview, oneShotReview, customProviderReview,
    customProviderOneShotReview, interactiveTerminalIntake, codexExecIntake, repeatedReliabilityDesign,
    repeatedGuardedTestDesign, repeatedGuardedTestResult, repeatedReliabilityClosure, controlledIntegrationPreviewGate,
    runtimeIntegrationApprovalPacket, runtimeCandidateDryRunBundle, controlledRuntimeCandidatePath, mainChainFinalApprovalPacket,
    mainChainDesignPatch, phase639RP1ApprovalPreview, phase639RNightlyFallbackPanel, phase640RNightlyPermissionedRetryPack,
    phase641RNightlyRegistrationResultIntake, phase640RExternalToolMode, phase641R645RExternalToolBundle, phase646R650RExternalToolClosure,
    hash, token, freshness, files,
    evidence, dirty, prompt, badges,
    fileRows, evidenceRows, validationRows, usageChecks,
    ...
    relaySimulationSteps, authChecklist, humanApprovalMissingFields, humanApprovalLedgerRows,
    readinessMissingFields, readinessLedgerRows, preparationLedgerRows, oneShotLedgerRows,
    customProviderLedgerRows, customProviderOneShotLedgerRows, interactiveTerminalIntakeRows, codexExecIntakeRows,
    repeatedReliabilityRows, repeatedGuardedTestRows, repeatedGuardedResultRows, repeatedClosureRows,
    controlledIntegrationGateRows, runtimeApprovalRows, runtimeCandidateDryRunRows, controlledRuntimeCandidateRows,
    controlledRuntimeCandidateBoundaryRows, mainChainFinalApprovalRows, mainChainFinalBoundaryRows, mainChainDesignPatchRows,
    mainChainDesignPatchBoundaryRows, phase639rP1ApprovalRows, phase639rNightlyFallbackRows, phase640rNightlyPermissionedRetryRows,
    phase641rNightlyRegistrationRows, phase640rExternalToolRows, phase641r645rExternalToolRows, phase646r650rExternalToolRows,
    actions, detailPayload,
  });
}
