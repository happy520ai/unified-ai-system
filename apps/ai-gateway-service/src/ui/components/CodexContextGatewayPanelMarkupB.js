export function renderCodexContextGatewayPanelMarkupB(context) {
  const {
    escapeHtml,
    preview,
    usage,
    ...
    preparationReview,
    oneShotReview,
    customProviderReview,
    customProviderOneShotReview,
    interactiveTerminalIntake,
    codexExecIntake,
    repeatedReliabilityDesign,
    repeatedGuardedTestDesign,
    repeatedGuardedTestResult,
    repeatedReliabilityClosure,
    controlledIntegrationPreviewGate,
    runtimeIntegrationApprovalPacket,
    runtimeCandidateDryRunBundle,
    controlledRuntimeCandidatePath,
    mainChainFinalApprovalPacket,
    mainChainDesignPatch,
    phase639RP1ApprovalPreview,
    phase639RNightlyFallbackPanel,
    phase640RNightlyPermissionedRetryPack,
    ...
    authRequiredFields,
    authSummarySteps,
    relaySimulationSteps,
    authChecklist,
    humanApprovalMissingFields,
    humanApprovalLedgerRows,
    readinessMissingFields,
    readinessLedgerRows,
    preparationLedgerRows,
    oneShotLedgerRows,
    customProviderLedgerRows,
    customProviderOneShotLedgerRows,
    interactiveTerminalIntakeRows,
    codexExecIntakeRows,
    repeatedReliabilityRows,
    repeatedGuardedTestRows,
    repeatedGuardedResultRows,
    repeatedClosureRows,
    controlledIntegrationGateRows,
    runtimeApprovalRows,
    runtimeCandidateDryRunRows,
    controlledRuntimeCandidateRows,
    controlledRuntimeCandidateBoundaryRows,
    mainChainFinalApprovalRows,
    mainChainFinalBoundaryRows,
    mainChainDesignPatchRows,
    mainChainDesignPatchBoundaryRows,
    phase639rP1ApprovalRows,
    phase639rNightlyFallbackRows,
    phase640rNightlyPermissionedRetryRows,
    phase641rNightlyRegistrationRows,
    phase640rExternalToolRows,
    phase641r645rExternalToolRows,
    phase646r650rExternalToolRows,
    actions,
    detailPayload,
  } = context;
  return `                <div class="codex-context-preview-grid" id="codex-phase610r-codex-exec-intake-section" data-codex-phase610r-codex-exec-intake="true" data-codex-phase610r-one-shot-pass-once="true" data-codex-phase610r-no-chat-integration="true">
