...
import { createManifestSummary, createPublicKnowledgeManifest } from "./publicKnowledgeManifest.js";
...
import {
  ...
  runFixtureImports,
  summarizeCases,
} from "./publicKnowledgeImportHelpers.js";
...
export function runPublicKnowledgeImportPreview() {
  ...
  const enrichedImportResult = {
    ...importResult,
    indexPreview: importResult.indexPreview,
    acceptedChunks,
  };
