/**
 * Static NVIDIA catalog data: source URLs, allowlists, blocklists, chat model
 * ids, and tool/specialised model records.
 *
 * Extracted from nvidiaCatalogDiscovery.js to keep that orchestrator under the
 * 500-line anti-entropy size limit.
 */

import { NVIDIA_TOOL_MODELS_EXTENDED } from "./nvidiaCatalogDataExtended.js";
import { OFFICIAL_SOURCE_URLS } from "./nvidiaCatalogConstants.js";

// Re-export so existing consumers (nvidiaCatalogHelpers.js, etc.) keep working.
export { OFFICIAL_SOURCE_URLS };
...
const NVIDIA_TOOL_MODELS_BASE = [
  ...
  // Remaining tool models (multimodal, video, voice, driving, biology) live in
  // nvidiaCatalogDataExtended.js to keep each file under the 500-line limit.
];

export const NVIDIA_TOOL_MODELS = [
  ...NVIDIA_TOOL_MODELS_BASE,
  ...NVIDIA_TOOL_MODELS_EXTENDED,
];
