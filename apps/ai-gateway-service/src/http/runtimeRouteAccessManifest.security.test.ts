...
const EXPECTED_RUNTIME_PERMISSIONS = [
  ...
  ["GET", "/v1/agents/agt_demo", "dashboard:read"],
  ["GET", "/v1/agents/agt_demo/effective-policy", "dashboard:read"],
  ["GET", "/v1/agents/agt_demo/audit", "audit:read"],
  ["POST", "/v1/agents/agt_demo/run", "workflow:run"],
  ["POST", "/v1/agents/agt_demo/revoke", "workflow:approve"],
  ["POST", "/v1/approvals/apr_demo/approve", "workflow:approve"],
  ["POST", "/v1/policies/execution-family/3/activate", "user:admin"],
