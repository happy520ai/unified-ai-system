...
import { executeExperienceHardeningCheck } from "./agentWorkforceExperienceHardeningRunner.js";
...
export async function runExperienceHardeningCheck(phase) {
  return executeExperienceHardeningCheck(phase, definitions, demoGoals[0]);
}
