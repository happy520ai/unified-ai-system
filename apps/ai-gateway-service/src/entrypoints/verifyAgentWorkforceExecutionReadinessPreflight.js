...
try {
  ...
  await writeVerifyAgentWorkforceExecutionReadinessPreflightEvidence(evidence);
...
async function writeVerifyAgentWorkforceExecutionReadinessPreflightEvidence(body) {
