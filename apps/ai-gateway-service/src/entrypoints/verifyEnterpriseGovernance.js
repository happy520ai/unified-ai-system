import { listen, requestJsonResponseWithHeaders as fetchJson, writeEvidenceFiles, } from "./entrypointUtils.js";
...
try {
  ...
  await writeVerifyEnterpriseGovernanceEvidence(evidence);
...
async function writeVerifyEnterpriseGovernanceEvidence(body) {
