...
import { renderModelConfigRepairLoopEvidence as createEvidenceMarkdown } from "./webChatVerificationMarkdown.js";
...
try {
  ...
  await writeVerifyWebChatModelConfigRepairLoopEvidence(evidence);
...
async function writeVerifyWebChatModelConfigRepairLoopEvidence(body) {
